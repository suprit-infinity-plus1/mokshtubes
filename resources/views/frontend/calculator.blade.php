                ...
                <div id="tabContents">
                    ...
                    <div id="tab1" class="tab-content-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/steel-sheets-plates.webp') }}"
                                    class="img-fluid rounded border w-100" alt="Steel Sheet Image">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab4" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/Hollow_structural_sections-square.webp') }}"
                                    class="img-fluid rounded border w-100" alt="Placeholder Image for Square Section">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab5" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/hollow_sections_rectangular.webp') }}"
                                    class="img-fluid rounded border w-100" alt="Placeholder Image for Rectangular HSS">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab6" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/roundbar.webp') }}"
                                    class="img-fluid rounded border w-100" alt="Placeholder Image for Round Steel Bar">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab7" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/squaresteelbars.webp') }}"
                                    class="img-fluid rounded border w-100" alt="Placeholder Image for Square Steel Bar">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab8" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/Flatbars.webp') }}"
                                    class="img-fluid rounded border w-100" alt="Placeholder Image for Flat Bar">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab9" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/equal-angles.webp') }}"
                    ...
                    <div id="tab10" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/unequal-angles.webp') }}"
                                    class="img-fluid rounded border w-100" alt="Placeholder Image for Unequal Angles">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab11" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/Channels-GOST.webp') }}"
                                    class="img-fluid rounded border w-100" alt="Placeholder Image for Channels - GOST">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab12" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/Channels-UPN.webp') }}"
                                    class="img-fluid rounded border w-100" alt="Placeholder Image for Channels - UPN">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab13" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/Beams-IPN.webp') }}"
                                    class="img-fluid rounded border w-100" alt="I-Beam Illustration" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab14" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/Beams-IPE.webp') }}"
                                    class="img-fluid rounded border w-100" alt="IPE Beam Illustration" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab15" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/Beams-HEA(IPBL).webp') }}"
                                    class="img-fluid rounded border w-100" alt="HEA Beam Illustration" />
                            </div>
                        </div>
                    </div>
    ...
    @endverbatim
                    ...
                    <div id="tab16" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="{{ asset('assets/images/calculator/Beams-HEB-(IPB).webp') }}"
                                    class="img-fluid rounded border w-100" alt="HEA Beam Illustration" />
                            </div>
                        </div>
                    </div>
