                ...
                <div class="blog-post">
                    <div class="single-blog-post">
                        ...
                        <div class="img-holder mb-4">
                            <img src="{{ asset('storage/' . $blog->cover_image) }}" alt="{{ $blog->title }}" class="img-fluid w-100">
                        </div>
                        @endif
                ...
                <div class="sidebar-wrapper">
                    ...
                    <div class="single-sidebar">
                        ...
                        <ul class="recent-post">
                            ...
                            <li>
                                <div class="img-holder">
                                    <img src="{{ asset('storage/' . $allBlog->cover_image) }}" alt="{{ $allBlog->title }}">
                                    <div class="overlay-style-two">
                                        <div class="box">
                                            <div class="content">
                            ...
                            <div class="col-md-12">
                                <div class="card-body ">
                                    ...
                                    <div class="mb-3 text-center">
                                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3773.4406978634916!2d72.82619187387158!3d18.956134955727215!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7cf9ee4261af1%3A0x57adb33b0f4c262!2sMoksh%20Tubes%20%26%20Fittings%20LLP!5e0!3m2!1sen!2sin!4v1759748667385!5m2!1sen!2sin" width="100%" height="200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                    </div>
