...
@section('meta_description',
    ' Moksh Tubes exports high-quality stainless steel pipe fittings from Mumbai to 30+ countries, ensuring trusted global distribution and superior service.')
                                        ...
                                        <div class="text">
                                            <p>
                                                ...
                                                export volumes increasing steadily over the years. <a
                                                    href="{{ route('products') }}">Products</a> like stainless
                                        ...
                                        <div class="text">
                                            <p>
                                                Based in the bustling industrial hub of Mumbai, <a
                                                    href="{{ route('index') }}">Moksh Tubes & Fittings LLP</a>
