...
@section('meta_description', 'Explore expert articles on stainless steel, nickel alloys, Hastelloy, engineering
    applications, technical comparisons, and industry-specific insights from Moksh Tubes LLP.')
...
@section('content')
    ...
    <section class="breadcrumb-area" style="background-image: url(/assets/images/blog-banner.png);">
        <div class="container">
