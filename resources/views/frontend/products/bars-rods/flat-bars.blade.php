...
@verbatim
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The weight of a mild steel (MS) flat bar can be calculated using the formula: Weight (kg) = Length (m) × Width (m) × Thickness (m) × 7850. A weight chart or calculator can make this easier."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Flat bars are available in steel (SS), mild steel (MS), alloy steel, aluminium, copper, brass, nickel alloys, and titanium. Grades comply with ASTM, ASME, DIN, EN, and JIS standards."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Stainless steel flat bars come in bright, polished, mill finish, peeled & ground, shot blasted, pickled & passivated finishes, ensuring excellent surface quality for decorative and industrial applications."
      }
    }
  ]
}
