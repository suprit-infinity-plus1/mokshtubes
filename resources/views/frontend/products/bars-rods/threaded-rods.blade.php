            ...
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    ...
                    <p class="text-center mt-3 px-3 py-2 text-white position-relative"
                        ...
                        load-bearing capability. At Moksh Tubes & Fittings LLP, we supply premium-quality Threaded Rods in
                        Stainless Steel, Carbon Steel, Alloy Steel, Duplex Steel, Nickel Alloys, Titanium, Brass, Copper,
                        and Galvanized Steel grades. Our threaded rods are manufactured according to ASTM, ASME, DIN, ISO,
                        and BS standards and are available in multiple diameters, thread types, finishes, and custom lengths
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <p class="fs-6 mb-3 text-justify">
                        <strong>Threaded Rods</strong>, commonly referred to as Stud Rods, All-Thread Rods, or Thread Bars,
                        are essential fastening components used to connect, secure, suspend, and reinforce structures and
                        mechanical assemblies. Unlike standard bolts, threaded rods feature threading along their entire
                        length, allowing nuts and washers to be installed at any position.
                    </p>

                    <p class="fs-6 text-justify">
                        These versatile fasteners are extensively used in steel structures, concrete anchoring systems, HVAC
                        installations, piping supports, marine structures, petrochemical plants, and heavy engineering
                        projects where strength and reliability are critical.
                    </p>

                    <p class="fs-6 text-justify">
                        At <a href="{{ route('index') }}">Moksh Tubes & Fittings LLP</a>, we offer a complete range of
                        Threaded Rods manufactured from corrosion-resistant and high-strength materials suitable for harsh
                        industrial environments, offshore installations, and structural applications.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 text-center shadow-sm grade-card">
                        <div class="card-body py-4">
                            ...
                            <p class="card-text small mb-0">304, 304L, 316, 316L, 310, 321<br>For corrosion resistance in
                                marine, food &amp; pharma industries.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 text-center shadow-sm grade-card">
                        <div class="card-body py-4">
                            ...
                            <p class="card-text small mb-0">ASTM A193 B7/B7M, A320 L7/L7M, ASTM A307<br>For structural
                                &amp; high-strength use.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 text-center shadow-sm grade-card">
                        <div class="card-body py-4">
                            ...
                            <p class="card-text small mb-0">UNS S31803, S32205, S32750, S32760<br>For offshore &amp;
                                chemical plants.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 text-center shadow-sm grade-card">
                        <div class="card-body py-4">
                            ...
                            <p class="card-text small mb-0">Inconel, Monel, Hastelloy, Titanium Grades 2 &amp; 5<br>For
                                extreme heat &amp; corrosive service.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 text-center shadow-sm grade-card">
                        <div class="card-body py-4">
                            ...
                            <p class="card-text small mb-0">C36000 Brass, C11000 Copper, Al 6061, 6082<br>For lightweight,
                                decorative &amp; electrical purposes.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4 mt-4">
                <div class="col-md-6 col-lg-4">
                    <div class="advantage-card h-100">
                        ...
                        <p class="small text-muted mt-2">Threaded continuously from end to end, offering maximum adjustment
                            flexibility.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="advantage-card h-100">
                        ...
                        <p class="small text-muted mt-2">Threaded at both ends with an unthreaded center section, commonly
                            used in flange connections.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="advantage-card h-100">
                        ...
                        <h4>Tap-End Studs</h4>
                        <p class="small text-muted mt-2">Featuring one short-threaded end and one long-threaded end for
                            equipment assembly applications.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="advantage-card h-100">
                        ...
                        <p class="small text-muted mt-2">Suitable for construction and general engineering applications.
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="advantage-card h-100">
                        ...
                        <p class="small text-muted mt-2">Used where vibration resistance and precise clamping force are
                            required.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="advantage-card h-100">
                        ...
                        <p class="small text-muted mt-2">Manufactured according to project specifications, including
                            special thread forms, coatings, and lengths.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <p class="small text-muted mt-2">Structural steel connections, concrete anchoring systems, building
                            reinforcement, suspension systems.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <p class="small text-muted mt-2">Dock structures, offshore platforms, shipbuilding projects,
                            saltwater applications.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <p class="small text-muted mt-2">Flange assemblies, pressure vessels, refineries, petrochemical
                            facilities.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <p class="small text-muted mt-2">Pumps, compressors, turbines, manufacturing equipment, machinery
                            assembly.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <p class="small text-muted mt-2">Railings, decorative fittings, signage systems, furniture
                            manufacturing.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="accordion-box">
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>Threaded rods are used for fastening, anchoring, suspension systems, structural
                                    reinforcement, machinery assembly, and industrial installations.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>Stainless Steel 316, Duplex Stainless Steel, Titanium, and Nickel Alloy threaded rods
                                    provide excellent corrosion resistance.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>Yes. We supply threaded rods in standard and custom lengths according to project
                                    requirements.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>Yes. EN 10204 3.1 Mill Test Certificates and additional inspection reports are available.
                                </p>
                            </div>
                        </div>
    ...
    <section class="sec-padd-top sec-padd-bottom bg-light">
        <div class="container">
            <div class="contact-cta-box">
                ...
                <p>
                    Looking for premium-quality <strong>Threaded Rods</strong> for construction, industrial, marine, or oil
                    &amp; gas projects? Contact <strong>Moksh Tubes &amp; Fittings LLP</strong> today for competitive
                    pricing, technical assistance, and worldwide delivery.
                </p>
