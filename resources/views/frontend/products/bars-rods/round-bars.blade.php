  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The weight of a round bar can be calculated using the formula: Weight (kg) = (π × D² / 4) × L × ρ, where D is the diameter of the round bar in meters, L is the length in meters, and ρ is the density of the material in kg/m³ (e.g., 7850 kg/m³ for steel). You can also refer to our round bar weight chart for quick reference."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We offer ASTM, ASME, DIN, EN, and JIS certified grades across all major alloys, ensuring compliance with international standards."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Mokshtubes supplies round bars in Mumbai, India, and internationally to countries including Sweden, Norway, Nigeria, UAE, USA, Singapore, Maldives, Saudi Arabia, Germany, UK, Canada, Jordan, Peru, Australia, Thailand, Russia, France, Belgium, Bulgaria, Taiwan, Italy, and Netherlands."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Mokshtubes offers high precision, a wide variety of materials and grades, multiple finishes, custom cutting, competitive prices, and durable bars complying with ASTM, ASME, DIN, and EN standards."
      }
    }
  ]
}
