...
@section('content')
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4" style="text-align: justify;">
                            ...
                            compared to <a href="{{ url('/products/pipes-tubes/welded-pipes/ss304-erw-pipes') ?? '#' }}">SS
                                304 ERW
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download SS316 ERW Pipes Datasheet</h3>
            <p class="mb-3">
                Get the complete SS316 ERW Pipes datasheet with chemical composition,
    ...
    <section id="advantages" class="sec-padd-top sec-padd-bottom bg-light">
        <div class="container">
            <div class="section-title center mb-4">
                <h2 class="fw-bold" style="color: #174268;">Advantages of SS 316 ERW Pipes</h2>
            </div>
            <div class="row g-4 mt-4 justify-content-center">
                <div class="col-sm-6 col-lg-4">
