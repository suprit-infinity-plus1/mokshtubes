                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        ...
                        <p class="fs-6 mb-4" style="text-align: justify;">
                            ...
                            <a href="{{ url('products/pipes-tubes/welded-pipes') }}">high-frequency electric resistance
    ...
    <section id="advantages" class="sec-padd-top sec-padd-bottom bg-light">
        <div class="container">
            <div class="section-title center mb-4">
                <h2 class="fw-bold" style="color: #174268;">Advantages of SS 304 ERW Pipes</h2>
            </div>
            <div class="row g-4 mt-4 justify-content-center">
                <div class="col-sm-6 col-lg-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card h-100">
                        ...
                        <h4>Smooth internal surface for fluid flow</h4>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card h-100">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card h-100">
                        ...
                        <h4>Suitable for food-grade & hygienic use</h4>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card h-100">
