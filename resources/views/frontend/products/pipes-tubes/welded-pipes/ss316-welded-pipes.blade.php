...
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    ...
                    <p class="text-center mt-3 px-3 py-2 text-white position-relative"
                        ...
                        Stainless Steel 316 Welded Pipes are premium-quality corrosion-resistant pipes manufactured from
                        stainless steel strips or plates using advanced welding processes. Containing chromium, nickel, and
                        molybdenum, Grade 316 offers superior resistance to pitting, crevice corrosion, and chloride attack
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4" style="text-align: justify;">
                            <strong class="text-black">Stainless Steel 316 Welded Pipes</strong> are among the most widely
                            used austenitic stainless steel piping products for corrosive and high-temperature environments.
                            Manufactured using advanced ERW (Electric Resistance Welded) and EFW (Electric Fusion Welded)
                            processes, these pipes offer exceptional corrosion resistance, excellent weldability, high
                            strength, and long service life.
                        </p>

                        <p class="fs-6 mb-4" style="text-align: justify;">
                            The addition of 2–3% molybdenum significantly improves resistance to chlorides, acids, seawater,
                            and harsh industrial chemicals, making SS 316 Welded Pipes ideal for marine engineering,
                            offshore platforms, chemical plants, desalination facilities, pharmaceutical manufacturing, food
                            processing, and heat exchanger systems.
                        </p>

                        <p class="fs-6" style="text-align: justify;">
                            At <strong style="color:black;"><a href="{{ url('/contact-us') }}">Moksh Tubes & Fittings
                                    LLP</a></strong>, we manufacture, stock, and export Stainless Steel 316 Welded Pipes in
                            compliance with ASTM A312 TP316, ASTM A312 TP316L, ASTM A358, ASME SA312, and EN standards for
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody class="text-center">
                                ...
                                <tr class="t-row">
                                    <td>Standard</td>
                                    <td>ASTM A312, ASTM A358, ASME SA312</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Grade</td>
                                    <td>TP316, TP316L</td>
                                ...
                                <tr class="t-row">
                                    <td>Pipe Type</td>
                                    <td>ERW, EFW, Welded</td>
                                </tr>
                                <tr class="t-row">
                                    <td>End Type</td>
                                    <td>Plain End, Bevel End, Threaded</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Surface Finish</td>
                                    <td>Pickled, Annealed, Polished, Matte</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Testing</td>
                                    <td>Hydro Test, PMI, UT, Eddy Current</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Certification</td>
    ...
    <section id="size-weight" class="sec-padd-top sec-padd-bottom bg-light">
        <div class="container">
            ...
            <p class="text-center mb-4">Weight Chart as per ASME B36.19M / ASTM A312 across standard schedules (5S, 10S,
                40S, 80S, 160).</p>
            ...
            <div class="row g-4 mt-4 justify-content-center">
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <p>Standard molybdenum-bearing stainless steel grade with excellent corrosion resistance and
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <p>Low-carbon version of SS316 providing improved weldability and resistance to intergranular
                            corrosion after welding.</p>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <p class="text-center mt-3">
                        📌 <strong>SS 316L</strong> provides low carbon content for enhanced weldability and protection
                        against carbide precipitation during heavy gauge welding.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="accordion-box">
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>
                                    SS 316 contains 2–3% molybdenum, which significantly enhances resistance to chloride
                                    pitting, crevice corrosion, and aggressive marine or chemical environments compared to
                                    SS 304.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>
                                    Yes, due to its molybdenum alloy content, SS 316 is considered the standard marine grade
                                    stainless steel and performs exceptionally well in seawater pipelines, desalination
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>
                                    Yes, Grade 316 offers excellent elevated temperature strength, high creep resistance,
                                    and good oxidation resistance up to 870°C in intermittent service and 925°C in
                                    continuous service.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>
                                    Yes, we provide EN 10204 3.1 Mill Test Certificates with every order. Third-Party
                                    Inspection (TPI) reports such as EN 10204 3.2 can also be arranged upon request.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>
                                    Ex-stock standard items are dispatched within 2–5 working days. Customized manufacturing
                                    or project quantities typically take 2–4 weeks depending on order specifications.
                                </p>
                            </div>
                        </div>
