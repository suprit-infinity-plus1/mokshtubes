        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="{{ asset('assets/images/peoduct/u-bent-tubes.webp') }}" alt="U-Bent Tubes for Industrial Heat Exchangers" width="550" height="350" class="img-fluid rounded shadow-sm" 
                    loading="lazy">
                </div>
