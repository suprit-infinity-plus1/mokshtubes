...
@section('meta_description', 'Buy perforated sheets in SS, aluminium & steel. Custom hole patterns, sizes & finishes for
    industrial & architectural use.')
@section('meta_keywords', 'Perforated Sheets, stainless steel perforated sheets, metal perforated sheets, decorative
    perforated panels, industrial perforated sheets, perforated sheet design')
...
@section('content')
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <p class="mb-3">
                Get the complete Perforated Sheets datasheet with chemical composition,
