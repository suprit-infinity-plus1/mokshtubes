...
@section('meta_description',
    'Buy precision shim sheets in SS, brass, copper & aluminium. Tight tolerance shims for industrial, automotive & aerospace use.')
@section('meta_keywords',
    'Shim Sheets, metal shim sheets, precision shims, stainless steel shims, brass shim sheets, industrial shims')
...
@section('content')
    ...
    <div class="sticky-top bg-white border-bottom material-tabs w-100">
        <div class="container">
            ...
            <a href="#manufacturing">Manufacturing Process</a> |
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="{{ asset('assets/images/product/Sheets-Plates-and-Coils/Shim-Sheets.webp') }}" alt="stainless steel shim sheet"
                    ...
                    <div class="pe-md-3">
                        ...
                        <p class="fs-6 mb-4" style="text-align: justify;">
                            At <strong style="color:black;"><a href="{{ url('/contact-us') }}">Moksh Tubes & Fittings
                                    LLP</a></strong>, we supply premium-quality shim sheets in a wide range of materials, thicknesses, and finishes. Our products comply with ASTM, ASME, DIN, EN, and JIS standards, ensuring consistent quality and reliability for precision applications.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody class="text-center">
                                <tr class="t-row">
                                    <td>Material</td>
                                    <td>Stainless Steel, Carbon Steel, Brass, Copper, Aluminium, Nickel Alloys, Titanium</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Grades</td>
    ...
    <section id="grades" class="sec-padd-top sec-padd-bottom">
        <div class="container">
            ...
            <div class="row g-4 mt-4 justify-content-center">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        <div class="advantage-icon"><i class="bi bi-sun"></i></div>
                        <h5>Brass & Copper</h5>
                        <p>C26000, C11000</p>
                    </div>
                </div>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        <div class="application-icon"><i class="bi bi-truck-front"></i></div>
                        <h5>1️⃣ Automotive Industry</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>3️⃣ Industrial Machinery</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>4️⃣ Construction & Engineering</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>6️⃣ Electrical & Electronics</h5>
    ...
    <section id="uses" class="sec-padd-top sec-padd-bottom">
        <div class="container">
            ...
            <div class="row g-4 mt-4 justify-content-center">
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card h-100">
                        ...
                        <h5>Precision alignment & leveling</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card h-100">
                        ...
                        <h5>Spacing & tolerance adjustment</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card h-100">
                        ...
                        <h5>Quick maintenance solution</h5>
                    </div>
                </div>
            ...
            <div class="row g-4 mt-4 justify-content-center">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card h-100">
                        <div class="advantage-icon"><i class="bi bi-stopwatch"></i></div>
    ...
    <section id="manufacturing" class="sec-padd-top sec-padd-bottom bg-light">
        <div class="container">
            <div class="section-title center">
                <h2>Manufacturing Process of Shim Sheets</h2>
            </div>

            <div class="row mt-4">
                <div class="col-md-6">
                    <img src="{{ asset('assets/images/product/Sheets-Plates-and-Coils/Shim-Sheets.webp') }}" alt="precision metal shim sheets" class="img-fluid rounded shadow-sm" loading="lazy">
                </div>
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6" style="text-align: justify;"><strong>Production Steps:</strong></p>
                        <p>1️⃣ Cold rolling for precision thickness</p>
                        <p>2️⃣ Slitting & cutting</p>
                        <p>3️⃣ Surface finishing</p>
                        <p>4️⃣ Annealing (if required)</p>
                        <p>5️⃣ Inspection & packaging</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="tolerances" class="sec-padd-top sec-padd-bottom bg-light">
        <div class="container">
            <div class="row mt-4 justify-content-center">
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="application-card h-100">
                        <div class="application-icon"><i class="bi bi-search"></i></div>
            ...
            <div class="row mt-4 justify-content-center">
                <div class="col-md-6 col-lg-5">
                    <div class="application-card h-100">
                        ...
                        <h5>Buying Guide – Shim Sheets</h5>
                        <p>Before selecting shim sheets:</p>
                        <p>✔ Required thickness accuracy</p>
                        <p>✔ Material type</p>
                        <p>✔ Application (industrial / precision)</p>
                        <p>✔ Sheet vs coil format</p>
                        <p>✔ Corrosion resistance requirement</p>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="application-card h-100">
                        ...
                        <p><strong>Industries We Serve:</strong> Automotive Industry, Aerospace & Aviation, Industrial Machinery, Construction & Infrastructure, Marine & Offshore</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="application/ld+json">
        ...
        },
        {
            ...
            "mainEntity": [
                ...
                {
                "@type": "Question",
                "name": "What thickness range is available?",
                "acceptedAnswer": {
                    "@type": "Answer",
                ...
                {
                "@type": "Question",
                "name": "Where are shim sheets used?",
                "acceptedAnswer": {
                    "@type": "Answer",
