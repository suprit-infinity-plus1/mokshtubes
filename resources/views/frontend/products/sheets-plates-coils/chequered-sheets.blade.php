...
@section('meta_description', 'Buy chequered sheets in SS, aluminium & steel. Anti-slip tread plates for flooring, ramps
    & industrial use.')
@section('meta_keywords', 'Chequered Sheets, tread plates, checker plates, anti-slip sheets, stainless steel chequered
    sheet, aluminium tread plate')
...
@section('content')
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <p class="mb-3">
                Get the complete Chequered Sheets datasheet with chemical composition,
