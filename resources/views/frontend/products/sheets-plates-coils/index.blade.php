...
@section(
    ...
    precision, and superior performance in industrial applications.'
) <!-- 153 characters -->
@section('content')
    ...
    <section class="sec-padd-top sec-padd-bottom bg-white">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                @endforeach --}}
                <div class="col-12 col-sm-6 col-lg-4">
                    <a href="{{ url('products/sheets-plates-coils/chequered-sheets') }}"
                        class="text-decoration-none d-block h-100">
                        <div class="material-card border rounded shadow-sm p-3 text-center h-100 transition"
                            style="border-color: #db7227; transition: 0.3s;">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <a href="{{ url('products/sheets-plates-coils/strips') }}" class="text-decoration-none d-block h-100">
                        <div class="material-card border rounded shadow-sm p-3 text-center h-100 transition"
                            style="border-color: #db7227; transition: 0.3s;">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <a href="{{ url('products/sheets-plates-coils/shim-sheets') }}"
                        class="text-decoration-none d-block h-100">
                        <div class="material-card border rounded shadow-sm p-3 text-center h-100 transition"
                            style="border-color: #db7227; transition: 0.3s;">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <a href="{{ url('products/sheets-plates-coils/coils') }}" class="text-decoration-none d-block h-100">
                        <div class="material-card border rounded shadow-sm p-3 text-center h-100 transition"
                            style="border-color: #db7227; transition: 0.3s;">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <a href="{{ url('products/sheets-plates-coils/cladded-plates') }}"
                        class="text-decoration-none d-block h-100">
                        <div class="material-card border rounded shadow-sm p-3 text-center h-100 transition"
                            style="border-color: #db7227; transition: 0.3s;">
