...
@section('meta_description', 'Buy sheets & plates in stainless steel, carbon steel & alloys. Wide thickness range,
    custom sizes, and industrial-grade materials.')
@section('meta_keywords', 'Sheets & Plates, stainless steel sheets, steel plates, metal sheets, industrial plates, alloy
    steel plates')
...
@section('content')
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download Sheets And Plates Datasheet</h3>
            <p class="mb-3">
                Get the complete Sheets And Plates datasheet with chemical composition,
