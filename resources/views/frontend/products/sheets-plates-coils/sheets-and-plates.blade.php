...
@section('content')
    ...
    <strong class="text-black">Sheets & Plates</strong> are essential flat-rolled metal products used across construction, manufacturing, infrastructure, automotive, shipbuilding, and heavy engineering industries. The main distinction lies in thickness — sheets are typically 0.5 mm to 6 mm thick, while plates are 6 mm and above, designed for structural strength and durability.
</p>

<p class="fs-6 mb-3 text-justify">
    Moksh Tubes & Fittings LLP supplies high-quality metal sheets & plates in a wide variety of materials, finishes, and sizes, sourced and manufactured to ASTM, ASME, EN, JIS, and DIN standards. Our sheets & plates are trusted for their dimensional accuracy, superior surface finish, and long-lasting performance in demanding environments.
</p>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped align-middle">
                ...
                <tbody class="text-start">
                    ...
                    <tr class="t-row">
                        <td>Finishes</td>
                        <td>No.1, 2B, BA, Mirror, Matte, Hairline, PVC Coated, Hot Rolled, Cold Rolled, Pickled & Passivated</td>
                    </tr>
                    <tr class="t-row">
                        <td>Standards</td>
                    ...
                    <tr class="t-row">
                        <td>Types</td>
                        <td>Hot Rolled Sheets/Plates, Cold Rolled Sheets, Chequered Plates, Perforated Sheets</td>
                    </tr>
                    <tr class="t-row">
                        <td>Applications</td>
                        <td>Construction, Shipbuilding, Automotive, Pressure Vessels, Oil & Gas, Industrial Fabrication</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <table class="table table-bordered table-striped align-middle">
        ...
        <tbody class="text-center">
            ...
            <tr class="t-row"><td>25.0</td><td>196.250</td><td>198.250</td><td>67.500</td><td>210.000</td><td>223.500</td></tr>
            <tr class="t-row"><td>30.0</td><td>235.500</td><td>237.900</td><td>81.000</td><td>252.000</td><td>268.200</td></tr>
            <tr class="t-row"><td>35.0</td><td>274.750</td><td>277.550</td><td>94.500</td><td>294.000</td><td>312.900</td></tr>
            <tr class="t-row"><td>40.0</td><td>314.000</td><td>317.200</td><td>108.000</td><td>336.000</td><td>357.600</td></tr>
            <tr class="t-row"><td>50.0</td><td>392.500</td><td>396.500</td><td>135.000</td><td>420.000</td><td>447.000</td></tr>
            <tr class="t-row"><td>60.0</td><td>471.000</td><td>475.800</td><td>162.000</td><td>504.000</td><td>536.400</td></tr>
            <tr class="t-row"><td>80.0</td><td>628.000</td><td>634.400</td><td>216.000</td><td>672.000</td><td>715.200</td></tr>
            <tr class="t-row"><td>100.0</td><td>785.000</td><td>793.000</td><td>270.000</td><td>840.000</td><td>894.000</td></tr>
        </tbody>
    </table>
</div>
    ...
    <section class="sec-padd-top sec-padd-bottom">
        <div class="container">
            ...
            <div class="section-title center mb-3">
                <h4 class="text-center mb-0" style="color: #db7227;"><strong>Sheets and Plates</strong> in a wide range of
            ...
            <table class="table table-bordered table-striped align-middle">
                ...
                <tbody>
                    <tr class="t-row">
                        ...
                        <td>
                            304, 304L, 316, 316L, 310, 321, 347 – corrosion-resistant for food, pharma, and marine uses
                        </td>
                    </tr>
                    <tr class="t-row">
                    ...
                    <tr class="t-row">
                        <td>Nickel Alloys</td>
                        <td>
                            Inconel, Monel, Hastelloy – for heat-resistant and corrosive environments
                        </td>
                    </tr>
                    <tr class="t-row">
                        <td>Aluminum</td>
                        <td>
                            1100, 5052, 6061, 6082 – lightweight, corrosion-resistant, used in transport & aerospace
                        </td>
                    </tr>
                    <tr class="t-row">
                        <td>Copper & Brass</td>
                    ...
                    <tr class="t-row">
                        <td>Titanium</td>
                        <td>
                            Grades 1, 2, 5 – for aerospace, desalination, and medical uses
                        </td>
                    </tr>
                </tbody>
            </table>
   ...
   <section class="sec-padd-top sec-padd-bottom bg-light">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="application-card">
            ...
            <ul>
                <li>Structural fabrication for columns, beams, bridges, facades, flooring, reinforcement for concrete structures</li>
            </ul>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="application-card">
            ...
            <ul>
                <li>Hulls, decks, offshore platforms, pontoons, ballast tanks, storage tanks for harsh marine environments</li>
            </ul>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="application-card">
            ...
            <ul>
                <li>Chassis, panels, truck beds, railway underframes, metro coaches, aerospace components</li>
            </ul>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="application-card">
            ...
            <ul>
                <li>Machine bases, conveyor systems, hoppers, ducts, silos, repair & maintenance applications</li>
            </ul>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="application-card">
            ...
            <ul>
                <li>Interior partitions, exterior cladding, signage, decorative roofing, designer elements</li>
            </ul>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="application-card">
            ...
            <ul>
                <li>Stainless steel sheets for sanitary tanks, cleanroom walls, counters, processing equipment</li>
            </ul>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="application-card">
            ...
            <ul>
                <li>Boiler walls, condensers, solar panel frames, wind turbine parts, hydroelectric structures</li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-6 col-lg-4">
        <div class="advantage-card">
            ...
            <h4>Provides structural strength in heavy engineering projects</h4>
        </div>
    </div>
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="advantage-card">
            ...
            <h4>Essential for pressure-retaining equipment like boilers and tanks</h4>
        </div>
    </div>
</div>
...
<div class="accordion accordion-block">
    ...
    <div class="accord-content">
        <p>
            ...
            Both are used in construction, fabrication, and industrial applications, but plates are generally preferred for heavy-duty uses.
        </p>
    </div>
</div>
...
<div class="accordion accordion-block">
    ...
    <div class="accord-content">
        <p>
            They are available in stainless steel, carbon steel, alloy steel, aluminum, copper, brass, titanium, nickel alloys, duplex/super duplex, and other special alloys.
        </p>
    </div>
</div>
<!--End single accordion box-->
...
<div class="accordion accordion-block">
    ...
    <div class="accord-content">
        <p>
            Sheets & plates can be supplied in finishes such as 2B, BA, HR, No.1, No.4, polished, matte, checkered, perforated, or coated.
        </p>
    </div>
</div>
<!--End single accordion box-->
