...
@section('meta_description', 'Buy cladded plates with stainless steel, nickel alloy & titanium cladding. High strength,
    corrosion-resistant plates for industrial use.')
@section('meta_keywords', 'Cladded Plates, clad plates, stainless steel clad plates, nickel alloy clad plates, composite
    metal plates, industrial clad plates')
...
@section('content')
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <p class="mb-3">
                Get the complete Cladded Plates datasheet with chemical composition,
