...
@section('meta_description', 'Buy metal strips in stainless steel, aluminium, copper & more. Precision slit strips with
    custom widths & thickness. India & export supply.')
@section('meta_keywords', 'Metal Strips, stainless steel strips, precision metal strips, aluminium strips, copper
    strips, steel strips')
...
@section('content')
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download Strips Datasheet</h3>
            <p class="mb-3">
                Get the complete Strips datasheet with chemical composition,
