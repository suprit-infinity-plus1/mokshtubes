            ...
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    ...
                    <p class="text-center mt-3 px-3 py-2 text-white position-relative"
                        ...
                        Spectacle Blind Flanges are critical components used in <a
                            href="{{ route('products.pipes-tubes') }}"
                            style="color: blue; text-decoration: underline;">piping systems</a> to isolate <br>sections of a
                        pipeline for maintenance or operation. These <br><a
                            href="{{ route('products.pipe-fittings-flanges-fasteners') }}"
                            style="color: blue; text-decoration: underline;">flanges</a> consist of a solid ring and a
                        hollow ring, allowing for quick visual indication <br>of whether the line is open or closed.
                        At Moksh Tubes & Fittings LLP, we are a trusted Spectacle Blind flange supplier and exporter,
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="{{ asset('assets/images/fasteners/blind-flanges_11zon.jpg') }}"
                        alt="Spectacle Blind Flanges Overview" class="img-fluid rounded shadow-sm" loading="lazy">
                </div>
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-3 text-justify" style="text-align: justify;">
                            <strong class="text-black">Spectacle Blind Flanges</strong> (also known as Figure-8 blinds) are
                            simple safety devices used to stop the flow in a pipeline during maintenance. They are shaped
                            like a pair of glasses, hence the name.
                        </p>

                        <ul class="fs-6 mb-3 list-unstyled">
                            <li class="mb-1"><i class="bi bi-check-circle-fill text-primary"></i> <a
                                    href="{{ route('products.pipes-tubes') }}" style="color: blue;">Pipe</a> isolation
                                without removing sections of the line</li>
                            <li class="mb-1"><i class="bi bi-check-circle-fill text-primary"></i> Reversible design
                                (open/closed)</li>
                            <li class="mb-1"><i class="bi bi-check-circle-fill text-primary"></i> Easy visual confirmation
                                of line status</li>
                        </ul>

                        <p class="fs-6 text-justify" style="text-align: justify;">
                            These flanges are commonly used in the petrochemical, chemical processing, and oil & gas
                            industries, where strict isolation is required for safety.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- <section id="export" class="sec-padd-top sec-padd-bottom">
                    <div class="container">
                        ...
                        <p class="fs-6 text-center text-muted mb-4">
                            We are a reliable Spectacle Blind flange supplier and exporter, supplying globally. <br>Trusted by EPC
            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    ...
                    <ul class="fs-6 list-unstyled mb-5">
                        ...
                        <li class="mb-3 p-3 bg-white border rounded shadow-sm"><i
                                class="bi bi-check-circle-fill text-primary me-2"></i> Prevents accidental contamination
                        </li>
                    </ul>
                ...
                <div id="buying-guide" class="col-lg-6">
                    <div class="p-4 bg-white rounded shadow-sm border-start border-4 border-warning h-100">
                        ...
                        <p class="fs-6 text-muted">Before selecting Spectacle Blind flanges or other <a
                                href="{{ route('products.pipe-fittings-flanges-fasteners') }}"
                        ...
                        <ul class="fs-6 list-unstyled font-weight-bold">
                            ...
                            <li class="mb-2"><i class="bi bi-arrow-right text-warning me-2"></i> Verify <a
                                    href="{{ route('products.pipes-tubes') }}" style="color: blue;">pipe</a> compatibility
                            </li>
                            <li class="mb-2"><i class="bi bi-arrow-right text-warning me-2"></i> Confirm facing type</li>
                            <li class="mb-2"><i class="bi bi-arrow-right text-warning me-2"></i> Ensure ASME B16.48
                                certification</li>
                        </ul>
                ...
                <div class="col-lg-10">
                    <div class="accordion-box">
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>A spectacle blind provides an absolute, fail-safe block with visual confirmation, whereas
                                    a valve might leak.</p>
                            </div>
                        </div>
                        <div class="accordion accordion-block">
                            <div class="accord-btn">
