...
@section('content')
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download Flanges Datasheet</h3>
            <p class="mb-3">
                Get the complete Flanges datasheet with chemical composition,
                            ...
                            <tbody class="text-start">
                                <tr class="t-row">
                                    ...
                                    <td>Stainless Steel, Carbon Steel, Alloy Steel, <a
                                        ...
                                        <a href="{{ route('materials.titanium') }}">Titanium</a>, Copper Alloys
                                    </td>
                                </tr>
                                <tr class="t-row">
                                    <td>Grades</td>
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h5>Stainless, carbon, <a href="{{ route('materials.nickel-Based-Superalloys') }}">nickel</a>,
                            titanium, and <a href="{{ route('materials.copper-Alloys') }}">copper alloys</a> (stainless
                            flange, MS flange)</h5>
                    </div>
                </div>
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5><a href="{{ url('products/pipe-fittings-flanges-fasteners/custom-fabricated-fittings') }}">Custom
                    ...
                    <div class="accordion-box">
                        ...
                        <div class="accordion accordion-block">
                            <div class="accord-btn">
                                <h4>What is a <a href="{{ url('products/flanges-and-gaskets') }}">flange</a>?
                                </h4>
                            </div>
...
@section('jsscripts')
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download Fittings And Flanges Datasheet</h3>
            <p class="mb-3">
                Get the complete Fittings And Flanges datasheet with chemical composition,
                mechanical properties, heat treatment details, and applications.
                Enter your email to receive the PDF instantly.
            </p>
