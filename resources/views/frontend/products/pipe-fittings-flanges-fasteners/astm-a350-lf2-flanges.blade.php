...
@section('title', 'ASTM A350 LF2 Flanges | Moksh Tubes')
@section('meta_description', 'ASTM A350 LF2 Flanges – premium low-temperature carbon steel flanges for diverse industrial applications.')
@section('meta_keywords', 'ASTM A350 LF2 Flanges, low temp carbon steel flanges, forged flanges')
@section('og_image', asset('assets/images/fasteners/astm-a350-lf2-flanges_11zon.jpg'))
@section('og_type', 'product')
@section('content')

    <section class="breadcrumb-area" style="background-image: url({{ asset('assets/images/fasteners/astm-a350-lf2-flanges_11zon.jpg') }});">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    <h1>ASTM A350 LF2 Flanges</h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-7 col-md-9">
                    <div style="background: linear-gradient(135deg, #f8faff 0%, #eef3fb 100%); border: 2px solid #e0e8f7; border-radius: 20px; padding: 60px 40px; box-shadow: 0 8px 40px rgba(23,66,104,0.10);">
                        ...
                        <p class="mb-4" style="color: #555; font-size: 1.05rem; line-height: 1.7;">
                            ...
                            <strong style="color: #db7227;">ASTM A350 LF2 Flanges</strong>.
                        ...
                        <div style="background: #fff; border-radius: 12px; padding: 20px 28px; display: inline-block; border: 1.5px solid #e0e8f7; margin-bottom: 32px; text-align: left;">
                            ...
                            <ul class="mb-0" style="color: #555; padding-left: 18px; line-height: 1.9;">
                                <li>Standard: ASTM A350</li>
                                <li>Material: Low-Temperature Carbon Steel (LF2)</li>
                                <li>Types: WNRF, SORF, Blind, Lap Joint</li>
                                <li>Applications: Cold environments, oil and gas, cryogenic piping</li>
                            </ul>
                        </div>
