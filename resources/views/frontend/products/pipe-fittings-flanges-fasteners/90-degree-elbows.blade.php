...
<!-- 52 characters -->
@section('meta_description', 'High-quality 90 Degree Pipe Elbows (LR & SR) for right-angle flow direction changes.
Available in Stainless Steel, Carbon Steel, and Alloy Steel.')
@section('meta_keywords', '90 Degree Elbow, Pipe Elbow, Buttweld Elbow, Stainless Steel Elbow, Carbon Steel Elbow, ASME
B16.9')
...
@section('content')
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download 90 Degree Elbows Datasheet</h3>
            <p class="mb-3">
                Get the complete 90 Degree Elbows datasheet with chemical composition,
    ...
    <section id="size-weight" class="sec-padd-top sec-padd-bottom bg-light">
        ...
        <div class="container">
            <div class="section-title center mb-4">
                <h2 class="fw-bold" style="color: #174268;">90 Degree Elbows Weight Chart</h2>
            </div>
        ...
        <div class="container">
            <div class="contact-cta-box">
                ...
                <p>For further information, bulk quotes, or custom high-pressure requirements for 90 Degree Elbows,
                    <strong>Moksh Tubes & Fittings LLP</strong> is your reliable industrial partner.
                </p>
