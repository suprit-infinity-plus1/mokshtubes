...
@section(
    'meta_description',
    'Moksh Tubes & Fittings LLP is a leading manufacturer, supplier & exporter of Weld Neck Flanges in Stainless Steel, Carbon Steel, Alloy Steel, Duplex, Super Duplex, Nickel Alloys & Titanium. ASME B16.5 certified with worldwide delivery.'
)
@section(
    'meta_keywords',
    'Weld Neck Flanges, Weld Neck Flanges Manufacturer, Weld Neck Flanges Supplier, Weld Neck Flanges Exporter, Stainless Steel Weld Neck Flanges, Carbon Steel Weld Neck Flanges, Alloy Steel Weld Neck Flanges, Duplex Weld Neck Flanges, Super Duplex Weld Neck Flanges, Forged Weld Neck Flanges, ASME B16.5 Weld Neck Flanges, ASME B16.47 Weld Neck Flanges, RF Weld Neck Flanges, RTJ Weld Neck Flanges, Industrial Weld Neck Flanges, Butt Weld Flanges, Forged Pipe Flanges, High Pressure Flanges, Industrial Pipe Flanges, Stainless Steel Flanges, Corrosion Resistant Flanges, Raised Face Flanges, Ring Type Joint Flanges, Flat Face Flanges, Oil & Gas Pipe Flanges, Petrochemical Flanges, Power Plant Flanges, Process Piping Components'
)
@section('og_title', 'Weld Neck Flanges Manufacturer, Supplier & Exporter | Moksh Tubes')
@section('og_description', 'Premium-quality Weld Neck Flanges manufactured in Stainless Steel, Carbon Steel, Alloy Steel, Duplex, Super Duplex, Nickel Alloys & Titanium. ASME B16.5 & ASME B16.47 certified with worldwide export support.')
...
@section('twitter_description', 'Buy premium-quality Weld Neck Flanges in RF, RTJ & FF facing types. Available in multiple pressure classes, sizes, and material grades with fast worldwide delivery.')
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    ...
                    <p class="text-center mt-3 px-3 py-2 text-white position-relative"
                        ...
                        Weld Neck Flanges are high-strength pipe flanges designed with a long tapered hub that provides excellent reinforcement and smooth stress distribution. They are widely used in high-pressure, high-temperature, and critical piping systems where strength, durability, and leak-proof performance are essential. At Moksh Tubes & Fittings LLP, we manufacture, supply, and export premium-quality Weld Neck Flanges in stainless steel, carbon steel, alloy steel, duplex, super duplex, nickel alloys, and titanium grades. Our flanges are manufactured to international standards, ensuring exceptional performance in demanding industrial applications.
                    </p>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <p class="fs-6 mb-3 text-justify">
                        A <strong>Weld Neck Flange (WN Flange)</strong> features a long tapered hub that is butt welded directly to the pipe, creating a strong and permanent connection. This design minimizes stress concentration at the base of the flange and provides excellent structural integrity, making it the preferred choice for high-pressure and high-temperature services.
                    </p>

                    <p class="fs-6 text-justify">
                        At <a href="{{ route('index') }}">Moksh Tubes & Fittings LLP</a>, we manufacture precision-engineered Weld Neck Flanges using premium-quality raw materials and advanced machining processes. Available in a wide range of sizes, pressure classes, and material grades, our flanges are suitable for oil & gas, petrochemical, chemical processing, power generation, marine, and other industrial piping systems.
                    </p>
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <p class="mb-3">
                Get the complete datasheet with chemical composition, mechanical properties, dimension details, and application
            ...
            <form id="leadForm" method="POST" action="https://mokshtubes.com/datasheet-leads-capture" class="mb-3">
                ...
                <div class="row justify-content-center">
                    <input type="hidden" name="pdf" value="weld-neck-flanges-datasheet.pdf">
    ...
    <section id="size-chart" class="sec-padd-top sec-padd-bottom">
        <div class="container">
            ...
            <p class="text-center pb-3">
                Weld Neck Flanges are manufactured in accordance with <strong>ASME B16.5</strong> and <strong>ASME B16.47</strong> standards and are available in various pressure classes and sizes.
            </p>
            ...
            <div class="table-responsive mt-4">
                <table class="table table-bordered table-striped align-middle text-center">
                    ...
                    <tbody>
                        ...
                        <tr class="t-row"><td>2"</td><td>150</td><td>152</td><td>19</td><td>2.90</td></tr>
                        <tr class="t-row"><td>3"</td><td>150</td><td>191</td><td>24</td><td>5.20</td></tr>
                        <tr class="t-row"><td>4"</td><td>150</td><td>229</td><td>24</td><td>7.80</td></tr>
                        <tr class="t-row"><td>6"</td><td>150</td><td>279</td><td>27</td><td>13.50</td></tr>
                        <tr class="t-row"><td>8"</td><td>150</td><td>343</td><td>30</td><td>21.80</td></tr>
                        <tr class="t-row"><td>10"</td><td>150</td><td>406</td><td>32</td><td>33.20</td></tr>
                        <tr class="t-row"><td>12"</td><td>150</td><td>483</td><td>35</td><td>49.50</td></tr>
                        <tr class="t-row"><td>16"</td><td>150</td><td>597</td><td>38</td><td>82.00</td></tr>
                        <tr class="t-row"><td>20"</td><td>150</td><td>711</td><td>43</td><td>132.50</td></tr>
                        <tr class="t-row"><td>24"</td><td>150</td><td>813</td><td>48</td><td>195.00</td></tr>
                    </tbody>
                </table>
            </div>
            <p class="text-center mt-2 small text-muted"><strong>Note:</strong> Dimensions and weights are approximate and may vary depending on the pressure class (150–2500), facing type (RF, RTJ, FF), material grade, and applicable ASME B16.5/B16.47 standards. Custom sizes are available on request.</p>
        </div>
    </section>
                        ...
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody class="text-start">
                                ...
                                <tr class="t-row">
                                    ...
                                    <td style="padding-left: 20px;">DIN 2631–2638</td>
                                </tr>
                                <tr class="t-row">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h4>LNG &amp; Natural Gas Projects</h4>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="advantage-card">
    ...
    <section id="mechanical-properties" class="sec-padd-top sec-padd-bottom">
        <div class="container">
            <div class="section-title center mb-4">
                ...
                <p class="text-center">The mechanical properties of <strong>Weld Neck Flanges</strong> depend on the selected material grade and comply with applicable ASTM and ASME standards. The table below represents typical values for commonly supplied stainless steel grades.</p>
            </div>
            ...
            <p class="mt-2 text-muted text-center"><small><strong>Note:</strong> Mechanical properties for Carbon Steel, Alloy Steel, Duplex, Super Duplex, Nickel Alloy, and Titanium Weld Neck Flanges are available in accordance with their respective ASTM/ASME material specifications.</small></p>
        </div>
    </section>
                    ...
                    <div class="accordion-box">
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>A Weld Neck Flange is a forged flange with a long tapered hub that is butt welded to a pipe, providing a strong, leak-proof, and durable connection.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>They are widely used in oil &amp; gas, petrochemical, power plants, refineries, offshore platforms, chemical processing, and other high-pressure industrial piping systems.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>We manufacture Weld Neck Flanges in stainless steel, carbon steel, alloy steel, duplex, super duplex, nickel alloys, and titanium grades.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>Yes. We manufacture Weld Neck Flanges in standard and customized sizes, pressure classes, and material grades according to customer specifications.</p>
                            </div>
                        </div>
