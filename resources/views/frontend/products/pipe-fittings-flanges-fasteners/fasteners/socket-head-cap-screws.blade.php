...
@section('title', 'Socket Head Cap Screws | Moksh Tubes')
@section('meta_description', 'Socket Head Cap Screws – stainless steel and alloy socket cap screws for precision machinery, aerospace, and industrial equipment.')
@section('meta_keywords', 'socket head cap screws, socket cap screws, Allen head screws, stainless steel screws')
@section('og_image', asset('assets/images/product/flangs/FASTENERS.webp'))
@section('og_type', 'product')
@section('content')

    <section class="breadcrumb-area" style="background-image: url({{ asset('assets/images/product/flangs/FASTENERS.webp') }});">
        <div class="container">
                ...
                <div class="col-lg-7 col-md-9">
                    <div style="background: linear-gradient(135deg, #f8faff 0%, #eef3fb 100%); border: 2px solid #e0e8f7; border-radius: 20px; padding: 60px 40px; box-shadow: 0 8px 40px rgba(23,66,104,0.10);">
                        ...
                        <p class="mb-4" style="color: #555; font-size: 1.05rem; line-height: 1.7;">
                            ...
                            <strong style="color: #db7227;">Socket Head Cap Screws</strong>.
                        ...
                        <div style="background: #fff; border-radius: 12px; padding: 20px 28px; display: inline-block; border: 1.5px solid #e0e8f7; margin-bottom: 32px; text-align: left;">
                            ...
                            <ul class="mb-0" style="color: #555; padding-left: 18px; line-height: 1.9;">
                                <li>Type: Socket Head Cap Screws (Allen Screws)</li>
                                <li>Material: SS 304/316, Alloy Steel, Titanium, Inconel</li>
                                <li>Standard: ISO 4762 / DIN 912 / ASME B18.3</li>
                                <li>Applications: Machinery, aerospace, automotive, tooling</li>
                            </ul>
                        </div>
