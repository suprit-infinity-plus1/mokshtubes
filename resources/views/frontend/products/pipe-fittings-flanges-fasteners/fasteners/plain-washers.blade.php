...
@section('title', 'Plain Washers | Moksh Tubes')
@section('meta_description', 'Plain Washers – stainless steel, carbon steel, and alloy plain flat washers for load distribution and protection in bolted joints.')
@section('meta_keywords', 'plain washers, flat washers, stainless steel washers, DIN 125 washers')
                ...
                <div class="col-lg-7 col-md-9">
                    <div style="background: linear-gradient(135deg, #f8faff 0%, #eef3fb 100%); border: 2px solid #e0e8f7; border-radius: 20px; padding: 60px 40px; box-shadow: 0 8px 40px rgba(23,66,104,0.10);">
                        ...
                        <p class="mb-4" style="color: #555; font-size: 1.05rem; line-height: 1.7;">
                            ...
                            <strong style="color: #db7227;">Plain Washers</strong>.
                        ...
                        <div style="background: #fff; border-radius: 12px; padding: 20px 28px; display: inline-block; border: 1.5px solid #e0e8f7; margin-bottom: 32px; text-align: left;">
                            ...
                            <ul class="mb-0" style="color: #555; padding-left: 18px; line-height: 1.9;">
                                <li>Type: Plain / Flat Washers</li>
                                <li>Material: SS 304/316, Carbon Steel, Alloy, Copper, Titanium</li>
                                <li>Standard: DIN 125 / ISO 7089 / ASME B18.22.1</li>
                                <li>Applications: Piping, structural, machinery, electrical</li>
                            </ul>
                        </div>
