...
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    ...
                    <p class="text-center mt-3 px-3 py-2 text-white position-relative"
                        ...
                        Threaded Rods are fully threaded fasteners used for fastening, anchoring, bracing, and structural
                        support in construction, industrial, and engineering applications. They provide excellent
                        load-bearing capacity, corrosion resistance, and reliable performance in demanding environments. At
                        <a href="{{ route('index') }}" class="text-white text-decoration-underline">Moksh Tubes & Fittings
                            LLP</a>, we manufacture, supply, and export premium-quality Threaded Rods in stainless steel,
                        carbon steel, alloy steel, duplex, super duplex, and nickel alloy grades. Manufactured to
                        international standards, our threaded rods ensure superior strength, precision, and long service
                        life.
                    </p>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <p class="fs-6 mb-3 text-justify">
                        A <strong>Threaded Rod</strong>, also known as an <strong>All Thread Rod</strong> or <strong>Stud
                            Rod</strong>, is a long metal rod with continuous threads along its entire length. It is used
                        with nuts and washers to create strong and adjustable fastening solutions for piping systems, steel
                        structures, machinery, HVAC installations, and construction projects. Threaded rods are available in
                        various diameters, lengths, thread types, and material grades to meet different industrial
                        requirements.
                    </p>
                    <p class="fs-6 text-justify">
                        At <a href="{{ route('index') }}">Moksh Tubes & Fittings LLP</a>, we manufacture
                        precision-engineered Threaded Rods using premium-quality raw materials and advanced threading
                        technology. Our rods offer excellent dimensional accuracy, high tensile strength, and outstanding
                        corrosion resistance, making them suitable for both indoor and outdoor applications.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="chemical-composition" class="sec-padd-top sec-padd-bottom bg-light">
        <div class="container">
            ...
            <p class="text-center pb-3">
                The chemical composition of <strong>Threaded Rods</strong> varies depending on the selected material grade.
                At Moksh Tubes & Fittings LLP, our Threaded Rods are manufactured using premium-quality raw materials that
                comply with ASTM, ASME, DIN, ISO, EN, and BS standards, ensuring excellent corrosion resistance, high
            ...
            <p class="mt-2 text-muted text-center"><small><strong>Note:</strong> Chemical composition varies depending on
                    the selected material grade. Carbon Steel, Alloy Steel, ASTM A193 B7/B7M, ASTM A320 L7, Duplex, Super
                    Duplex, and Nickel Alloy Threaded Rods are also available in accordance with the relevant ASTM and ASME
                    material specifications.</small></p>
        </div>
    </section>
    ...
    <section id="size-chart" class="sec-padd-top sec-padd-bottom">
        <div class="container">
            ...
            <p class="text-center pb-3">
                Threaded Rods are available in a wide range of metric and imperial sizes with various lengths to meet
            ...
            <p class="text-center mt-2 small text-muted"><strong>Note:</strong> Dimensions and weights are approximate and
                may vary depending on the material grade, thread standard (Metric, UNC, UNF, BSW, BSP), coating, and
                manufacturing tolerances. Custom diameters, lengths, and thread types are available upon request.</p>
        </div>
    </section>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 text-center shadow-sm grade-card">
                        <div class="card-body py-4">
                            ...
                            <p class="card-text small mb-0">Carbon Steel, Alloy Steel<br>ASTM A193 Grade B7/B7M, ASTM A320
                                Grade L7</p>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody class="text-start">
                                ...
                                <tr class="t-row">
                                    ...
                                    <td style="padding-left: 20px;">DIN 975 / DIN 976</td>
                                </tr>
                                <tr class="t-row">
                                    <td style="padding-left: 20px;"><strong>ISO</strong></td>
                                    <td style="padding-left: 20px;">ISO 898-1</td>
                                </tr>
                                <tr class="t-row">
                                    <td style="padding-left: 20px;"><strong>EN</strong></td>
                                    <td style="padding-left: 20px;">EN ISO 898</td>
                                </tr>
                                <tr class="t-row">
    ...
    <section id="mechanical-properties" class="sec-padd-top sec-padd-bottom">
        <div class="container">
            <div class="section-title center mb-4">
                ...
                <p class="text-center">The mechanical properties of <strong>Threaded Rods</strong> depend on the selected
            ...
            <p class="text-center mt-2 small text-muted"><strong>Note:</strong> Mechanical properties for Carbon Steel,
                Alloy Steel, ASTM A193 B7/B7M, ASTM A320 L7, Duplex, Super Duplex, and Nickel Alloy Threaded Rods are
                available in accordance with their respective ASTM/ASME material specifications upon request.</p>
        </div>
    </section>
                    ...
                    <div class="accordion-box">
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>
                                    A Threaded Rod is a fully threaded metal rod used with nuts and washers for fastening,
                                    anchoring, bracing, and structural support in industrial and construction applications.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>
                                    Threaded Rods are widely used in construction, steel fabrication, piping systems, HVAC
                                    installations, industrial machinery, power plants, and offshore projects.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>
                                    We manufacture Threaded Rods in stainless steel, carbon steel, alloy steel, duplex,
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>
                                    Yes. We manufacture Threaded Rods in custom diameters, lengths, thread types, coatings,
                                    and material grades according to customer specifications.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <section class="sec-padd-top sec-padd-bottom bg-light">
        <div class="container">
            <div class="contact-cta-box text-center">
                ...
                <p>
                    Looking for a trusted <strong>Threaded Rods</strong> manufacturer and supplier? Contact <strong>Moksh
                        Tubes & Fittings LLP</strong> for premium-quality industrial threaded rods, competitive pricing,
