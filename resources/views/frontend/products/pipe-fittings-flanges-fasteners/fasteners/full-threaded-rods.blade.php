...
@section('title', 'Full Threaded Rods | Moksh Tubes')
@section('meta_description', 'Full Threaded Rods – stainless steel, carbon steel, and alloy fully threaded rods for construction, industrial, and structural applications.')
@section('meta_keywords', 'full threaded rods, all-thread rods, stainless steel threaded rods, B7 threaded rods')
                ...
                <div class="col-lg-7 col-md-9">
                    <div style="background: linear-gradient(135deg, #f8faff 0%, #eef3fb 100%); border: 2px solid #e0e8f7; border-radius: 20px; padding: 60px 40px; box-shadow: 0 8px 40px rgba(23,66,104,0.10);">
                        ...
                        <p class="mb-4" style="color: #555; font-size: 1.05rem; line-height: 1.7;">
                            ...
                            <strong style="color: #db7227;">Full Threaded Rods</strong>.
                        ...
                        <div style="background: #fff; border-radius: 12px; padding: 20px 28px; display: inline-block; border: 1.5px solid #e0e8f7; margin-bottom: 32px; text-align: left;">
                            ...
                            <ul class="mb-0" style="color: #555; padding-left: 18px; line-height: 1.9;">
                                <li>Type: Fully Threaded Rods / All-Thread Rods</li>
                                <li>Material: SS 304/316, Carbon Steel, Alloy Steel, Duplex</li>
                                <li>Size: M6 to M100 / ¼" to 4"</li>
                                <li>Length: Up to 3000 mm or custom</li>
                            </ul>
                        </div>
