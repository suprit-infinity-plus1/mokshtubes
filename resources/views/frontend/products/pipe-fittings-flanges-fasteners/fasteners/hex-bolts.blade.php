...
@section('meta_description', 'Moksh Tubes & Fittings LLP is a leading manufacturer, supplier & exporter of Hex Bolts in Stainless Steel, Carbon Steel, Alloy Steel, Duplex, Super Duplex & Nickel Alloys. ASTM A193, DIN & ISO standards with worldwide delivery.')
@section('meta_keywords', 'Hex Bolts, Hex Bolts Manufacturer, Hex Bolts Supplier, Hex Bolts Exporter, Stainless Steel Hex Bolts, Carbon Steel Hex Bolts, Alloy Steel Hex Bolts, Duplex Hex Bolts, Super Duplex Hex Bolts, ASTM A193 Hex Bolts, ASTM A320 Hex Bolts, DIN 931 Hex Bolts, DIN 933 Hex Bolts, ISO 4014 Hex Bolts, ISO 4017 Hex Bolts, Heavy Duty Hex Bolts, Industrial Fasteners, High Tensile Hex Bolts, Structural Bolts, Full Thread Hex Bolts, Partial Thread Hex Bolts, Corrosion Resistant Bolts, Heavy Hex Bolts, Mechanical Fasteners, Construction Fasteners, Pipeline Fasteners, Engineering Fasteners, Precision Fasteners')
@section('og_title', 'Hex Bolts Manufacturer, Supplier & Exporter | Moksh Tubes')
@section('og_description', 'Premium-quality Hex Bolts manufactured in Stainless Steel, Carbon Steel, Alloy Steel, Duplex, Super Duplex & Nickel Alloys. ASTM A193, DIN & ISO compliant with worldwide export support.')
@section('og_image', asset('assets/images/fasteners/hax-bolt.png'))
@section('og_type', 'product')
@section('twitter_title', 'Hex Bolts Manufacturer in India')
@section('twitter_description', 'Buy premium-quality Hex Bolts for construction, structural steel, industrial machinery, and piping systems. Available in multiple grades, thread types, and finishes with fast worldwide delivery.')
@section('content')
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <form id="leadForm" method="POST" action="https://mokshtubes.com/datasheet-leads-capture" class="mb-3">
                ...
                <div class="row justify-content-center">
                    <input type="hidden" name="pdf" value="hex-bolts-datasheet.pdf">
