                        ...
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody class="text-start">
                                <tr class="t-row">
                                    ...
                                    <td style="padding-left: 20px;">ASTM F436, ASTM F844</td>
                                </tr>
                                <tr class="t-row">
                                    <td style="padding-left: 20px;"><strong>ASME</strong></td>
                                    <td style="padding-left: 20px;">ASME B18.22.1</td>
                                </tr>
                                <tr class="t-row">
                                    <td style="padding-left: 20px;"><strong>DIN</strong></td>
                                    <td style="padding-left: 20px;">DIN 125, DIN 127, DIN 9021</td>
                                </tr>
                                <tr class="t-row">
                                    <td style="padding-left: 20px;"><strong>ISO</strong></td>
                                    <td style="padding-left: 20px;">ISO 7089, ISO 7090</td>
                                </tr>
                                <tr class="t-row">
                                    <td style="padding-left: 20px;"><strong>EN</strong></td>
                                    <td style="padding-left: 20px;">EN ISO 7089</td>
                                </tr>
                                <tr class="t-row">
                                    <td style="padding-left: 20px;"><strong>BS</strong></td>
                                    <td style="padding-left: 20px;">BS 4320</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
