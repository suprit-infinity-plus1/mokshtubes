...
@section(
    'meta_description',
    'Moksh Tubes & Fittings LLP is a leading manufacturer, supplier & exporter of Slip On Flanges in Stainless Steel, Carbon Steel, Alloy Steel, Duplex, Super Duplex, Nickel Alloys & Titanium. ASME B16.5 certified with worldwide delivery.'
)
@section(
    'meta_keywords',
    'Slip On Flanges, Slip On Flanges Manufacturer, Slip On Flanges Supplier, Slip On Flanges Exporter, Stainless Steel Slip On Flanges, Carbon Steel Slip On Flanges, Alloy Steel Slip On Flanges, Duplex Slip On Flanges, Super Duplex Slip On Flanges, Forged Slip On Flanges, ASME B16.5 Slip On Flanges, SO Flanges, Double Fillet Weld Flanges, Industrial Slip On Flanges, RF Slip On Flanges, RTJ Slip On Flanges, Forged Pipe Flanges, Industrial Pipe Flanges, Double Fillet Weld Connection, Corrosion Resistant Flanges, Raised Face Flanges, Ring Type Joint Flanges, Flat Face Flanges, Oil & Gas Pipe Flanges, Petrochemical Flanges, Process Piping Components, Low Pressure Pipe Flanges, Medium Pressure Pipe Flanges'
)
@section('og_title', 'Slip On Flanges Manufacturer, Supplier & Exporter | Moksh Tubes')
@section('og_description', 'Premium-quality Slip On Flanges manufactured in Stainless Steel, Carbon Steel, Alloy Steel, Duplex, Super Duplex, Nickel Alloys & Titanium. ASME B16.5 & ASME B16.47 certified with worldwide export support.')
...
@section('twitter_description', 'Buy premium-quality Slip On Flanges for industrial piping systems. Available in RF, RTJ & FF facing types, multiple pressure classes, and material grades with fast worldwide delivery.')
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    ...
                    <p class="text-center mt-3 px-3 py-2 text-white position-relative"
                        ...
                        Slip On Flanges are one of the most widely used pipe flanges, designed to slide over the pipe and be welded from both the inside and outside for a secure, leak-resistant connection. They are ideal for low to medium-pressure piping systems and are valued for their easy installation, cost-effectiveness, and reliable performance. At Moksh Tubes & Fittings LLP, we manufacture, supply, and export premium-quality Slip On Flanges in stainless steel, carbon steel, alloy steel, duplex, super duplex, nickel alloys, and titanium grades. Our flanges are manufactured to international standards, ensuring durability and long-lasting performance across various industrial applications.
                    </p>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <p class="fs-6 mb-3 text-justify">
                        A <strong>Slip On Flange (SO Flange)</strong> is designed to fit over the outside diameter of a pipe before being fillet welded on both the inside and outside. Its simple design allows for easy pipe alignment and installation, making it a preferred choice for low to medium-pressure applications where ease of fabrication and cost savings are important.
                    </p>

                    <p class="fs-6 text-justify">
                        At <a href="{{ route('index') }}">Moksh Tubes & Fittings LLP</a>, we manufacture precision-engineered Slip On Flanges using high-quality raw materials and advanced machining technology. Available in a wide range of sizes, pressure classes, and material grades, our flanges provide reliable sealing performance and excellent corrosion resistance for demanding industrial environments.
                    </p>
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <form id="leadForm" method="POST" action="https://mokshtubes.com/datasheet-leads-capture" class="mb-3">
                ...
                <div class="row justify-content-center">
                    <input type="hidden" name="pdf" value="slip-on-flanges-datasheet.pdf">
...
<!-- 
    ...
    <section id="size-chart" class="sec-padd-top sec-padd-bottom">
        <div class="container">
            ...
            <p class="text-center pb-3">
                Slip On Flanges are manufactured in accordance with <strong>ASME B16.5</strong> and <strong>ASME B16.47</strong> standards and are available in a wide range of nominal pipe sizes, pressure classes, and facing types.
            </p>
            ...
            <div class="table-responsive mt-4">
                <table class="table table-bordered table-striped align-middle text-center">
                    ...
                    <tbody>
                        ...
                        <tr class="t-row"><td>1½"</td><td>150</td><td>127</td><td>16</td><td>1.70</td></tr>
                        <tr class="t-row"><td>2"</td><td>150</td><td>152</td><td>19</td><td>2.70</td></tr>
                        <tr class="t-row"><td>3"</td><td>150</td><td>191</td><td>24</td><td>4.90</td></tr>
                        <tr class="t-row"><td>4"</td><td>150</td><td>229</td><td>24</td><td>7.40</td></tr>
                        <tr class="t-row"><td>6"</td><td>150</td><td>279</td><td>27</td><td>12.90</td></tr>
                        <tr class="t-row"><td>8"</td><td>150</td><td>343</td><td>30</td><td>20.80</td></tr>
                        <tr class="t-row"><td>10"</td><td>150</td><td>406</td><td>32</td><td>31.80</td></tr>
                        <tr class="t-row"><td>12"</td><td>150</td><td>483</td><td>35</td><td>47.80</td></tr>
                        <tr class="t-row"><td>16"</td><td>150</td><td>597</td><td>38</td><td>79.50</td></tr>
                        <tr class="t-row"><td>20"</td><td>150</td><td>711</td><td>43</td><td>128.80</td></tr>
                        <tr class="t-row"><td>24"</td><td>150</td><td>813</td><td>48</td><td>189.50</td></tr>
                    </tbody>
                </table>
            </div>
                        ...
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody class="text-start">
                                ...
                                <tr class="t-row">
                                    ...
                                    <td style="padding-left: 20px;">DIN 2573 / DIN 2576</td>
                                </tr>
                                <tr class="t-row">
    ...
    <section id="mechanical-properties" class="sec-padd-top sec-padd-bottom">
        <div class="container">
            <div class="section-title center mb-4">
                ...
                <p class="text-center">The mechanical properties of <strong>Slip On Flanges</strong> depend on the selected material grade and comply with applicable ASTM and ASME standards. The table below shows the typical mechanical properties for commonly supplied stainless steel grades.</p>
            </div>
            ...
            <p class="mt-2 text-muted text-center"><small><strong>Note:</strong> Mechanical properties for Carbon Steel, Alloy Steel, Duplex, Super Duplex, Nickel Alloy, and Titanium Slip On Flanges are available in accordance with their respective ASTM/ASME material specifications upon request.</small></p>
        </div>
    </section>
                    ...
                    <div class="accordion-box">
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>A Slip On Flange is a pipe flange that slides over the pipe and is welded on both the inside and outside to create a secure and leak-resistant connection.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>They are commonly used in oil &amp; gas, chemical processing, water treatment, power plants, marine, and general industrial piping systems operating under low to medium pressure.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>We manufacture Slip On Flanges in stainless steel, carbon steel, alloy steel, duplex, super duplex, nickel alloys, and titanium grades.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>Yes. We manufacture Slip On Flanges in standard and customized sizes, pressure classes, and material grades according to customer specifications.</p>
                            </div>
                        </div>
