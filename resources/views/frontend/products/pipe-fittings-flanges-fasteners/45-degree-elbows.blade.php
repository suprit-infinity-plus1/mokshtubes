...
@section('title', '45 Degree Elbows | Moksh Tubes')
@section('meta_description', '45 Degree Elbows – high-quality pipe elbows for diverse industrial applications.')
@section('meta_keywords', '45 Degree Elbows, pipe elbows, industrial fittings')
@section('og_image', asset('assets/images/product/flangs/45-degree-elbows_11zon.jpg'))
@section('og_type', 'product')
@section('content')

    <section class="breadcrumb-area" style="background-image: url({{ asset('assets/images/product/flangs/45-degree-elbows_11zon.jpg') }});">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    <h1>45 Degree Elbows</h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-7 col-md-9">
                    <div style="background: linear-gradient(135deg, #f8faff 0%, #eef3fb 100%); border: 2px solid #e0e8f7; border-radius: 20px; padding: 60px 40px; box-shadow: 0 8px 40px rgba(23,66,104,0.10);">
                        ...
                        <p class="mb-4" style="color: #555; font-size: 1.05rem; line-height: 1.7;">
                            ...
                            <strong style="color: #db7227;">45 Degree Elbows</strong>.
