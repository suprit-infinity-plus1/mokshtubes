...
@section('title', 'LJFF Flanges | Moksh Tubes')
@section('meta_description', 'LJFF Flanges – premium Lap Joint Flat Face flanges for diverse industrial applications.')
@section('meta_keywords', 'LJFF Flanges, lap joint flat face flanges, steel flanges')
@section('og_image', asset('assets/images/fasteners/LJFF-Flanges_11zon.jpg'))
@section('og_type', 'product')
@section('content')

    <section class="breadcrumb-area" style="background-image: url({{ asset('assets/images/fasteners/ljff-flanges_11zon.jpeg') }});">
        <div class="container">
                ...
                <div class="col-lg-7 col-md-9">
                    <div style="background: linear-gradient(135deg, #f8faff 0%, #eef3fb 100%); border: 2px solid #e0e8f7; border-radius: 20px; padding: 60px 40px; box-shadow: 0 8px 40px rgba(23,66,104,0.10);">
                        ...
                        <p class="mb-4" style="color: #555; font-size: 1.05rem; line-height: 1.7;">
                            ...
                            <strong style="color: #db7227;">LJFF Flanges</strong>.
                        ...
                        <div style="background: #fff; border-radius: 12px; padding: 20px 28px; display: inline-block; border: 1.5px solid #e0e8f7; margin-bottom: 32px; text-align: left;">
                            ...
                            <ul class="mb-0" style="color: #555; padding-left: 18px; line-height: 1.9;">
                                <li>Type: Lap Joint Flat Face (LJFF)</li>
                                <li>Standard: ASME B16.5</li>
                                <li>Materials: Stainless Steel, Nickel Alloys, Carbon Steel</li>
                                <li>Applications: Systems requiring frequent dismantling</li>
                            </ul>
                        </div>
