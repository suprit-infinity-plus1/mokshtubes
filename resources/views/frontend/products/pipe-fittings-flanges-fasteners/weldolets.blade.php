...
@section('title', 'Weldolets | Moksh Tubes')
@section('meta_description', 'Weldolets – branch connection pipe fittings for industrial applications.')
@section('meta_keywords', 'Weldolets, branch fittings, pipe olets')
@section('og_image', asset('assets/images/product/flangs/weldolets_11zon.jpg'))
@section('og_type', 'product')
@section('content')

    <section class="breadcrumb-area" style="background-image: url({{ asset('assets/images/product/flangs/weldolets_11zon.jpg') }});">
        <div class="container">
                ...
                <div class="col-lg-7 col-md-9">
                    <div style="background: linear-gradient(135deg, #f8faff 0%, #eef3fb 100%); border: 2px solid #e0e8f7; border-radius: 20px; padding: 60px 40px; box-shadow: 0 8px 40px rgba(23,66,104,0.10);">
                        ...
                        <p class="mb-4" style="color: #555; font-size: 1.05rem; line-height: 1.7;">
                            ...
                            <strong style="color: #db7227;">Weldolets</strong>.
                        ...
                        <div style="background: #fff; border-radius: 12px; padding: 20px 28px; display: inline-block; border: 1.5px solid #e0e8f7; margin-bottom: 32px; text-align: left;">
                            ...
                            <ul class="mb-0" style="color: #555; padding-left: 18px; line-height: 1.9;">
                                <li>Type: Weldolets (Branch Connections)</li>
                                <li>Materials: Stainless Steel, Carbon Steel, Alloy Steel</li>
                                <li>Applications: 90° branch connection off a main pipe run</li>
                            </ul>
                        </div>
