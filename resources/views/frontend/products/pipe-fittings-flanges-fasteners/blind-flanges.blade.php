            ...
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    <h1 class="page-title">Blind Flanges Manufacturer, Supplier & Exporter in India</h1>
                        ...
                        Blind Flanges are solid pipe flanges used to seal the end of pipelines, valves, pressure vessels, and piping systems. They provide a secure, leak-proof closure while allowing easy access for future maintenance, inspection, or system expansion. At Moksh Tubes & Fittings LLP, we manufacture, supply, and export premium-quality Blind Flanges in stainless steel, carbon steel, alloy steel, duplex, super duplex, nickel alloys, and titanium grades. Manufactured to international standards, our Blind Flanges deliver outstanding strength, corrosion resistance, and long-lasting performance in demanding industrial environments.
                    </p>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="{{ asset('assets/images/fasteners/blind-flanges_11zon.jpg') }}"
                        alt="Blind Flanges Manufacturer" class="img-fluid rounded shadow-sm" width="550"
                ...
                <div class="col-md-6">
                    <p class="fs-6 mb-3 text-justify">
                        A <strong>Blind Flange (BL Flange)</strong> is a solid flange without a bore, designed to close or terminate the end of a piping system. It is bolted to another flange using a gasket to create a tight, leak-proof seal. Blind Flanges are commonly used when future pipeline extensions, pressure testing, maintenance, or equipment isolation may be required.
                    </p>

                    <p class="fs-6 text-justify">
                        At <a href="{{ route('index') }}">Moksh Tubes & Fittings LLP</a>, we manufacture precision-engineered Blind Flanges using premium-quality forged materials and advanced CNC machining technology. Our flanges are available in a wide range of sizes, pressure classes, and material grades, making them suitable for high-pressure, high-temperature, and corrosive industrial applications.
                    </p>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody class="text-start">
                                ...
                                <tr class="t-row"><td>Standards</td><td>ASME B16.5, ASME B16.47 (Series A & B), DIN, EN 1092-1, BS 4504, AWWA</td></tr>
                                <tr class="t-row">
                                    <td>Material</td>
                                    <td>Stainless Steel, Carbon Steel, Alloy Steel, Duplex, Super Duplex & Nickel Alloys</td>
                                </tr>
                                <tr class="t-row"><td>Size Range</td><td>½" to 48" (Custom Sizes Available)</td></tr>
                                <tr class="t-row"><td>Pressure Classes</td><td>150#, 300#, 600#, 900#, 1500#, 2500#, PN6 to PN64</td></tr>
                                <tr class="t-row"><td>Facing Types</td><td>Raised Face (RF), Flat Face (FF), Ring Type Joint (RTJ)</td></tr>
   ...
   <!-- charts -->
    <section id="size-chart" class="sec-padd-top sec-padd-bottom">
        <div class="container">
            ...
            <p class="text-center pb-3">
                Blind Flanges are manufactured according to <strong>ISO 4762</strong> and <strong>DIN 912</strong> standards and are available in a wide range of diameters and lengths.
            </p>
            ...
            <div class="table-responsive mt-4">
                <table class="table table-bordered table-striped align-middle text-center">
                    ...
                    <tbody>
                        <tr class="t-row"><td>1/2"</td><td>89.0</td><td>11.2</td><td>0.7</td></tr>
                        <tr class="t-row"><td>3/4"</td><td>98.6</td><td>12.7</td><td>0.9</td></tr>
                        <tr class="t-row"><td>1"</td><td>108.0</td><td>14.3</td><td>1.1</td></tr>
                        <tr class="t-row"><td>1½"</td><td>127.0</td><td>17.5</td><td>1.8</td></tr>
                        <tr class="t-row"><td>2"</td><td>152.4</td><td>19.1</td><td>2.7</td></tr>
                        <tr class="t-row"><td>3"</td><td>190.5</td><td>23.9</td><td>5.4</td></tr>
                        <tr class="t-row"><td>4"</td><td>228.6</td><td>23.9</td><td>7.7</td></tr>
                        <tr class="t-row"><td>6"</td><td>279.4</td><td>25.4</td><td>11.8</td></tr>
                        <tr class="t-row"><td>8"</td><td>342.9</td><td>28.4</td><td>21.3</td></tr>
                        <tr class="t-row"><td>10"</td><td>406.4</td><td>30.2</td><td>31.8</td></tr>
                        <tr class="t-row"><td>12"</td><td>482.6</td><td>31.8</td><td>49.9</td></tr>
                        <tr class="t-row"><td>16"</td><td>596.9</td><td>36.6</td><td>83.9</td></tr>
                        <tr class="t-row"><td>20"</td><td>698.5</td><td>42.9</td><td>133.8</td></tr>
                        <tr class="t-row"><td>24"</td><td>812.8</td><td>47.8</td><td>190.5</td></tr>
                    </tbody>
                </table>
            </div>
            <p class="text-center mt-2 small text-muted"><strong>Note:</strong> Dimensions and weights are for Class 150 RF Blind Flanges. Data for Class 300, 600, 900, 1500, and 2500, as well as RTJ and FF facings, are available upon request or in our datasheet.</p>
        </div>
    </section>
        ...
        <div class="container">
             <div class="section-title center mb-4">
                <h2 class="fw-bold" style="color: #174268;">Mechanical Properties</h2>
                 <p class="text-center">The mechanical properties of <strong>Blind Flanges</strong> depend on the selected material grade and comply with applicable ASTM, ISO, and DIN standards. The table below shows the typical mechanical properties for commonly supplied stainless steel grades.</p>
            </div>
            ...
            <div class="table-responsive">
             ...
             <p class="mt-2 text-muted text-center"><small><strong>Note:</strong> Mechanical properties for Carbon Steel, Alloy Steel Grade 12.9, ASTM A193 B7, ASTM A320 L7, Duplex, Super Duplex, and Nickel Alloy Blind Flanges are available in accordance with their respective ASTM, ISO, and DIN material specifications upon request.</small></p>
        </div>
    </section>
    ...
    <section id="packaging" class="sec-padd-top sec-padd-bottom">
        <div class="container text-center">
            ...
            <p class="fs-5">We ensure that our <strong>Blind Flanges</strong> are securely packaged to prevent damage during transit. We use high-quality wooden crates, pallets, and shrink-wrapping for export shipments.</p>
    ...
    <section id="packaging" class="sec-padd-top sec-padd-bottom text-center">
        <div class="container">
            ...
            <p class="text-muted" style="max-width: 900px; margin: 0 auto; font-size: 16px; line-height: 1.8;">
                We ensure secure and standardized packaging to prevent damage during transit. Our <strong>Blind Flanges</strong> are packed in high-quality wooden crates, shrink-wrapped, and securely strapped on pallets for international shipping.
            ...
            <div class="accordion faq-accordion" id="faqAccordion">
                ...
                <div class="accordion-item mb-3 border-0">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-muted">
                            A Blind Flange is a solid disc used to block off a pipeline or to create a stop. It is heavily stressed due to system pressure, making it crucial for safely terminating piping systems and pressure vessels.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item mb-3 border-0">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-muted">
                            A Raised Face (RF) Blind Flange has a slightly raised surface around the bore area to concentrate gasket pressure. An RTJ (Ring Type Joint) Blind Flange has a machined groove designed to accommodate a metal ring gasket, providing a high-integrity seal for high-pressure and high-temperature applications.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item mb-3 border-0">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-muted">
                            We manufacture Blind Flanges in Stainless Steel (304, 316), Carbon Steel, Alloy Steel, Duplex, Super Duplex, Nickel Alloys, and Titanium, catering to diverse industrial requirements.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item mb-3 border-0">
                    ...
                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-muted">
                            Yes, our Blind Flanges are manufactured in strict compliance with ASME B16.5, ASME B16.47, DIN, EN 1092-1, and AWWA standards.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item border-0">
                    ...
                    <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-muted">
                            Yes, we can manufacture Blind Flanges in non-standard sizes, heavy wall thicknesses, and special facings based on customer drawings and specifications.
                        </div>
                    </div>
                </div>
      ...
      <section class="sec-padd-top sec-padd-bottom bg-light">
        <div class="container">
            <div class="contact-cta-box">
                ...
                <p>
                    Looking for a trusted <strong>Blind Flanges</strong> manufacturer and supplier? Contact <strong>Moksh Tubes & Fittings LLP</strong> for premium-quality industrial blind flanges, competitive pricing, ready stock, technical support, and fast worldwide delivery. Request your free quotation today.
                </p>
