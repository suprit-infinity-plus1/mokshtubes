...
@section('title', 'Blind Flanges | Moksh Tubes')
@section('meta_description', 'Blind Flanges – premium Blind flanges for closing pipe ends in diverse industrial applications.')
@section('meta_keywords', 'Blind Flanges, pipe blank flanges, steel flanges')
@section('og_image', asset('assets/images/fasteners/Blind-Flanges_11zon.jpg'))
@section('og_type', 'product')
@section('content')

    <section class="breadcrumb-area" style="background-image: url({{ asset('assets/images/fasteners/blind-flanges_11zon.jpg') }});">
        <div class="container">
                ...
                <div class="col-lg-7 col-md-9">
                    <div style="background: linear-gradient(135deg, #f8faff 0%, #eef3fb 100%); border: 2px solid #e0e8f7; border-radius: 20px; padding: 60px 40px; box-shadow: 0 8px 40px rgba(23,66,104,0.10);">
                        ...
                        <p class="mb-4" style="color: #555; font-size: 1.05rem; line-height: 1.7;">
                            ...
                            <strong style="color: #db7227;">Blind Flanges</strong>.
                        ...
                        <div style="background: #fff; border-radius: 12px; padding: 20px 28px; display: inline-block; border: 1.5px solid #e0e8f7; margin-bottom: 32px; text-align: left;">
                            ...
                            <ul class="mb-0" style="color: #555; padding-left: 18px; line-height: 1.9;">
                                <li>Type: Blind Flanges (BLRF / BLFF)</li>
                                <li>Standard: ASME B16.5 / B16.47</li>
                                <li>Materials: Stainless Steel, Carbon Steel, Alloy Steel</li>
                                <li>Applications: Sealing pipe ends, isolation in fluid systems</li>
                            </ul>
                        </div>
