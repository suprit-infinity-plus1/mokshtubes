...
@section('content')
        <style>
            ...
            .premium-card .icon-wrapper {
                background: rgba(219, 114, 39, 0.1);
                /* light theme color */
                color: var(--brown);
                width: 50px;
                height: 50px;
                ...
                <ul>
                    <li data-transition="slidingoverlayleft">
                        ...
                        <div class="tp-caption tp-resizeme" data-x="left" data-hoffset="15" data-y="center" data-voffset="110"
                            ...
                            <div class="slide-content-box">
                                <div class="button">
                                    <a class="thm-btn bg-clr1" href="javascript:void(0);" data-bs-toggle="modal"
                                        data-bs-target="#contactFormModal">Get Quote</a>
                                </div>
                            </div>
                        </div>
                        <div class="tp-caption tp-resizeme" data-x="left" data-hoffset="227" data-y="center" data-voffset="110"
                            ...
                            <div class="slide-content-box">
                                <div class="button">
                                    <a class="thm-btn bg-clr2" href="https://wa.me/919769584950" target="_blank">WhatsApp
                                        Now</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <li data-transition="slidingoverlayleft">
                        ...
                        <div class="tp-caption tp-resizeme" data-x="right" data-hoffset="190" data-y="center" data-voffset="110"
                            data-transform_idle="o:1;"
                            data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:2000;e:Power4.easeInOut;"
                            data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-splitin="none"
                            data-splitout="none" data-responsive_offset="on" data-start="2600">
                    ...
                    <li data-transition="slidingoverlayright">
                        <img src="{{ asset('assets/images/slides/we-help.webp') }}" alt="banner image" width="1920" height="550"
                            data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1"
                            loading="lazy">
            ...
            <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="single-our-service border" style="background: #fff;">
                            ...
                            <div class="p-3 text-left">
                                ...
                                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#contactFormModal"
                                    class="thm-btn bg-clr1 mt-2" style=" font-size: 14px;">Get Price</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="single-our-service border" style="background: #fff;">
                            <figure class="img-box mb-0">
                                <a class="w-100" href="{{ route('materials.inconel') }}">
                                    <img src="/assets/images/inconel/Inconel-625.png" alt="Inconel Pipes" class="w-100"
                                        loading="lazy">
                                </a>
                            </figure>
                            <div class="p-3 text-left">
                        ...
                        <div class="single-our-service border" style="background: #fff;">
                            <figure class="img-box mb-0">
                                <a class="w-100" href="{{ route('materials.austenitic-stainless-Steel') }}">
                                    <img src="/assets/images/austenitic-stainless-steel/austenitic-stainless-steel-316-Copy.png"
                                        alt="SS 316 Pipes" class="w-100" loading="lazy">
                                </a>
                            </figure>
                            <div class="p-3 text-left">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-4">
                        <div class="single-our-service border" style="background: #fff;">
                            <figure class="img-box mb-0">
                                <a class="w-100" href="{{ url('products/sheets-plates-coils/sheets-and-plates') }}">
                                    <img src="/assets/images/service/SHEETS-PLATES.webp" alt="Stainless Steel Sheets & Plates"
                                        class="w-100" loading="lazy">
                                </a>
                            </figure>
                            <div class="p-3 text-left">
                                <a href="{{ url('products/sheets-plates-coils/sheets-and-plates') }}">
                                    <h3 class="mt-0 h5">Stainless Steel Sheets & Plates</h3>
                                </a>
                                <p>High-quality SS sheets and plates available in various grades and finishes for diverse gauge.
                                </p>
                                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#contactFormModal"
                                    class="thm-btn bg-clr1 mt-2" style=" font-size: 14px;">Get Price</a>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 mb-4">
                        <div class="single-our-service border">
                            <figure class="img-box mb-0">
                                <a class="w-100" href="{{ url('products/sheets-plates-coils/sheets-and-plates') }}">
                                    <img src="/assets/images/service/SHEETS-PLATES.webp" alt="Sheets and Plates" class="w-100"
                                        loading="lazy">
                    ...
                    <div class="col-md-4 col-sm-6 mb-4">
                        <div class="single-our-service border">
                            <figure class="img-box mb-0">
                                <a class="w-100" href="{{ url('products/sheets-plates-coils/perforated-sheets') }}">
                            ...
                            <div class="p-3">
                                <a href="{{ url('products/sheets-plates-coils/perforated-sheets') }}">
                        ...
                        <div class="single-our-service border">
                            <figure class="img-box mb-0">
                                <a class="w-100" href="{{ route('products.fasteners') }}">
                                   <!-- <img class="w-100" src="{{ asset('assets/images/service/6.jpg') }}"
                                        alt="Awesome Image"> -->
       ...
       {{--   <section class="materials-we-supply sec-padd-top sec-padd-bottom">
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-md-12 text-center">
                        <p>Moksh Tubes & Fittings LLP offers a comprehensive range of industrial metals and specialty alloys for
                            critical engineering applications. Our products are available in multiple grades, sizes, and
                            specifications to meet domestic and international project requirements.</p>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row mt-4">
                    <div class="col-md-12 text-center">
                        <p>All materials are supplied with complete documentation, including mill test certificates, ensuring
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="footer-col service-col">
                            ...
                            <ul class="footer-list">
                                ...
                                <li><a href="{{ url('products/sheets-plates-coils/coils') }}">COILS</a></li>
                                <li><a href="{{ url('products/sheets-plates-coils/strips') }}">STRIPS</a></li>
                                ...
                                <li><a href="{{ url('products/sheets-plates-coils/chequered-sheets') }}">CHEQUERED
                                        SHEETS</a></li>
                                <li><a href="{{ url('products/sheets-plates-coils/shim-sheets') }}">SHIM SHEETS</a></li>
                                <li><a href="{{ url('products/sheets-plates-coils/cladded-plates') }}">CLADDED PLATES</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="footer-col service-col">
                            ...
                            <ul class="footer-list">
                                <li><a href="{{ url('products/special-fabricated/ss-railings') }}">SS RAILING PRODUCTS</a>
                                </li>
                                <li><a href="{{ url('products/special-fabricated/glass-railings') }}">GLASS RAILINGS</a>
                                </li>
                                <li><a href="{{ url('products/special-fabricated/custom-steel-furniture') }}">CUSTOM STEEL
                                        FURNITURE</a></li>
                                <li><a href="{{ url('products/special-fabricated/fabricated-ss-grills') }}">FABRICATED SS
                                        GRILLS</a></li>
                            </ul>
                        </div>
                    </div>
        ...
        <section class="industries-we-serve sec-padd-top sec-padd-bottom" style="background-color: #f9f9f9;">
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-md-12 text-center">
                        <p>Our products are trusted by companies operating in some of the world's most demanding industries. We
                            supply materials designed to perform reliably under high pressure, elevated temperatures, corrosive
                            environments, and heavy mechanical loads.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 mt-4">
                ...
                <div class="row mt-4">
                    <div class="col-md-12 text-center">
                        <p>No matter the industry, our team can recommend the right material to match your application,
                            operating conditions, and performance requirements.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="brand-carousel owl-carousel owl-theme brand">
                    <div class="single-item">
                        <a href="javascript:void(0);">
                            <img src="{{ asset('assets/images/bharat-heavy-electricals-limited.jpg') }}"
                                alt="Bharat Heavy Electricals Limited (BHEL)">
                            <p class="company-name">Bharat Heavy Electricals Limited (BHEL)</p>
                        </a>
                    </div>
                    <div class="single-item">
                        <a href="javascript:void(0);">
                            <img src="{{ asset('assets/images/Maharashtra-Seamless-Limited.png') }}"
                                alt="Maharashtra Seamless Limited (MSL)">
                            <p class="company-name">Maharashtra Seamless Limited (MSL)</p>
                        </a>
                    </div>
                    <div class="single-item">
                        <a href="javascript:void(0);">
                            <img src="{{ asset('assets/images/nuclear-power-corporation-of-india-limited.gif') }}"
                                alt="Nuclear Power Corporation of India Limited (NPCIL)">
                            <p class="company-name">Nuclear Power Corporation of India Limited (NPCIL)</p>
                        </a>
                    </div>
                    <div class="single-item">
                        <a href="javascript:void(0);">
                            <img src="{{ asset('assets/images/CHEMDIST-PROCESS-SOLUTIONS-PRIVATE-LIMITED.jpg') }}"
                                alt="Chemdist Process Solutions Private Limited">
                            <p class="company-name">Chemdist Process Solutions Pvt Ltd</p>
                        </a>
                    </div>
                    <div class="single-item">
                        <a href="javascript:void(0);">
                            <img src="{{ asset('assets/images/SSEPL-TECHNO-PRIVATE-LIMITED.png') }}"
                                alt="SSEPL Techno Private Limited">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12 mb-4">
                        <div class="single-our-service border p-4 text-center rounded shadow-sm"
                            style="background-color: #fff; height: 100%;">
                            <div class="mb-3">
                                <a href="{{ asset('assets/images/ISO 9001 CERTIFICATE MOKSH STEEL.pdf') }}" target="_blank">
                                    <img src="{{ asset('assets/images/iso-9001-certificate.png') }}" alt="ISO 9001 Certificate"
                                        class="img-fluid border"
                                        style="height: 250px; object-fit: contain; width: 100%; border-radius: 4px; background-color: #f8f9fa;">
                                </a>
                            </div>
                            <h3 class="mt-0 mb-2 h5">ISO 9001:2015</h3>
                            <p class="mb-4 text-muted">Quality Management System</p>
                            <a href="{{ asset('assets/images/ISO 9001 CERTIFICATE MOKSH STEEL.pdf') }}" target="_blank"
                                class="thm-btn bg-clr1" style="padding: 8px 20px; font-size: 14px;">View Certificate</a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-12 mb-4">
                        <div class="single-our-service border p-4 text-center rounded shadow-sm"
                            ...
                            <div class="mb-3">
                                <a href="{{ asset('assets/images/MTF LLP UDYAM CERTIFICATE.pdf') }}" target="_blank">
                                    <img src="{{ asset('assets/images/udyam-certificate.png') }}" alt="UDYAM Registration"
                                        class="img-fluid border"
                                        style="height: 250px; object-fit: contain; width: 100%; border-radius: 4px; background-color: #f8f9fa;">
                                </a>
                            </div>
                        ...
                        <div class="single-our-service border p-4 text-center rounded shadow-sm"
                            ...
                            <div class="mb-3">
                                <a href="{{ asset('assets/images/PED CERTIFICATE MOKSH STEEL.pdf') }}" target="_blank">
                                    <img src="{{ asset('assets/images/ped-certificate.png') }}" alt="PED Certificate"
                                        class="img-fluid border"
                                        style="height: 250px; object-fit: contain; width: 100%; border-radius: 4px; background-color: #f8f9fa;">
                                </a>
                            </div>
        ...
        <!-- <section class="global-export-quality sec-padd-top sec-padd-bottom">
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-md-12 text-center">
                        <p>Quality is at the core of everything we do. Every product supplied by Moksh Tubes & Fittings LLP
                            undergoes strict quality checks to ensure compliance with customer specifications and international
                            standards.</p>
                        <p>We provide complete quality documentation, including Mill Test Certificates (MTC), Positive Material
                            Identification (PMI), third-party inspection reports, and custom testing based on project
                            requirements.</p>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row mt-4">
                    <div class="col-md-12 text-center">
                        <p>With export-grade packaging and reliable logistics, we ensure materials reach customers safely and on
                            time.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 text-center mb-4">
                        <p>Selecting the right supplier is just as important as choosing the right material. At Moksh Tubes &
                            Fittings LLP, we are committed to supplying premium-quality industrial metal products that meet
                            international standards for performance, durability, and reliability.</p>
                        <p>With more than 20 years of industry experience, we serve customers across India and international
                            markets by providing high-quality stainless steel, nickel alloys, titanium, engineering steels,
                            aluminium alloys, copper alloys, and other specialty metals for demanding industrial applications.
                        </p>
                        <p>Whether you require standard products or custom-manufactured components, our experienced team ensures
                            every order meets your exact technical specifications and delivery requirements.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="accordion-box">
                            ...
                            <div class="accordion accordion-block">
                                ...
                                <div class="accord-content collapsed">
                                    <p>Yes. We offer custom lengths, diameters, wall thicknesses, and cutting services based on
                            ...
                            <div class="accordion accordion-block">
                                ...
                                <div class="accord-content">
                                    <p>Yes. All applicable products can be supplied with EN 10204 3.1 Mill Test Certificates.
                                    </p>
                                </div>
                            </div>
                            <!--End single accordion box-->
                            ...
                            <div class="accordion accordion-block">
                                ...
                                <div class="accord-content">
                                    <p>We supply products for oil & gas, chemical processing, power plants, marine,
                                        pharmaceutical, food processing, construction, mining, and many other industries.</p>
                                </div>
                            </div>
                            <!--End single accordion box-->
                            <!--Start single accordion box-->
                            <div class="accordion accordion-block">
                                ...
                                <div class="accord-content">
                                    <p>Yes. We regularly export industrial metal products to customers across Asia, Europe, the
                                        Middle East, North America, and other international markets.</p>
                                </div>
                            </div>
                            <!--End single accordion box-->
                            <!--Start single accordion box-->
                            <div class="accordion accordion-block">
                                ...
                                <div class="accord-content">
                                    <p>Yes. Third-party inspection can be arranged through internationally recognized inspection
                        ...
                        {{--    <!--Start single accordion box-->
                            ...
                            <div class="accordion accordion-block">
                                ...
                                <div class="accord-content">
                                    <p>We stock stainless steel, duplex steel, nickel alloys, titanium, engineering steels,
                                        aluminium alloys, copper alloys, and other specialty metals.</p>
                                </div>
                            </div>
                            <!--End single accordion box-->
                            <!--Start single accordion box-->
                            <div class="accordion accordion-block">
                                ...
                                <div class="accord-content">
                                    <p>You can contact us through our enquiry form, email, phone, or WhatsApp. Our technical
                                        sales team will recommend the right material and provide a competitive quotation based
        ...
        <section id="contact-form" class="contact-form-section sec-padd-top sec-padd-bottom bg-light">
            <div class="container">
                <div class="section-title center">
                    ...
                    <p>Looking for premium quality <strong>Stainless Steel Pipes, Sheets, Plates, or Custom Engineering
                            solutions</strong>?<br>Fill out the form below and our experts will get back to you within 30
                        minutes.</p>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <form action="{{ url('sendmail') }}" method="POST"
                            class="default-form contact-form border p-4 bg-white shadow-sm rounded">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <input type="tel" name="form_phone" class="form-control" placeholder="Phone Number*"
                                        required>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <textarea name="form_message" class="form-control" placeholder="Your Requirement*" required
                                        rows="4"></textarea>
                                </div>
