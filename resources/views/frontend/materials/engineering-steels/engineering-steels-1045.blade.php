                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            <strong class="text-black"> MOKSH TUBES & FITTINGS LLP</strong>is a manufacturer, supplier, exporter, importer, and stockist of <strong>EN 1045 steel </strong> products such as pipes, tubes, bars, plates, and fittings.
                        </p>

                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black">EN 1045</strong class="text-black">, commonly referred to as <strong>C1045</strong> or <strong>SAE 1045</strong>, is a medium carbon steel known for its good strength, hardness, and wear resistance. It offers a balance between ductility and strength, making it suitable for a wide range of mechanical and structural applications where moderate strength and toughness are required.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="sec-padd-top sec-padd-bottom">
        <div class="container">
            <div class="contact-cta-box">
                <h2>Contact Us</h2>
                <p>
                  For inquiries or to request a quote for EN 1045 steel products, contact <strong> Moksh Tubes & Fittings LLP </strong> — your trusted partner for medium carbon steels.
                </p>
                <!-- Call button -->
