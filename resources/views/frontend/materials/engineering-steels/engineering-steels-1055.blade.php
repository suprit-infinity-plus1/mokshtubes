...
@section('content')
    ...
    <section class="breadcrumb-area" style="background-image: url(/assets/images/engineering-steels/engineering-steels-1055.webp);">
        <div class="container">
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        ...
                        <p class="fs-6 text-justify">
                            ...
                            customized
                            according to project-specific requirements. All materials are sourced from certified mills and
                            delivered
...
<section id="heat-treatment" class="sec-padd-top sec-padd-bottom">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            </div <!-- End Technical Properties Section -->
                                ...
                                <div class="row">
                                    ...
                                    @foreach ($products as $product)
                                        <div class="col-12 col-sm-6 mb-2 d-flex justify-content-start align-items-start">
                                            <span class="me-2"
                                                style="color: #db7227; font-size: 1.1rem;">&#10004;</span>
