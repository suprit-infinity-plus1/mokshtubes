        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="/assets/images/engineering-steels/engineering-steels-p1.jpg" alt="ENp1" class="img-fluid rounded shadow-sm">
                </div>
    ...
    <section class="sec-padd-top sec-padd-bottom">
        <div class="container">
            <div class="section-title center">
                ...
                <p class="text-center pb-3"><strong class="text-dark">Engineering Steel P1</strong> is primarily used for:</p>
            </div>
