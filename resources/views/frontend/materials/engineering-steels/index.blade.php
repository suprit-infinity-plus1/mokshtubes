...
@section('meta_description', 'Explore durable engineering steels EN8, EN19, 1045 & 4140 from MokshTubes — high strength, toughness & reliability for industrial and mechanical uses.')
        ...
        <div class="container">
            ...
            <div class="row g-4">
                @foreach ($grades as $grade)
                    @php
                        $href = $grade['slug'] !== '#' ? url((in_array(strtolower(request()->segment(1)), ['se','no','ng','ae','us','sg','mv','sa','de','gb','ca','jo','pe','au','th','ru','fr','be','za','bg','tw','it','nl','in']) ? '/' . request()->segment(1) : '') . '/materials/engineering-steels/' . $grade['slug']) : '#';
                    @endphp
