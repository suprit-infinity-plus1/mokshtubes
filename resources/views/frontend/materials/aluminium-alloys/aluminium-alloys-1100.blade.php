    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 mb-4 mb-md-0">
                <img src="{{ asset('assets/images/aluminium-alloys/aluminium-alloys-1100.webp') }}" alt="Aluminium 1100" class="img-fluid rounded shadow-sm">
            </div>
                ...
                <div class="accordion-box">
                    ...
                    <div class="accordion accordion-block">
                        ...
                        <div class="accord-content">
                            <p>
                                Aluminium Alloy 1100 is a commercially pure <a href="{{ route('materials.aluminium-Alloys') }}">grade</a> with at least 99%
                                aluminum content. It
