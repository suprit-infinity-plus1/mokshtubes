...
@section('meta_description',
    'High performance Aluminium 7075 with excellent strength and fatigue resistance for
    aerospace and sports uses.')
@section('meta_keywords',
    'Aluminium Alloy 7075, High Performance Aluminium, Aluminium 7075 Pipes, Aluminium 7075 Tubes,
...
@section('content')
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    <h1>Premium Aluminium 7075 Alloy for Industrial Use<br>High-Strength Aerospace-Grade Aluminium</h1>
                    <!-- Add your extra content here -->
                    <p class="text-center mt-3 px-3 py-2 text-white position-relative"
                        style="background:rgba(0,0,0,0.4); display:inline-block; border-radius:6px;">
                        Aluminium Alloy 7075 is one of the strongest commercial aluminium alloys, known for its outstanding
                        tensile strength, fatigue resistance, and toughness. Below is the complete datasheet including
                        chemical composition, heat treatment, mechanical properties, applications, and pricing.
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="{{ asset('assets/images/aluminium-alloys/aluminium-alloys7075.webp') }}" alt="Aluminium 7075"
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <p class="mb-3">
                Get the complete Alluminium Alloy 7075 datasheet with chemical composition,
            ...
            <form id="leadForm" method="POST" action="{{ route('lead.capture') }}" class="mb-3">
                @csrf
                <div class="row justify-content-center">
                    <input type="hidden" name="pdf" value="aluminium_7075.pdf">
