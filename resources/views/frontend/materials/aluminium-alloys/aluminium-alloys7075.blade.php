...
@section('content')
    ...
    <section class="breadcrumb-area" style="background-image: url(/assets/images/aluminium-alloys/aluminium-alloys7075.webp);">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    ...
                    <p class="text-center mt-3 px-3 py-2 text-white position-relative"
                        ...
                        Aluminium Alloy 7075 is one of the strongest commercial aluminium alloys, known for its outstanding tensile strength, fatigue resistance, and toughness. Below is the complete datasheet including chemical composition, heat treatment, mechanical properties, applications, and pricing.
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download Aluminium 7075 Datasheet
</h3>
            <p class="mb-3">
              Get the complete Aluminium 7075 datasheet with composition, mechanical properties, heat treatment, and applications.
