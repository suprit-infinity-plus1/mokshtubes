...
@section('meta_description',
    'Aluminium 6012 — heat-treatable alloy with high strength and corrosion resistance, ideal
...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="{{ asset('assets/images/aluminium-alloys/aluminium-alloys-6012.webp') }}" alt="Aluminium 6012"
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <p class="mb-3">
                Get the complete Alluminium Alloy 6012 datasheet with chemical composition,
            ...
            <div class="table-responsive col-lg-8 mx-auto">
                <table class="table table-bordered table-striped align-middle">
                    ...
                    <tbody>
                         <tr class="t-row">
                            <td>Grade</td>
                            <td>Aluminium 6012 / AA6012 / UNS A96012</td>
                        </tr>
                         <tr class="t-row">
                            <td>Type</td>
                         ...
                         <tr class="t-row">
                            ...
                            <td>Si 0.8–1.2%, Mg 0.45–0.8%, Cu 0.2–0.6%</td>
                        </tr>
                         <tr class="t-row">
                            <td>Conditions</td>
                            <td>O, T4, T6</td>
    ...
    <section class="sec-padd-top sec-padd-bottom" id="composition">
        <div class="container">
            ...
            <p class="text-center mt-3">
                Aluminium 6012 is prized for its excellent machinability, moderate strength, and good corrosion resistance.
            </p>
        </div>
    </section>
    ...
    <section class="sec-padd-top sec-padd-bottom bg-light" id="properties">
        <div class="container">
            <div class="section-title center">
                <h2>Physical Properties – Aluminium Alloy 6012</h2>
            </div>
    ...
    <section class="sec-padd-top sec-padd-bottom bg-light" id="related grades">
        <div class="container">
            <div class="section-title center">
                <h2>Available Forms & Size Range – Aluminium 6012</h2>
            </div>
    ...
    <section id="price" class="sec-padd-top sec-padd-bottom bg-light py-5">
        <div class="container">
            <div class="section-title text-center mb-4">
                <h2>Aluminium Alloy 6012 Price per kg in India</h2>
            </div>

            <p class="text-center fs-5">
                <strong>Typical Range:</strong> ₹290 – ₹450 per kg
            </p>
                            ...
                            <div class="accord-content">
                                <p>
                                    ...
                                    structural, and general <a
                                        href="{{ route('materials.engineering-Steels') }}">engineering</a> applications.
                                    It
