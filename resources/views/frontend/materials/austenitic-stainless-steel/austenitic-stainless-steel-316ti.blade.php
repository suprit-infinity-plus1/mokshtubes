...
@section('meta_description',
    'Austenitic Stainless Steel 316Ti – high-performance alloy with excellent high-temperature
    stability and corrosion resistance for diverse industries.')
...
@section('content')
    ...
    <section class="breadcrumb-area"
        style="background-image: url(/assets/images/austenitic-stainless-steel/austenitic-stainless-steel-316Ti.webp);">
        <div class="container">
    ...
    <section id="overview" class="sec-padd-top sec-padd-bottom bg-light">
        <div class="container">
            <div class="section-title center">
                <h2>Stainless Steel 316Ti | Product Overview</h2>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="{{ asset('assets/images/austenitic-stainless-steel/austenitic-stainless-steel-316Ti.webp') }}"alt="Austenitic Stainless Steel 316Ti"
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download Austentic Stainles Steel 316T Datasheet</h3>
            <p class="mb-3">
                Get the complete Austentic Stainles Steel 316T datasheet with chemical composition,
    ...
    <section class="sec-padd-top" id="specification">
        <div class="container">
            <div class="section-title center">
                <h2>Technical Specifications – Stainless Steel 316Ti (UNS S31635 / EN 1.4571)</h2>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody>
                                <tr class="t-row">
                                    <td>Material</td>
                                    <td>Austenitic Stainless Steel 316Ti</td>
                                </tr>
                                <tr class="t-row">
                                    <td>UNS No.</td>
                                    <td>S31635</td>
                                ...
                                <tr class="t-row">
                                    <td>Typical Use</td>
                                    <td>High-Temperature & Corrosive Environments</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <section id="composition" class="sec-padd-top sec-padd-bottom">
        <div class="container">
            <div class="section-title center">
                <h2>Chemical Composition of Stainless Steel 316Ti</h2>
            </div>
            ...
            <div class="row justify-content-center mt-5" id="heat-treatment">
                <div class="col-lg-10">
                    <h4 class="text-center mb-3" style="color:#db7227;">
                        Heat Treatment & Fabrication of Stainless Steel 316Ti
                    </h4>
                    ...
                    <div class="table-responsive">
                        ...
                        <p class="mt-3 text-center">
                            📌 SS 316Ti is preferred over SS 316 for high-temperature welded applications due to titanium
                            stabilization.
                        </p>
                    </div>
                </div>
    ...
    <section class="sec-padd-top sec-padd-bottom" id="mechanical">
        <div class="container">
            <div class="section-title center mb-5">
                <h2 class="fw-bold" style="color:#174268;">
                    Mechanical Properties of Stainless Steel 316Ti (Annealed)
                </h2>
            </div>
    ...
    <section class="sec-padd-top sec-padd-bottom bg-light" id="available-forms">
        <div class="container">
            <div class="section-title center">
                <h2>Available Forms & Size Range – Stainless Steel 316Ti</h2>
            </div>
    ...
    <section class="sec-padd-top sec-padd-bottom" id="international">
        <div class="container">
            <div class="section-title center">
                <h2>International Standards & Equivalent Grades – SS 316Ti</h2>
            </div>
    ...
    <section id="price" class="sec-padd-top sec-padd-bottom bg-light py-5">
        <div class="container">
            <div class="section-title text-center mb-4">
                <h2>STAINLESS STEEL 316Ti PRICE PER KG (INDIA)</h2>
            </div>

            <p class="text-center fs-5">
                <strong>Typical Range:</strong> ₹390 – ₹720 per kg
            </p>
