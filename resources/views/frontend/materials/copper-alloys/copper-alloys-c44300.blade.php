...
@section('meta_description', 'Copper Alloy C44300 – high-performance copper alloy offering excellent corrosion
...
@section('content')
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download Copper Alloy C44300 Datasheet</h3>
            <p class="mb-3">
                Get the complete Copper Alloy C44300 datasheet with chemical composition,
            ...
            <form id="leadForm" method="POST" action="https://mokshtubes.com/datasheet-leads-capture" class="mb-3">
                ...
                <div class="row justify-content-center">
                    <input type="hidden" name="pdf" value="copper-alloy-C44300.pdf">
