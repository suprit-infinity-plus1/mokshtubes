...
<section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <p class="mb-3">
                Get the complete Copper Alloys Beryllium Coppar datasheet with chemical composition,
...
<section class="sec-padd-top" id="specification">
        <div class="container">
            <div class="section-title center">
                <h2>Specifications of Beryllium Copper (UNS R60702)</h2>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody>
                                <tr class="t-row">
                                    <td>Grade</td>
                                    <td>Beryllium Copper / UNS R60702</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Type</td>
                                    <td>Commercially Pure Beryllium</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Standards</td>
