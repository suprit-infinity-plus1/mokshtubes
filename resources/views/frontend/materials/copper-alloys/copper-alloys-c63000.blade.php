        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="/assets/images/copper-alloys/Copper Alloys C63000.jpg"alt="Copper Alloys C63000" class="img-fluid rounded shadow-sm">
                </div>
    ...
    <section class="sec-padd-top sec-padd-bottom">
        <div class="container">
            <div class="contact-cta-box">
                <h2>Contact Us</h2>
                <p>
                    contact <strong >Moksh Tubes & Fittings LLP</strong> — for custom quotes, technical support, and prompt delivery. We're your trusted partner in non-ferrous alloys.
                    <!-- Call button -->
