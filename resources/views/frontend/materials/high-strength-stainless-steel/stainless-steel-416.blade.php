...
@section('content')
    ...
    <section class="breadcrumb-area"
        style="background-image: url(/assets/images/high-strength-stainless-steel/Stainless-Steel-416.webp);">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="{{ asset('assets/images/high-strength-stainless-steel/Stainless-Steel-416.webp') }}"
                        alt="Stainless Steel 416" class="img-fluid rounded shadow-sm">
                </div>
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black">Stainless Steel 416</strong> is a martensitic, free-machining
                            stainless
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            ...
                            resistance is slightly lower than that of <strong>Stainless Steel 410</strong>. It is magnetic
                            in
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download High Strength Stainless Steel 416 Datasheet</h3>
            <p class="mb-3">
                Get the complete High Strength Stainless Steel 416 datasheet with chemical composition,
    ...
    <section id="products"  class="sec-padd-top sec-padd-bottom">
        <div class="container">
            ...
            <div class="row justify-content-center mb-4" style="text-align: justify;">
                <div class="col-lg-10">
                    <p class="fs-6">
                        <strong class="text-dark">MOKSH TUBES & FITTINGS LLP</strong>, with extensive expertise in
                        martensitic stainless steel grades and a strong global supply network, offers a wide variety of
                        <strong class="text-dark">Stainless Steel 416</strong> products. These products serve industries
                        such as Automotive, Aerospace, Chemical Processing, Food Processing Equipment, Valves, Shafts,
                        Pumps, and Fasteners. Stainless Steel 416 is exceptionally suited for components requiring high
                        machinability, moderate corrosion resistance, and good mechanical strength. In applications where
                        efficiency in machining and dimensional precision are critical, <strong class="text-dark">SS
                            416</strong> delivers reliable performance while meeting mechanical property requirements for
            ...
            <div class="row justify-content-center mb-3">
                <div class="col-lg-10">
                    <p class="fw-bold fs-5 text-center my-4" style="color: #174268;">
                        All products are manufactured in compliance with ASTM A276 / A582 / A484 / A479 and other
                        international standards.
                    </p>
                </div>
            </div>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Shafts, gears, bushings, and precision-machined components requiring durability and performance.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Bolts, screws, studs, and threaded parts requiring high machinability and dimensional precision.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Components requiring precision machining and good dimensional stability in controlled
                            environments.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Applications where a balance between strength, machinability, and cost is essential for
                            performance.</p>
                    </div>
                </div>
            </div>
