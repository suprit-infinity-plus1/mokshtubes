...
@section('content')
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    <h1>Stainless Steel 431 Alloy UNS S43100 <br> High-Strength Martensitic Stainless Steel</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <strong class="text-black">Stainless Steel 431 (UNS S43100)</strong> is a high-strength martensitic stainless steel 
    with excellent corrosion resistance, toughness, and superior tensile strength. It is commonly used in aerospace, 
    marine, chemical, and automotive industries where a combination of mechanical performance and corrosion resistance 
    is required.
</p>
<p class="fs-6 mb-4" style="text-align: justify;">
    <strong>MOKSH TUBES & FITTINGS LLP</strong> deals in a wide range of Stainless Steel 431 products, including 
    pipes, tubes, sheets, plates, coils, flanges, fasteners, bars, rods, and precision-engineered components. 
    This alloy provides exceptional resistance to both organic and inorganic chemicals, mild acids, and fresh water 
    environments. Its martensitic microstructure offers high hardness and strength after heat treatment, making 
    <strong>Stainless Steel 431</strong> one of the most versatile grades within the 400-series stainless steels. 
    When compared to other stainless steels like <strong>density of SS 304</strong> (8.0 g/cm³) or 
    <strong>density of SS 316</strong> (8.0 g/cm³), the <strong>Stainless Steel 431 density</strong> is about 
    <strong>7.75 g/cm³</strong>, providing a balance between strength, corrosion resistance, and machinability.
</p>
