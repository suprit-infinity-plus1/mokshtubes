...
@section('content')
    ...
    <section class="breadcrumb-area"
        style="background-image: url(/assets/images/high-strength-stainless-steel/Stainless-Steel-422.webp);">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="{{ asset('assets/images/high-strength-stainless-steel/Stainless-Steel-422.webp') }}"
                        alt="Stainless Steel 422" class="img-fluid rounded shadow-sm" loading="lazy">
                </div>
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            importer, and stockist of a complete range of Stainless Steel 422 (UNS S42200) products,
                            including
                            pipes & tubes, pipe fittings, flanges, fasteners, sheets & plates, coils, wires, round bars,
                            flat
                            bars, angles, channels, welding rods, wire mesh, and various custom or hard-to-find SS 422
                            products.
                        </p>

                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black">Stainless Steel 422</strong> is a martensitic stainless steel alloy
                            containing
                            high chromium and moderate carbon, designed for excellent high-temperature strength, oxidation
                            resistance,
                            and good corrosion resistance in mild environments. It offers superior creep and stress rupture
                            performance compared to conventional martensitic grades, making it ideal for turbine and
                            high-heat
                            service components.
                        </p>

                        <p class="fs-6" style="text-align: justify;">
                            SS 422 can be heat treated to achieve high mechanical strength and hardness, and it maintains
                            good
                            toughness even at elevated temperatures. With its combination of wear resistance, hardenability,
                            and
                            moderate corrosion resistance, SS 422 is an excellent choice for demanding industrial
                            applications.
                        </p>
                    </div>
                </div>
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download High Strength Stainless Steel 422 Datasheet</h3>
            <p class="mb-3">
                Get the complete High Strength Stainless Steel 422 datasheet with chemical composition,
            ...
            <div class="row justify-content-center mb-4" style="text-align: justify;">
                <div class="col-lg-10">
                    <p class="fs-6">
                        ...
                        and a strong global sourcing network, offers a comprehensive range of <strong
                            class="text-dark">STAINLESS STEEL 422</strong>
                        products. These materials are engineered for high-stress, high-temperature, and wear-resistant
                        applications,
                        making them ideal for use in turbine components, aerospace parts, valves, petrochemical plants, and
                        power
                        generation equipment. Known for its excellent thermal stability, oxidation resistance, and
                        mechanical strength,
                        <strong class="text-dark">Stainless Steel 422</strong> delivers exceptional performance and
            ...
            <div class="row justify-content-center mb-3">
                <div class="col-lg-10">
                    <p class="fw-bold fs-5 text-center my-4" style="color: #174268;">
                        We supply Stainless Steel 422 products manufactured in full compliance with ASTM A276, A479, A484,
    ...
    <section class="sec-padd-top sec-padd-bottom">
        <div class="container">
            <div class="section-title center">
                ...
                <p class="text-center pb-3"><strong class="text-dark">STAINLESS STEEL 422</strong> is used in environments
                    requiring
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Used in turbine blades, buckets, shafts, valves, and bolts that operate at elevated temperatures.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Suitable for aircraft gas turbines, jet engine parts, and high-temperature structural components.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Ideal for exhaust valves, engine components, and other wear-resistant parts requiring high
                            strength.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Used for parts exposed to seawater and mild corrosive conditions demanding mechanical
                            reliability.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Used for shafts, gears, and wear-resistant mechanical components where both strength and
                            corrosion resistance are needed.</p>
                    </div>
                </div>
            </div>
        </div>
