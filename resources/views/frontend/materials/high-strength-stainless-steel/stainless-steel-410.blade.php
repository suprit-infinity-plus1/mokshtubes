    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 mb-4 mb-md-0">
                <img src="{{ asset('assets/images/High Strength Stainless Steel WEBP/Stainless-Steel-410.webp') }}" alt="Stainless Steel 410"
            ...
            <div class="col-md-6">
                <div class="pe-md-3">
                    <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                        <a href="{{ route('index') }}">MOKSH TUBES & FITTINGS LLP</a> is a leading supplier, exporter, importer, and stockist of Stainless Steel 410 products, including pipes, tubes, sheets, plates, coils, bars, fittings, flanges, fasteners, wire mesh, and custom-engineered components.
                    </p>
