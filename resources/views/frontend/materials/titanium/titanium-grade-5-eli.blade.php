        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="/assets/images/titanium/titanium-5-eli.jpeg" alt="Titanium Grade 5 ELI" class="img-fluid rounded shadow-sm">
                </div>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>Medical and Surgical Devices</h5>
                        <p>Used in bone screws, plates, dental implants, and joint replacements due to its purity and tissue
                            compatibility.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Employed in airframes, jet engine components, and spacecraft due to its lightweight strength and
                            fatigue resistance.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>Marine & Subsea Equipment</h5>
                        <p>Performs reliably in high-saline, pressure-intensive underwater environments like submersibles
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Chosen for liquid gas containers and components due to its retained toughness at ultra-low
                            temperatures.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>Industrial & Power Sector</h5>
                        <p>Used in turbines, heat exchangers, and pressure vessels that operate under cyclic thermal and
                            mechanical loads.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>3D Printing / Additive Manufacturing</h5>
                        <p>Optimized grades of Grade 5 ELI are used in metal powder form for medical and aerospace-grade
            ...
            <div class="row g-4 mt-4">
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>Experts in titanium and high-performance alloys</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>In-house quality control and testing facilities</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>Prompt delivery with global export capability</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="why-banner-block">
                        ...
                        <h5>Customization for precision-critical industries</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="why-banner-block">
                        ...
                        <h5>Commitment to customer satisfaction and technical excellence</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="sec-padd-top sec-padd-bottom">
        <div class="container">
            <div class="contact-cta-box">
                <h2>Contact Us</h2>
                <p>
                    <strong>Moksh Tubes & Fittings LLP</strong> today for pricing, availability, or expert technical guidance.
                </p>
                <!-- Call button -->
