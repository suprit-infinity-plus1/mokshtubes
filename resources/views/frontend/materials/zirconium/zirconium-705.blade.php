...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="{{ asset('assets/images/zirconium/zirconium-705.webp') }}" alt="Zirconium 705"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplying, exporting, importing, and stocking a wide range of<strong class="text-black">
                                ...
                                <a href="{{ route('products') }}">products</a></strong>. Our comprehensive lineup includes
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download Zicrnium 705 Datasheet</h3>
            <p class="mb-3">
                Get the complete Zicrnium 705 datasheet with chemical composition,
            ...
            <form id="leadForm" method="POST" action="{{ route('lead.capture') }}" class="mb-3">
                @csrf
                <div class="row justify-content-center">
                    <input type="hidden" name="pdf" value="zicrnium_705.pdf">
