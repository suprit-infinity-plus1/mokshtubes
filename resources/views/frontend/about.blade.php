                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <figure class="about-img h-100 m-0">
                            ...
                            <img src="https://placehold.co/500x700" alt="about titan builders photo"
            ...
            <div class="container vision-mission">
                ...
                <div class="row align-items-center mb-5">
                    <div class="col-md-6">
                        <h2>OUR HISTORY</h2>
                        <p>
                            Established in the year <strong class="text-black">2005</strong> by <strong
                                class="text-black">Mr. Vikram B. Jain and Mr. Naresh
                                B. Jain, Moksh Tubes &
                                Fittings LLP,</strong>
                    ...
                    <div class="col-md-6 text-center">
                        <!-- Desktop Image -->
                        <img src="https://placehold.co/600x300?text=Large+Image" alt="Large"
                            class="img-fluid d-none d-lg-block">
                        <!-- Tablet Image -->
                        <img src="https://placehold.co/400x250?text=Tablet+Image" alt="Tablet"
                            class="img-fluid d-none d-md-block d-lg-none">
                        <!-- Mobile Image -->
                        <img src="https://placehold.co/300x200?text=Mobile+Image" alt="Mobile"
...
"></span>
        ...
        <section class="subscribe center sec-padd" style="background-image: url(images/background/5.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                        <h2>Subscribe For Newsletter</h2>
                        <p>Idea of denouncing pleasure praising pain was born and I will give you a complete account
                            <br> ofsystem, expound the great explorer.
                        </p>
                ...
                <div class="row">
                        ...
                        <div class="item tran5">
                            <div class="team-member">
                                <figure class="img-box">
                                    <a href="#"><img src="images/team/4.jpg" alt="team member photo"></a>
                                    <div class="overlay">
                                        <ul class="social">
                    ...
                    <article class="col-md-3 col-sm-6 col-xs-12">
                        <div class="item tran5">
                            <div class="team-member">
                                <figure class="img-box">
                                    <a href="#"><img src="images/team/3.jpg" alt="team member photo"></a>
                                    <div class="overlay">
                                        <ul class="social">
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                    ...
                    <article class="col-md-3 col-sm-6 col-xs-12">
                        <div class="item tran5">
                            <div class="team-member">
                                <figure class="img-box">
                                    <a href="#"><img src="images/team/2.jpg" alt="team member photo"></a>
                                    <div class="overlay">
                                        <ul class="social">
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                    ...
                    <article class="col-md-3 col-sm-6 col-xs-12">
                        <div class="item tran5">
                            <div class="team-member">
                                <figure class="img-box">
                                    <a href="#"><img src="images/team/1.jpg" alt="team member photo"></a>
                                    <div class="overlay">
                                        <ul class="social">
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
