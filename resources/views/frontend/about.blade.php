...
@section('meta_description', 'Learn about Mokshtubes LLP, trusted manufacturer & exporter of stainless steel, Hastelloy,
    and Inconel products.') <!-- 152 characters -->
...
@section('meta')
    <meta property="og:title" content="About Us – Mokshtubes Fittings & LLP" />
    <meta property="og:description"
        content="Learn about Mokshtubes LLP, trusted manufacturer & exporter of stainless steel, Hastelloy, and Inconel products." />
    <meta property="og:image" content="{{ asset('assets/images/about/Untitled.png') }}" />
    <meta property="og:url" content="{{ url()->current() }}" />
    <meta property="og:type" content="website" />

    <!-- Twitter / X -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="About Us – Mokshtubes Fittings & LLP">
    <meta name="twitter:description"
        content="Learn about Mokshtubes LLP, trusted manufacturer & exporter of stainless steel, Hastelloy, and Inconel products.">
    <meta name="twitter:image" content="{{ asset('assets/images/about/Untitled.png') }}">
@endsection
        ...
        <div class="container vision-mission">
            ...
            <div class="row align-items-center mb-5 flex-md-row-reverse">
                ...
                <div class="col-md-6 text-center">
                    ...
                    <img src="{{ asset('assets/images/history/our-goal.jpg') }}" alt="Large"
                        class="img-fluid d-none d-lg-block">
                    <!-- Tablet Image 400x250 -->
            ...
            <div class="row">
                ...
                <article class="col-md-3 col-sm-6 col-xs-12">
                    <div class="item tran5">
                        <div class="team-member">
                            <figure class="img-box">
                                <a href="#"><img src="{{ asset('assets/images/team/3.jpg') }}"
                                        alt="team member photo"></a>
                                <div class="overlay">
                                    <ul class="social">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <article class="col-md-3 col-sm-6 col-xs-12">
                    <div class="item tran5">
                        <div class="team-member">
                            <figure class="img-box">
                                <a href="#"><img src="{{ asset('assets/images/team/2.jpg') }}"
                                        alt="team member photo"></a>
                                <div class="overlay">
                                    <ul class="social">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <article class="col-md-3 col-sm-6 col-xs-12">
                    <div class="item tran5">
                        <div class="team-member">
                            <figure class="img-box">
                                <a href="#"><img src="{{ asset('assets/images/team/1.jpg') }}"
                                        alt="team member photo"></a>
                                <div class="overlay">
                                    <ul class="social">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
