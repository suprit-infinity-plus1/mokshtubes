<?php $__env->startSection('title', 'Industrial Custom Fabricated Fittings – Moksh Tubes'); ?> <!-- 53 characters -->
<?php $__env->startSection('meta_description', 'Moksh Tubes provides industrial-grade custom fabricated fittings in stainless, alloy,
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="breadcrumb-area" style="background-image: url(/assets/images/product/flangs/custom-fabricated-fittings.webp);">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/product/flangs/custom-fabricated-fittings.webp')); ?>"
                ...
                <div class="col-md-6">
                    <p class="fs-6 mb-3 text-justify">
                        ...
                        fittings, these are <a href="<?php echo e(route('materials.engineering-Steels')); ?>">engineered</a> and
                    ...
                    <p class="fs-6 mb-3 text-justify">
                        <a href="<?php echo e(route('index')); ?>">Moksh Tubes & Fittings LLP</a>, we produce a wide range of custom
                        fabricated fittings in <a href="<?php echo e(route('materials')); ?>">materials</a> like stainless steel, carbon
                        steel, alloy steel, duplex & super
                        duplex, <a href="<?php echo e(route('materials.titanium')); ?>">titanium</a>, and <a
                            href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel alloys</a>. Our fittings comply
                        with ASTM, ASME, DIN, EN, and API
                        standards, and are crafted using cutting, forming, bending, <a
                            href="<?php echo e(route('blogs.welded-vs-seamless')); ?>">welding</a>, and machining techniques to
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody>
                                ...
                                <tr class="t-row">
                                    <td>Nickel Alloys</td>
                                    <td><a href="<?php echo e(route('materials.inconel')); ?>">Inconel 600/625/825</a>, <a
                                            href="<?php echo e(route('materials.monel')); ?>">Monel 400/K500</a>, <a
                                            href="<?php echo e(route('materials.hastelloy')); ?>">Hastelloy C22/C276</a> – for extreme
                                        heat and
                                ...
                                <tr class="t-row">
                                    <td>Copper Alloys</td>
                                    <td><a href="<?php echo e(route('materials.copper-Alloys')); ?>">Cu-Ni 70/30, Cu-Ni 90/10</a> –
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <ul>
                            ...
                            <li>Large bore <a
                                    href="<?php echo e(url('products/special-fabricated/fabricated-ss-grills')); ?>">fabricated</a>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="application-card">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo e(route('materials.titanium')); ?>">Titanium</a> and nickel alloy fittings for
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h5>Available in stainless, carbon, <a
                                href="<?php echo e(route('materials.duplex-and-super-duplex')); ?>">duplex</a>, nickel, titanium, and
                            copper alloys.</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>State of the Art Facilities: Advanced CNC, bending, and <a
                                href="<?php echo e(route('products.pipes-tubes.welded-pipes')); ?>">welding</a> capabilities.</h5>
                    </div>
                </div>
                            ...
                            <div class="accord-content">
                                <p>
                                    ...
                                    according to specific requirements, such as size, <a
                                        href="<?php echo e(route('materials')); ?>">material</a>, design, or application. They
                            ...
                            <div class="accord-content">
                                <p>
                                    ...
                                    (Inconel, Hastelloy, Monel), titanium, <a
                                        href="<?php echo e(route('materials.copper-Alloys')); ?>">copper alloys</a>, and other high
                                    performance
                            ...
                            <div class="accord-content">
                                <p>
                                    ...
                                    machining, and heat treatment to ensure precise dimensions, <a
                                        href="<?php echo e(route('materials.high-strength-stainless-steel')); ?>">strength</a>, and
                                    durability.
                                </p>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/products/pipe-fittings-flanges-fasteners/custom-fabricated-fittings.blade.php ENDPATH**/ ?>