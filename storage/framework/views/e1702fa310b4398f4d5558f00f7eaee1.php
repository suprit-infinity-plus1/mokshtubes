<?php $__env->startSection('title', 'Titanium Grade 9 – High Strength & Corrosion Resistant'); ?> <!-- 52 chars -->
<?php $__env->startSection('meta_description', 'Titanium Grade 9 alloy offers superior strength, corrosion resistance, and durability, perfect for aerospace, marine, and industrial applications.'); ?>
<?php $__env->startSection('meta_keywords', 'Titanium Grade 9, High Strength Titanium, Corrosion Resistant Titanium, Titanium Grade 9 Pipes, Titanium Grade 9 Tubes, Aerospace Titanium Alloys, Marine Titanium Alloys, Industrial Titanium Alloys, Durable Titanium, Premium Titanium Alloy'); ?>
<?php $__env->startSection('og_image', asset('assets/images/titanium/Titanium-9.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/titanium/Titanium-9.webp')); ?>" alt="Titanium Grade 9"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            exporter, importer, and stockist of high-performance<strong class="text-black"> Titanium Grade 9
                                (Ti-3Al-2.5V) <a href="<?php echo e(route('products')); ?>">products</a></strong> ,
                        ...
                        <p>
                            ...
                            marine hardware and sports equipment,<strong class="text-black"> <a
                                    href="<?php echo e(route('materials.titanium')); ?>">Titanium Grade 9</a></strong>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/titanium/titanium-grade-9.blade.php ENDPATH**/ ?>