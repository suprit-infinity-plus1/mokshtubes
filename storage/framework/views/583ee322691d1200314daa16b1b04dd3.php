<?php $__env->startSection('title', 'Stellite Metal | Moksh Tubes – Durable & High Strength'); ?>
<?php $__env->startSection('meta_description', 'Stellite alloys at MokshTubes deliver exceptional hardness, wear and corrosion resistance for cutting tools, valves, machinery & high-stress applications.'); ?>
<?php $__env->startSection('meta_keywords', 'Stellite alloy, high hardness alloy, wear resistant alloy, corrosion resistant alloy, cutting tools alloy, valves alloy, industrial machinery alloy, durable Stellite'); ?>
<?php $__env->startSection('og_image', asset('assets/images/hard-to-find-and-special-alloys/hard-to-find-and-special-alloys-stellite.webp')); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/hard-to-find-and-special-alloys/hard-to-find-and-special-alloys-stellite.webp')); ?>"
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            <strong class="text-black"> <a href="<?php echo e(route('index')); ?>">MOKSH TUBES & FITTINGS
                            ...
                            Rods, Bars, <a href="<?php echo e(route('products.pipes-tubes')); ?>">Tubes</a>, Welding Wires, Electrodes,
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <p class="mb-3">
                Get the complete Stellite Alloys datasheet with chemical composition,
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/hard-to-find-special-alloys/hard-to-find-special-alloys-stellite.blade.php ENDPATH**/ ?>