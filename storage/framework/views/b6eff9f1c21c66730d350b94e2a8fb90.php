<?php $__env->startSection('title', 'Contact Mokshtubes Fittings LLP | Request a Quote or Inquiry'); ?>
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="sticky-card" style="position: sticky; top: 100px;">
                        <div class="list-group">
                            ...
                            <a href="<?php echo e(route('contact-us-gulalwadi')); ?>" class="list-group-item location-card">
                                <h2 class="mb-1 fw-semibold h5">Gulalwadi – Mumbai</h2>
                                <p class="mb-0 small">Bldg. No. 36/40, Hinglaj Bhavan, Kika Street</p>
                            </a>

                            <a href="<?php echo e(route('contact-us-khetwadi')); ?>" class="list-group-item location-card">
                                <h2 class="mb-1 fw-semibold h5">Khetwadi – Mumbai</h2>
                                <p class="mb-0 small">6/A, Ground Floor, Rajwanti Mansion</p>
                            </a>

                            <a href="<?php echo e(route('contact-us-kamatipura')); ?>" class="list-group-item location-card">
                                <h2 class="mb-1 fw-semibold h5">Kamatipura – Mumbai</h2>
                                <p class="mb-0 small">95/95A, Dawood Baug, Sukhlaji Street</p>
                            </a>

                            <a href="<?php echo e(route('contact-us-darukhana')); ?>" class="list-group-item location-card mb-0">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube-new\mokshtube\resources\views/frontend/contact.blade.php ENDPATH**/ ?>