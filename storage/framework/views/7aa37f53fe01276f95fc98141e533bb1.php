<?php $__env->startSection('title', 'SMO 654 – Super Austenitic Stainless Steel'); ?> <!-- 52 chars -->
<?php $__env->startSection('meta_description', 'SMO 654 is a super austenitic stainless steel offering excellent chloride resistance, high strength, and durability in harsh chemical environments.'); ?>
<?php $__env->startSection('meta_keywords', 'SMO 654, Super Austenitic Stainless Steel, Chloride Resistant Alloy, Chemical Resistant Steel, High Strength Stainless Steel, Industrial Stainless Steel Alloys'); ?>
<?php $__env->startSection('og_image', asset('assets/images/super-austenitic-stainless-steel/super-austenitic-stainless-steel-SMO-654.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/super-austenitic-stainless-steel/super-austenitic-stainless-steel-SMO-654.webp')); ?>"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, and stockist of high-performance<strong class="text-black"> SMO 654 (UNS
                                S32654) <a href="<?php echo e(route('products')); ?>">products</a>.</strong> We offer a
                        ...
                        <p> <strong class="text-black">SMO 654</strong> is an advanced super austenitic stainless steel
                            ...
                            nitrogen, SMO 654 surpasses other <a
                                href="<?php echo e(route('materials.austenitic-stainless-Steel')); ?>">stainless
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/super-austenitic-stainless-steel/super-austenitic-stainless-steel-smo-654.blade.php ENDPATH**/ ?>