<?php $__env->startSection('title', 'Hastelloy C-4 | High-Performance Alloy for Oxidizing Media'); ?>
<?php $__env->startSection('meta_description', 'Hastelloy C-4 pipes, tubes & fittings from Moksh Tubes — long-term stability & resistance
    to oxidizing chemicals, acids & high heat for industrial use.'); ?>
<?php $__env->startSection('meta_keywords', 'Hastelloy C-4, Hastelloy C4, high performance alloy, corrosion resistant alloy, Hastelloy C4
...
<?php $__env->startSection('og_image', asset('assets/images/hastelloy/hastelloy-C4.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/hastelloy/hastelloy-C4.webp')); ?>" alt="Hastelloy C276"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            products, including <strong class="text-black"><a
                                    href="<?php echo e(route('products.pipes-tubes')); ?>">Pipes & Tubes</a>, Pipe Fittings, Flanges,
                        ...
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            due to its low silicon and carbon content. Like other <a
                                href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel alloys</a>, it is known for
                            ...
                            a wide range of thermal conditions, <a
                                href="<?php echo e(route('materials.hard-To-Find-Special-Alloys')); ?>">Hastelloy C-4</a>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/hastelloy/hastelloy-c4.blade.php ENDPATH**/ ?>