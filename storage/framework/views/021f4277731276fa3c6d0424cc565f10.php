<?php $__env->startSection('title', 'Moksh Tubes LLP | High-Performance Metal Alloys & Products'); ?>
...
<?php $__env->startSection('canonical', 'https://mokshtubes.com'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div id="slider1" class="rev_slider" data-version="5.0">
            <ul>
                <li data-transition="slidingoverlayleft">
                    <img src="<?php echo e(asset('assets/images/slides/Mokshtubes-banner-desktop.webp')); ?>"
                    ...
                    <div class="tp-caption tp-resizeme" data-x="left" data-hoffset="15" data-y="center" data-voffset="110"
                        ...
                        <div class="slide-content-box">
                            <div class="button">
                                <a class="thm-btn bg-clr1" href="<?php echo e(route('about-us')); ?>">about us</a>
                            </div>
                        </div>
                    </div>
                    <div class="tp-caption tp-resizeme" data-x="left" data-hoffset="227" data-y="center" data-voffset="110"
                        ...
                        <div class="slide-content-box">
                            <div class="button">
                                <a class="thm-btn bg-clr2" href="<?php echo e(route('contact-us')); ?>">Contact Us</a>
                            </div>
                        </div>
                    </div>
                ...
                <li data-transition="slidingoverlayleft">
                    <img src="<?php echo e(asset('assets/images/slides/carpenteria-interno.webp')); ?>" alt="banner image"
                    ...
                    <div class="tp-caption tp-resizeme" data-x="right" data-hoffset="400" data-y="center"
                ...
                <li data-transition="slidingoverlayright">
                    <img src="<?php echo e(asset('assets/images/slides/we-help.webp')); ?>" alt="banner image" width="1920"
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    ...
                    <figure class="about-img">
                        ...
                        <img src="<?php echo e(asset('assets/images/about/about-moksh-tubes.jpg')); ?>"
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="single-our-service border">
                        <figure class="img-box mb-0">
                            <figure class="img-box mb-0">
                                <a class="w-100" href="<?php echo e(route('products.pipes-tubes.welded-pipes')); ?>">
                                    <img src="/assets/images/service/WELDED-PIPES.webp" alt="Awesome Image"
                                        class="w-100"></a>
                            </figure>

                            <div class="p-3">
                                <a href="<?php echo e(route('products.pipes-tubes.welded-pipes')); ?>">
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="single-our-service border">
                        <figure class="img-box mb-0">
                            <a class="w-100" href="<?php echo e(route('products.pipes-tubes.seamless-pipes')); ?>">
                                <img class="w-100" src="/assets/images/service/SEAMLESS-PIPES.webp" alt="Awesome Image">
                            </a>
                        </figure>
                        <div class="p-3">
                            <a href="<?php echo e(route('products.pipes-tubes.seamless-pipes')); ?>">
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="single-our-service border">
                        <figure class="img-box mb-0">
                            <a class="w-100" href="<?php echo e(route('products.sheets-plates-coils.sheets-and-plates')); ?>">
                        ...
                        <div class="p-3">
                            <a href="<?php echo e(route('products.sheets-plates-coils.sheets-and-plates')); ?>">
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="single-our-service border">
                        ...
                        <div class="p-3">
                            <a href="<?php echo e(route('products.sheets-plates-coils.perforated-sheets')); ?>">
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="single-our-service border">
                        ...
                        <div class="p-3">
                            <a href="<?php echo e(route('products.bars-rods.round-bars')); ?>">
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="single-our-service border">
                        <figure class="img-box mb-0">
                            <a class="w-100" href="<?php echo e(route('products.pipe-fittings-flanges-fasteners.fasteners')); ?>">
                                
                                <img class="w-100" src="/assets/images/service/FASTENERS-1.webp" alt="Awesome Image">
                            </a>
                        </figure>
                        <div class="p-3">
                            <a href="<?php echo e(route('products.pipe-fittings-flanges-fasteners.fasteners')); ?>">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="footer-col service-col">
                        ...
                        <ul class="footer-list">
                            <li><a href="<?php echo e(route('products.pipes-tubes.welded-pipes')); ?>">WELDED PIPES (ERW & EFW)</a>
                            </li>
                            <li><a href="<?php echo e(route('products.pipes-tubes.seamless-pipes')); ?>">SEAMLESS PIPES</a></li>
                            <li><a href="<?php echo e(route('products.pipes-tubes.capillaries')); ?>">CAPILLARIESS</a></li>
                            <li><a href="<?php echo e(route('products.pipes-tubes.hollow-section-pipe')); ?>">HOLLOW SECTION PIPE
                                    (SQUARE, RECTANGULAR & OVAL)</a></li>
                            <li><a href="<?php echo e(route('products.pipes-tubes.u-bent-tubes')); ?>">U-BENT TUBES</a></li>
                            <li><a href="<?php echo e(route('products.pipes-tubes.boiler-heat-exchanger-tubes')); ?>">BOILER & HEAT
                ...
                <div class="col-md-4">
                    <div class="footer-col service-col">
                        ...
                        <ul class="footer-list">
                            ...
                            <li><a href="<?php echo e(route('products.sheets-plates-coils.coils')); ?>">COILS</a></li>
                            <li><a href="<?php echo e(route('products.sheets-plates-coils.strips')); ?>">STRIPS</a></li>
                            <li><a href="<?php echo e(route('products.sheets-plates-coils.perforated-sheets')); ?>">PERFORATED
                                    SHEETS</a></li>
                            <li><a href="<?php echo e(route('products.sheets-plates-coils.chequered-sheets')); ?>">CHEQUERED
                                    SHEETS</a></li>
                            <li><a href="<?php echo e(route('products.sheets-plates-coils.shim-sheets')); ?>">SHIM SHEETS</a></li>
                            <li><a href="<?php echo e(route('products.sheets-plates-coils.cladded-plates')); ?>">CLADDED PLATES</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="footer-col service-col">
                        ...
                        <ul class="footer-list">
                            ...
                            <li><a href="<?php echo e(route('products.bars-rods.hexagon-bars')); ?>">HEXAGON BARS</a></li>
                            <li><a href="<?php echo e(route('products.bars-rods.flat-bars')); ?>">FLAT BARS</a></li>
                            <li><a href="<?php echo e(route('products.bars-rods.square-bars')); ?>">SQUARE BARS</a></li>
                            <li><a href="<?php echo e(route('products.bars-rods.threaded-rods')); ?>">THREADED RODS</a></li>
                            <li><a href="<?php echo e(route('products.bars-rods.hollow-bars')); ?>">HOLLOW BARS</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="footer-col service-col">
                        ...
                        <ul class="footer-list">
                            <li><a href="<?php echo e(route('products.pipe-fittings-flanges-fasteners')); ?>">FITTINGS</a></li>
                            <li><a
                                    href="<?php echo e(route('products.pipe-fittings-flanges-fasteners.fittings-and-flanges')); ?>">FLANGES</a>
                            </li>
                            <li><a href="<?php echo e(route('products.pipe-fittings-flanges-fasteners.fasteners')); ?>">FASTENERS</a>
                            </li>
                            <li><a
                                    href="<?php echo e(route('products.pipe-fittings-flanges-fasteners.flanges-and-gaskets')); ?>">GASKETS</a>
                            </li>
                            <li><a href="<?php echo e(route('products.special-fabricated.custom-steel-furniture')); ?>">CUSTOM
                ...
                <div class="col-md-6">
                    <div class="footer-col service-col">
                        ...
                        <ul class="footer-list">
                            <li><a href="<?php echo e(route('products.special-fabricated.ss-railings')); ?>">SS RAILING PRODUCTS</a>
                            </li>
                            <li><a href="<?php echo e(route('products.special-fabricated.glass-railings')); ?>">GLASS RAILINGS</a>
                            </li>
                            <li><a href="<?php echo e(route('products.special-fabricated.custom-steel-furniture')); ?>">CUSTOM STEEL
                                    FURNITURE</a></li>
                            <li><a href="<?php echo e(route('products.special-fabricated.fabricated-ss-grills')); ?>">FABRICATED SS
                                    GRILLS</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="default-blog-news wow fadeInUp animated animated"
                        ...
                        <figure class="img-holder mb-0">
                            <a href="<?php echo e(route('blogs.emerging-trends-in-industrial-piping-for-2025-and-beyond')); ?>"><img
                                    src="<?php echo e(asset('assets/images/blog/emerging-trends-in-industrial-piping-for-2025-and-beyond_11zon_11zon_11zon.webp')); ?>"
                                    alt="News"></a>
                            <figcaption class="overlay">
                                <div class="box">
                                    <div class="content">
                                        <a
                                            href="<?php echo e(route('blogs.emerging-trends-in-industrial-piping-for-2025-and-beyond')); ?>"><i
                        ...
                        <div class="lower-content">
                            <a href="<?php echo e(route('blogs.emerging-trends-in-industrial-piping-for-2025-and-beyond')); ?>">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="default-blog-news wow fadeInUp animated animated"
                        ...
                        <figure class="img-holder mb-0">
                            <a href="#"><img
                                    src="<?php echo e(asset('/assets/images/blog/indias-stainless-steel-export-industry.webp')); ?>"
                                    alt="News"></a>
                            <figcaption class="overlay">
                                <div class="box">
                                    <div class="content">
                                        <a href="<?php echo e(route('blogs.indias-stainless-steel-export-industry')); ?>"><i
                                                class="fa fa-link" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </figcaption>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="default-blog-news wow fadeInUp animated animated"
                        style="visibility: visible; animation-name: fadeInUp;">
                        <figure class="img-holder mb-0">
                            <a href="#"><img src="<?php echo e(asset('assets/images/blog/Untitled.webp')); ?>"
                                    alt="News"></a>
                            <figcaption class="overlay">
                                <div class="box">
                                    <div class="content">
                                        <a href="<?php echo e(route('blogs.the-role-of-high-performance')); ?>"><i class="fa fa-link"
                        ...
                        <div class="lower-content">
                            ...
                            <div class="link">
                                <a href="<?php echo e(route('blogs.the-role-of-high-performance')); ?>" class="default_link">Read
    ...
    <div class="container py-5 text-center ">
        ...
        <div class="col-md-8 mx-auto mt-4" style="position:relative;width:100%;aspect-ratio:3/2;overflow:hidden;">
            <img src="<?php echo e(asset('assets/images/map.jpg')); ?>" alt="International Market"
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube-new\mokshtube\resources\views/frontend/index.blade.php ENDPATH**/ ?>