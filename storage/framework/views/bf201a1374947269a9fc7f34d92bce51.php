<?php $__env->startSection('title', 'Monel R405 Alloy – Premium Strength & Machinability'); ?> <!-- 53 chars -->
...
<?php $__env->startSection('meta_keywords',
    ...
    Alloys'); ?>
<?php $__env->startSection('og_image', asset('assets/images/monel/Monel-R405.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/monel/Monel-R405.webp')); ?>" alt="Monel K500"
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, importer, and stockist of <a href="<?php echo e(route('materials.monel')); ?>">MONEL
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black">MONEL R405</strong class="text-black"> is a <a
                                href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel</a> copper <a
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <form id="leadForm" method="POST" action="<?php echo e(route('lead.capture')); ?>" class="mb-3">
                <?php echo csrf_field(); ?>
                <div class="row justify-content-center">
                    <input type="hidden" name="pdf" value="Monel_R405_data_sheet.pdf">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/monel/monel-r405.blade.php ENDPATH**/ ?>