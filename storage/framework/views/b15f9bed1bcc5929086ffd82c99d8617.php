...
<?php $__env->startSection('content'); ?>
    ...
    <section class="breadcrumb-area" style="background-image: url(<?php echo e(asset('storage/' . $blog->cover_image)); ?>);">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="accordion-box">
                                                        ...
                                                        <?php $__currentLoopData = $blog->faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="sidebar-wrapper">
                        ...
                        <div class="single-sidebar">
                            ...
                            <ul class="recent-post">
                                <?php $__currentLoopData = $allBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allBlog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    
                                    <li>
                                        <div class="img-holder">
                                            <img src="<?php echo e(asset('storage/' . $allBlog->cover_image)); ?>"
                                                alt="<?php echo e($allBlog->title); ?>">
                                            <div class="overlay-style-two">
                                                <div class="box">
                                                    <div class="content">
                                                        <a href="<?php echo e(route('frontend.single-blog', $allBlog->slug)); ?>">
                                        ...
                                        <div class="title-holder">
                                            <a href="<?php echo e(route('frontend.single-blog', $allBlog->slug)); ?>">
                                                <h5 class="post-title">
                                                    <?php echo e($allBlog->title); ?>

                                                </h5>
                                            </a>
                                            <h6 class="post-date">
                                                <i class="icon-calendar-with-spring-binder-and-date-blocks"></i>
                                                <?php echo e(\Carbon\Carbon::parse($allBlog->published_at)->format('F d, Y')); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube-new\mokshtube\resources\views/frontend/blogs/single-blog.blade.php ENDPATH**/ ?>