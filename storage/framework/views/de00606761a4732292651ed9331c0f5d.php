<?php $__env->startSection('title', 'Electrolytic Copper (EC Copper) | High Purity Copper'); ?>
<?php $__env->startSection('meta_description', 'High purity Electrolytic Copper with excellent electrical and thermal conductivity.'); ?>
...
<?php $__env->startSection('og_image', asset('assets/images/copper-alloys/copper-alloys-ec-copper.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/copper-alloys/copper-alloys-ec-copper.webp')); ?>"alt="Copper Alloys EC Copper"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, importer, and stockist of<strong class="text-black"> EC Copper (Electrolytic
                                ...
                                <a href="<?php echo e(route('products')); ?>">products</a></strong>. Our offerings include Wires, Rods,
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black"><a href="<?php echo e(route('materials.copper-Alloys')); ?>">Copper Alloys EC Copper</a></strong>, also known as Electrolytic Grade Copper, is a high-purity copper
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/copper-alloys/copper-alloys-ec-copper.blade.php ENDPATH**/ ?>