...
<div class="bg-dark text-white mb-3 px-4 py-3 rounded-2">
    <ul class="breadcrumb text-white-all mb-0" style="background-color: transparent">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.blogs.categories')); ?>" class="text-white text-decoration-none"><i class="fas fa-list"></i> All Categories</a></li>
...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('admin.blogs.categories.update', $category->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube-new\mokshtube\resources\views/backend/blog_categories/edit.blade.php ENDPATH**/ ?>