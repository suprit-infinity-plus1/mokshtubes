<?php $__env->startSection('title', 'Inconel 718 – High-Strength Alloy for Extreme Loads'); ?> <!-- 53 chars -->
<?php $__env->startSection('meta_description', 'Inconel 718 offers superior tensile strength, fatigue, and oxidation resistance—ideal for aerospace, turbines, and energy sectors.'); ?>
<?php $__env->startSection('meta_keywords', 'Inconel 718, High-Strength Alloy, Extreme Load Alloys, Nickel Alloys, Aerospace Alloys, Turbine Alloys, Energy Sector Alloys, Fatigue Resistant Alloys, Oxidation Resistant Alloys, Corrosion Resistant Alloys'); ?>
<?php $__env->startSection('og_image', asset('assets/images/inconel/Inconel-718.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/inconel/Inconel-718.webp')); ?>" alt="Inconel 718"
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            products. These include <a href="<?php echo e(route('products.pipes-tubes')); ?>">Pipes &
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black">INCONEL 718</strong class="text-black"> is a <a
                                href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel</a> chromium <a href="<?php echo e(route('materials.hastelloy')); ?>">alloy</a>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/inconel/inconel-718.blade.php ENDPATH**/ ?>