<?php $__env->startSection('title', 'Carbide Alloys for Superior Hardness & Precision'); ?>
...
<?php $__env->startSection('og_image', asset('assets/images/hard-to-find-and-special-alloys/hard-to-find-and-special-alloys-carbide.webp')); ?>
...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            exporter, and supplier of Carbide Alloys, offering a wide range of <a
                                href="<?php echo e(route('products')); ?>">products</a> including Tungsten
                            ...
                            parts, and custom-engineered <a
                                href="<?php echo e(route('materials.hard-To-Find-Special-Alloys')); ?>">carbide</a> components
                            designed to withstand extreme wear, abrasion,
                            and thermal stress.

                        <p> <strong class="text-black"><a
                                    href="<?php echo e(route('materials.hard-To-Find-Special-Alloys')); ?>">Carbide
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download Carbide Alloys Datasheet</h3>
            <p class="mb-3">
                Get the complete Carbide Alloys datasheet with chemical composition,
