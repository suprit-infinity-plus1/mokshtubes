<?php $__env->startSection('meta_title', 'Hastelloy Alloys C22, C276, B2 – Grades, Composition & Uses | Moksh Tubes LLP'); ?>

<?php $__env->startSection('meta_description', 'Hastelloy C276, C22 & B2 alloys from Moksh Tubes — exceptional corrosion resistance for chemical, marine, oil & gas, and industrial use.'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="breadcrumb-area" style="background-image: url(/assets/images/hastelloy/hastelloy-banner.jpg);">
        <div class="container">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube-new\mokshtube\resources\views/frontend/materials/hastelloy/index.blade.php ENDPATH**/ ?>