<?php $__env->startSection('title', 'Duplex Steel S31803 | High Strength & Corrosion Resistance'); ?>
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        ...
                        <p class="fs-6 text-justify" style="text-align: justify;">
                            ...
                            corrosion cracking are a concern. <a href="<?php echo e(route('index')); ?>">MOKSH TUBES & FITTINGS LLP</a>
                            is a trusted supplier, exporter, importer, and stockist of Duplex S31803 products such as <a
                                href="<?php echo e(route('products')); ?>">pipes, tubes, fittings, flanges, plates, and custom
                                components</a>.
                        </p>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/duplex-and-super-duplex/duplex-s31803.blade.php ENDPATH**/ ?>