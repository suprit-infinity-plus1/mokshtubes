<?php $__env->startSection('title', 'Austenitic Stainless Steel 309 | Heat Resistant Alloy'); ?>

<?php $__env->startSection('meta_description', 'Austenitic Stainless Steel 309 – high-quality alloy offering superior oxidation resistance and durability for high-temperature and industrial applications.'); ?>
...
<?php $__env->startSection('og_image', asset('assets/images/austenitic-stainless-steel/austenitic-stainless-steel-309.webp')); ?>
<?php $__env->startSection('og_type', 'article'); ?>

<?php $__env->startSection('content'); ?>

    <!--Start breadcrumb area-->
    <section class="breadcrumb-area" style="background-image: url(/assets/images/austenitic-stainless-steel/austenitic-stainless-steel-309.webp);">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/austenitic-stainless-steel/austenitic-stainless-steel-309.webp')); ?>"alt="Austenitic Stainless Steel 309"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, importer, and stockist of<strong class="text-black"> Austenitic Stainless
                                Steel 309 <a href="<?php echo e(route('products')); ?>"> products</a>,</strong> including
                            pipes,<a href="<?php echo e(route('products.pipes-tubes')); ?>"> tubes</a>, sheets, plates, bars, and
                            fittings.
                        </p>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/austenitic-stainless-steel/austenitic-stainless-steel-309.blade.php ENDPATH**/ ?>