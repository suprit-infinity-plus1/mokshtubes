<?php $__env->startSection('title', 'Premium Pipe Fittings Manufacturer & Supplier'); ?> <!-- 52 characters -->
<?php $__env->startSection('meta_description', 'Stainless, carbon, alloy, duplex, nickel, and titanium pipe fittings from Moksh Tubes — ASTM/ASME compliant and built for reliable performance.'); ?> <!-- 153 characters -->
<?php $__env->startSection('meta_keywords', 'Pipe Fittings, Stainless Steel Fittings, Carbon Steel Fittings, Alloy Steel Fittings, Duplex
    Fittings, Nickel Alloy Fittings, Titanium Fittings, ASTM/ASME Fittings, Industrial Pipe Fittings'); ?>
    <?php $__env->startSection('og_image', asset('assets/images/product/flangs/Pipe-Fittings.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/product/flangs/Pipe-Fittings.webp')); ?>" alt="Pipe-Fittings"
                ...
                <div class="col-md-6">
                    ...
                    <p class="fs-6 mb-3 text-justify">
                        ...
                        complex layouts. Manufactured from stainless steel, carbon steel, alloy steel, <a
                            href="<?php echo e(route('materials.duplex-and-super-duplex')); ?>">duplex, super duplex</a>,
                            ...
                            <tbody class="text-start">
                                <tr class="t-row">
                                    ...
                                    <td>Stainless Steel, Carbon Steel, Alloy Steel, Duplex & Super Duplex, <a
                                        ...
                                        Titanium, <a href="<?php echo e(route('materials.copper-Alloys')); ?>">Copper Alloys</a></td>
                                </tr>
                                <tr class="t-row">
                                    <td>Grades</td>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/products/pipe-fittings-flanges-fasteners/pipe-fittings.blade.php ENDPATH**/ ?>