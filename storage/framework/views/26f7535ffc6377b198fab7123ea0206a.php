<?php $__env->startSection('title', 'Titanium Grade 7 – Corrosion Resistant Titanium Alloy'); ?> <!-- 52 chars -->
<?php $__env->startSection('meta_description', 'Titanium Grade 7 – excellent corrosion resistance in oxidizing and reducing environments, ideal for chemical, marine, and industrial applications.'); ?>
<?php $__env->startSection('meta_keywords', 'Titanium Grade 7, Corrosion Resistant Titanium, Titanium Grade 7 Pipes, Titanium Grade 7 Tubes, Titanium Grade 7 Sheets, Oxidizing Resistant Titanium, Reducing Environment Titanium, Chemical Industry Titanium, Industrial Titanium Alloys, High Performance Titanium'); ?>
<?php $__env->startSection('og_image', asset('assets/images/titanium/titanium-7.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/titanium/titanium-7.webp')); ?>" alt="Titanium Grade 7"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, importer, and stockist of premium<strong class="text-black"> Titanium Grade
                                7 <a href="<?php echo e(route('products')); ?>">products</a>.</strong> Our inventory
                            includes <a href="<?php echo e(route('products.pipes-tubes')); ?>">Pipes & Tubes</a>, Pipe Fittings,
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Perfect for reactors, piping, tanks, and heat exchangers handling hydrochloric or nitric acids.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>Desalination Plants & Marine Systems</h5>
                        <p>Stands up to seawater and brine environments—used in condensers, piping, and cooling systems.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>Power Generation & Nuclear Industries</h5>
                        <p>Ideal for heat exchanger tubing and structural components exposed to corrosive coolants and
                            radiation.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Used in scrubbers, ducts, and stack liners facing corrosive flue gases.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>Medical & Pharmaceutical Processing</h5>
                        <p>Preferred where high purity and biocompatibility are required.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>Electroplating & Pickling Industries</h5>
                        <p>Reliable in handling strong acid solutions and chlorine-based electrolytes.</p>
                    </div>
                </div>
            ...
            <div class="row g-4 mt-4">
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>Manufacturing Excellence in titanium and specialty alloys
                        </h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>Global Supply Network for high-grade, certified raw materials</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>Tailored Engineering Solutions for your unique project needs</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="why-banner-block">
                        ...
                        <h5>In-Stock Inventory for fast delivery and custom orders</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="why-banner-block">
                        ...
                        <h5>Customer-Centric Support focused on reliability and satisfaction</h5>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/titanium/titanium-grade-7.blade.php ENDPATH**/ ?>