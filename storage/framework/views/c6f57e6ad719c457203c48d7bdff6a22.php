<?php $__env->startSection('title', 'Titanium Grade 1 – Pure Titanium Material & Uses'); ?> <!-- 52 chars -->
<?php $__env->startSection('meta_description', 'Titanium Grade 1 offers excellent corrosion resistance, ductility, and weldability—ideal for chemical, marine, and industrial applications.'); ?>
<?php $__env->startSection('meta_keywords', 'Titanium Grade 1, Commercially Pure Titanium, Corrosion Resistant Titanium, Titanium Grade 1 Pipes, Titanium Grade 1 Tubes, Titanium Grade 1 Sheets, Marine Industry Titanium, Chemical Processing Titanium, Weldable Titanium Alloy, Industrial Titanium Grades'); ?>
<?php $__env->startSection('og_image', asset('assets/images/titanium/titanium-1.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/titanium/titanium-1.webp')); ?>" alt="Titanium Grade 1"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            exports, imports, and stocks a wide variety of<strong class="text-black"> Titanium Grade
                                1</strong> products, including <a href="<?php echo e(route('products.pipes-tubes')); ?>">Pipes &
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            ...
                            softest among all commercially pure <a href="<?php echo e(route('materials.titanium')); ?>">titanium
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/titanium/titanium-grade-1.blade.php ENDPATH**/ ?>