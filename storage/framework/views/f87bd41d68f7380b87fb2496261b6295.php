<?php $__env->startSection('title', 'Austenitic Stainless Steel 347 | High-Temp Stability SS'); ?>

<?php $__env->startSection('meta_description', 'Austenitic Stainless Steel 347 from Moksh Tubes — excellent long-term high-temperature & corrosion resistance for industrial applications.'); ?>
...
<?php $__env->startSection('og_image', asset('assets/images/austenitic-stainless-steel/austenitic-stainless-steel-347.webp')); ?>
<?php $__env->startSection('og_type', 'article'); ?>

<?php $__env->startSection('content'); ?>

    <!--Start breadcrumb area-->
    <section class="breadcrumb-area" style="background-image: url(/assets/images/austenitic-stainless-steel/austenitic-stainless-steel-347.webp);">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/austenitic-stainless-steel/austenitic-stainless-steel-347.webp')); ?>"alt="Austenitic Stainless Steel 347"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, importer, and stockist of<strong class="text-black"> Austenitic Stainless
                                Steel 347 <a href="<?php echo e(route('products')); ?>">products</a></strong> including
                            <a href="<?php echo e(route('products.pipes-tubes')); ?>">pipes & tubes</a>, sheets, plates, bars, and
                            fittings.
                        </p>
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            ...
                            cracking compared to <a href="<?php echo e(route('materials.austenitic-stainless-Steel')); ?>">304 stainless
                                steel</a>.
                        </p>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/austenitic-stainless-steel/austenitic-stainless-steel-347.blade.php ENDPATH**/ ?>