<?php $__env->startSection('title', 'Aluminium Bronze Alloy | High Strength & Corrosion Resistant'); ?>
<?php $__env->startSection('meta_description', 'Aluminium Bronze – high-strength copper alloy offering exceptional corrosion resistance for marine, chemical, and heavy industrial applications.'); ?>
<?php $__env->startSection('meta_keywords', 'Aluminium Bronze, copper alloy, high strength copper, corrosion resistant alloy, marine copper alloy, industrial copper alloy'); ?>
<?php $__env->startSection('og_image', asset('assets/images/copper-alloys/copper alloys aluminium bronze.webp')); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/copper-alloys/copper alloys aluminium bronze.webp')); ?>"alt="Aluminium Bronze"
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            copper-based alloys with <a href="<?php echo e(route('materials.aluminium-Alloys')); ?>">aluminium</a> as
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black"><a href="<?php echo e(route('materials.copper-Alloys')); ?>">Aluminium
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download Aluminium Bronze Datasheet</h3>
            <p class="mb-3">
                Get the complete Aluminium Bronze datasheet with chemical composition,
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/copper-alloys/copper-alloys-aluminium-bronze.blade.php ENDPATH**/ ?>