<?php $__env->startSection('title', 'Titanium Grade 2 – Industrial Grade Titanium'); ?> <!-- 52 chars -->
<?php $__env->startSection('meta_description', 'Titanium Grade 2 provides excellent corrosion resistance and strength, ideal for aerospace, medical, and industrial applications.'); ?>
<?php $__env->startSection('meta_keywords', 'Titanium Grade 2, Industrial Grade Titanium, Corrosion Resistant Titanium, Titanium Grade 2 Pipes, Titanium Grade 2 Tubes, Titanium Grade 2 Sheets, Aerospace Titanium Alloys, Medical Industry Titanium, High Strength Titanium, Industrial Titanium Grades'); ?>
<?php $__env->startSection('og_image', asset('assets/images/titanium/titanium-2.webp')); ?>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    <h1>Titanium Grade 2 <br> Corrosion Resistant & Industrial Alloy</h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/titanium/titanium-2.webp')); ?>" alt="Titanium Grade 2"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, importer, and stockist of a comprehensive range of<strong
                                class="text-black"> Titanium Grade 2 <a href="<?php echo e(route('products')); ?>">products</a>
                            ...
                            Bars, Flat Bars, Angles, Welding Rods, Wire Mesh, and other Custom or <a
                                href="<?php echo e(route('materials.hard-To-Find-Special-Alloys')); ?>">Hard-to-Find</a> Titanium
                            Grade 2 Components.
                        </p>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/titanium/titanium-grade-2.blade.php ENDPATH**/ ?>