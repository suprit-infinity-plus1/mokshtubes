<?php $__env->startSection('title', 'Inconel X-750 – Extreme Heat & Oxidation Alloy'); ?> <!-- 53 chars -->
<?php $__env->startSection('meta_description', 'Inconel X-750 maintains strength and stability in extreme heat—ideal for springs, fasteners, and high-performance gas turbines.'); ?>
<?php $__env->startSection('meta_keywords', 'Inconel X-750, Extreme Heat Alloys, Oxidation Resistant Alloys, High Temperature Alloys, Nickel Alloys, Corrosion Resistant Alloys, Inconel Springs, Inconel Fasteners, High-Performance Gas Turbine Alloys'); ?>
<?php $__env->startSection('og_image', asset('assets/images/inconel/Inconel-X 750.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/inconel/Inconel-X 750.webp')); ?>" alt="Inconel X-750"
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            range of forms including <a href="<?php echo e(route('products.pipes-tubes')); ?>">Pipes & Tubes</a>, Pipe
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            ...
                            <a href="<?php echo e(route('materials.hastelloy')); ?>">alloy</a> made for high-strength applications at elevated temperatures. This alloy is strengthened
                            by additions of <a href="<?php echo e(route('materials.aluminium-Alloys')); ?>">aluminum</a> and <a
                                href="<?php echo e(route('materials.titanium')); ?>">titanium</a>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/inconel/inconel-x750.blade.php ENDPATH**/ ?>