<?php $__env->startSection('title', '253 MA – Heat & Oxidation Resistant Alloy'); ?> <!-- 52 chars -->
<?php $__env->startSection('meta_description', '253 MA alloy is designed for high-temperature industrial environments, offering excellent strength and oxidation resistance up to 1150°C.'); ?>
<?php $__env->startSection('meta_keywords', '253 MA, Heat Resistant Alloy, Oxidation Resistant Alloy, High Temperature Alloy, 253 MA Pipes, 253 MA Tubes, 253 MA Fittings, Industrial Heat Resistant Alloys, High Strength Alloy, Corrosion Resistant Alloy'); ?>
<?php $__env->startSection('og_image', asset('assets/images/super-austenitic-stainless-steel/super-austenitic-stainless-steel-253.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/super-austenitic-stainless-steel/super-austenitic-stainless-steel-253.webp')); ?>"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            good structural stability. We offer a broad range of<strong class="text-black"> 253 MA
                                products</strong> including <a href="<?php echo e(route('products.pipes-tubes')); ?>">Pipes & Tubes</a>,
                        ...
                        <p> <strong class="text-black">253 MA</strong> Originally developed by Outokumpu, 253 MA combines
                            moderate <a href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel</a> content with
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/super-austenitic-stainless-steel/super-austenitic-stainless-steel-253-ma.blade.php ENDPATH**/ ?>