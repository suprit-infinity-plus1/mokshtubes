<?php $__env->startSection('title', '1045 Engineering Steel | High Strength Steel'); ?>
<?php $__env->startSection('meta_description', '1045 Engineering Steel offering superior strength, toughness, and wear resistance for
    mechanical, structural, and industrial applications.'); ?>
<?php $__env->startSection('meta_keywords', '1045 Engineering Steel, high strength carbon steel, medium carbon steel, mechanical steel,
    structural steel, durable steel, industrial steel'); ?>
<?php $__env->startSection('og_image', asset('assets/images/engineering-steels/engineering-steels-1045.webp')); ?>
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            such as pipes,
                            <a href="<?php echo e(route('products.pipes-tubes')); ?>"> tubes</a>, bars, plates, and fittings.
                        </p>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/engineering-steels/engineering-steels-1045.blade.php ENDPATH**/ ?>