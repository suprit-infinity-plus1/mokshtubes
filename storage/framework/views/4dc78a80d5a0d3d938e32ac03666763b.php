<?php $__env->startSection('title', 'Haynes Superalloys 230 - Strength & Oxidation Resistant'); ?>
<?php $__env->startSection('meta_description', 'Haynes Alloy 230 offers exceptional strength, oxidation resistance, and thermal stability for extreme industrial applications.'); ?>
<?php $__env->startSection('meta_keywords', 'Haynes Superalloys 230, Haynes Alloy 230, High Strength Haynes, Oxidation Resistant Haynes, Thermal Stability Alloy, Corrosion Resistant Haynes, Industrial Haynes Alloys, Chemical Processing Haynes, Power Industry Haynes, Aerospace Haynes Alloys, Marine Industry Haynes'); ?>
<?php $__env->startSection('og_image', asset('assets/images/haynes/haynes-230.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/haynes/haynes-230.webp')); ?>" alt="Haynes-230"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            exporter, importer, and stockist of a wide range of<strong class="text-black"> Haynes 230 (UNS
                                N06230) <a href="<?php echo e(route('products')); ?>">products</a></strong> including Pipes & Tubes,
                            ...
                            Channels, Welding Rods, Wire Mesh, and other custom and <a
                                href="<?php echo e(route('materials.hard-To-Find-Special-Alloys')); ?>">hard-to-find</a> Haynes 230
                            products.
                        </p>
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black"><a href="<?php echo e(route('materials.haynes-Superalloys')); ?>">Haynes
                                ...
                                href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel</a>-chromium-tungsten-molybdenum
                            alloy renowned for
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/haynes-superalloys/haynes-superalloys-230.blade.php ENDPATH**/ ?>