<?php $__env->startSection('title', 'Super Duplex 2205 Corrosion-Resistant Steel'); ?>
            ...
            <div class="col-md-6">
                <div class="pe-md-3">
                    ...
                    <p class="fs-6 text-justify" style="text-align: justify;">
                        2205 is widely used in industries where chloride stress corrosion resistance, strength, and durability are crucial. <a href="<?php echo e(route('index')); ?>">MOKSH TUBES & FITTINGS LLP</a> is a trusted supplier, exporter, importer, and stockist of Super Duplex 2205 products such as <a href="<?php echo e(route('products')); ?>">pipes, tubes, fittings, flanges, plates, and custom components</a>.
                    </p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/duplex-and-super-duplex/super-duplex-2205.blade.php ENDPATH**/ ?>