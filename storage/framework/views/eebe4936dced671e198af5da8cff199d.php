<?php $__env->startSection('title', 'Inconel 600 | Premium Heat & Corrosion Shield'); ?>
...
<?php $__env->startSection('og_image', asset('assets/images/inconel/inconel-600.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/inconel/inconel-600.webp')); ?>" alt="Inconel 600"
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            <a href="<?php echo e(route('products')); ?>">products</a>. We offer a wide range of forms including <a
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black">INCONEL 600</strong class="text-black"> is a <a
                                href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel</a>-chromium iron
                            <a href="<?php echo e(route('materials.hastelloy')); ?>">alloy</a> designed for service temperatures from
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <form id="leadForm" method="POST" action="<?php echo e(route('lead.capture')); ?>" class="mb-3">
                <?php echo csrf_field(); ?>
                <div class="row justify-content-center">
                    <input type="hidden" name="pdf" value="Inconel_600_data_sheet.pdf">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/inconel/inconel-600.blade.php ENDPATH**/ ?>