<?php $__env->startSection('title', 'About Us – Mokshtubes Fittings & LLP'); ?> <!-- 52 characters -->
<?php $__env->startSection('meta_description', 'Learn about Mokshtubes LLP, trusted manufacturer & exporter of stainless steel, Hastelloy, and Inconel products.'); ?> <!-- 152 characters -->
<?php $__env->startSection('meta_keywords', 'Mokshtubes, Metal Alloys Supplier, High Performance Alloys, Industrial Metal Solutions,
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    ...
                    <figure class="about-img h-100 m-0">
                        ...
                        <img src="<?php echo e(asset('assets/images/about/about-materials_11zon.webp')); ?>"
                            alt="about titan builders photo" class="img-fluid w-100 h-100 object-fit-cover custom-img">
                        ...
                        <div class="text">
                            ...
                            <p>
                                ...
                                stockists, and exporters of <strong class="text-black"><a
                                        href="<?php echo e(route('products.pipes-tubes')); ?>"> Pipes & Tubes</a>, Pipe Fittings,
                                    Flanges,
                                    Fasteners, Sheets
                                ...
                                diverse industrial sectors by offering a wide range of materials in <strong
                                    class="text-black">ferrous
                                    and
                                    non-ferrous grades, including Stainless Steel, Duplex & Super Duplex Steel,
                                    Nickel
                                    Alloys such as <a href="<?php echo e(route('materials.hastelloy')); ?>"> Hastelloy</a>,<a
                                        href="<?php echo e(route('materials.inconel')); ?>"> Inconel</a>,<a
                                        href="<?php echo e(route('materials.monel')); ?>"> Monel</a>, Titanium Alloys, Copper & Bronze
                                    Alloys,
        ...
        <div class="container vision-mission">
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-md-6 text-center">
                    <!-- Desktop Image -->
                    <img src="<?php echo e(asset('assets/images/history/our-mission.webp')); ?>" alt="Large"
                        class="img-fluid d-none d-lg-block">
                    <!-- Tablet Image 400x250-->
                    <img src="<?php echo e(asset('assets/images/history/our-mission.webp')); ?>" alt="Tablet"
                        class="img-fluid d-none d-md-block d-lg-none">
                    <!-- Mobile Image 300x200 -->
                    <img src="<?php echo e(asset('assets/images/history/our-mission.webp')); ?>" alt="Mobile"
            ...
            <div class="row align-items-center mb-5 flex-md-row-reverse">
                ...
                <div class="col-md-6 text-center">
                    ...
                    <img src="<?php echo e(asset('assets/images/history/our-goal.jpg')); ?>" alt="Large"
                        class="img-fluid d-none d-lg-block">
                    <!-- Tablet Image 400x250 -->
                    <img src="<?php echo e(asset('assets/images/history/our-goal.jpg')); ?>" alt="Tablet"
                        class="img-fluid d-none d-md-block d-lg-none">
                    <!-- Mobile Image 300x200 -->
                    <img src="<?php echo e(asset('assets/images/history/our-goal.jpg')); ?>" alt="Mobile"
                        class="img-fluid d-block d-md-none mx-auto">
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube-new\mokshtube\resources\views/frontend/about.blade.php ENDPATH**/ ?>