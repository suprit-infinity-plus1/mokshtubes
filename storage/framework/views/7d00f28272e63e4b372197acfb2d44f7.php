<?php $__env->startSection('title', 'Hastelloy B2 | Premium Acid-Resistant Nickel Alloy'); ?>
<?php $__env->startSection('meta_description', 'Hastelloy B2 pipes, tubes, and fittings deliver strong resistance to hydrochloric and reducing acids—ideal for chemical process industries.'); ?>
<?php $__env->startSection('meta_keywords', 'Hastelloy B2, acid resistant nickel alloy, corrosion resistant alloy, Hastelloy B2 pipes,
...
<?php $__env->startSection('og_image', asset('assets/images/hastelloy/hastelloy-b2.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/hastelloy/hastelloy-b2.webp')); ?>" alt="Hastelloy-b2"
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            Products. Including <a href="<?php echo e(route('products.pipes-tubes')); ?>">pipes & tubes</a>, fittings,
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black"><a href="<?php echo e(route('materials.hastelloy')); ?>">HASTELLOY B2</a></strong
                                class="text-black"> is a <a href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel
                                alloy
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/hastelloy/hastelloy-b2.blade.php ENDPATH**/ ?>