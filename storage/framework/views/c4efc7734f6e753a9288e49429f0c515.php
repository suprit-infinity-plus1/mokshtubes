<?php $__env->startSection('title', 'Titanium Grade 23 – Ti-6Al-4V ELI High Strength Alloy'); ?> <!-- 52 chars -->
<?php $__env->startSection('meta_description', 'Titanium Grade 23 (Ti-6Al-4V ELI) provides exceptional strength, low weight, and corrosion resistance for aerospace and medical applications.'); ?>
<?php $__env->startSection('meta_keywords', 'Titanium Grade 23, Ti-6Al-4V ELI, High Strength Titanium, Lightweight Titanium Alloy, Aerospace Titanium Alloys, Medical Titanium Alloys, Corrosion Resistant Titanium, Titanium Grade 23 Pipes, Titanium Grade 23 Tubes, Industrial Titanium Grades'); ?>
<?php $__env->startSection('og_image', asset('assets/images/titanium/titanium-23.webp')); ?>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-auto text-center">
                    <h1>Titanium Grade 23 <br> Ti-6Al-4V ELI High Strength Alloy</h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/titanium/titanium-23.webp')); ?>" alt="Titanium Grade 23"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            manufacturing, stocking, exporting, importing, and supplying of premium<strong
                                class="text-black"> <a href="<?php echo e(route('materials.titanium')); ?>">Titanium Grade 23</a>
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            ...
                            composition of 6% <a href="<?php echo e(route('materials.aluminium-Alloys')); ?>">Aluminum</a>, 4% Vanadium,
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/titanium/titanium-grade-23.blade.php ENDPATH**/ ?>