<?php $__env->startSection('title', 'Flat Bars – Stainless, Alloy, Aluminium & Brass'); ?> <!-- 52 characters -->
                ...
                <div class="col-md-6">
                    <p class="fs-6 mb-3 text-justify">
                        <strong class="text-black">Flat Bars</strong> are strong and versatile rectangular shaped <a
                            href="<?php echo e(route('products.bars-rods')); ?>">metal bars</a>
                        ...
                        flat bar, mild steel flat bar (MS flat bar), or stainless steel flat bar (SS flat bar) <a
                            href="<?php echo e(route('index')); ?>">Moksh Tubes
                    ...
                    <p class="fs-6 mb-3 text-justify">
                        ...
                        flat bar, brass flat bar, copper flat bar, and even specialty alloys like <a
                            href="<?php echo e(route('materials.titanium')); ?>">titanium</a> flat bar, nylon
                            ...
                            <tbody class="text-start">
                                <tr class="t-row">
                                    ...
                                    <td>Stainless Steel, Mild Steel, Alloy Steel, Duplex & Super Duplex, Aluminium, Brass,
                                        Copper, <a href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">Nickel
                                            Alloys</a></td>
                                </tr>
                                <tr class="t-row">
                                    <td>Thickness</td>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <ul>
                            <li>Copper <a href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel</a> and <a
                                    href="<?php echo e(route('materials.duplex-and-super-duplex')); ?>">duplex</a> flat bar rail, hull
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <ul>
                            <li><a href="<?php echo e(route('materials.aluminium-Alloys')); ?>">Aluminium</a> flat bar and titanium
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="accordion-box">
                            ...
                            <div class="accord-content">
                                <p>
                                    ...
                                    Where 7850 kg/m³ is the density of mild steel. A weight chart or <a
                                        href="<?php echo e(route('calculator')); ?>">calculator</a> can make
                                    this easier.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            <div class="accord-btn">
                                <h4>What <a href="<?php echo e(route('materials')); ?>">materials</a> are available for flat bars?
                                </h4>
                            </div>
                            <div class="accord-content">

                                Flat bars are available in <a
                                    href="<?php echo e(route('materials.high-strength-stainless-steel')); ?>">steel (SS)</a>, mild
                                steel (MS), alloy steel,
                                <a href="<?php echo e(route('materials.aluminium-Alloys')); ?>">aluminium</a>, <a
                                    href="<?php echo e(route('materials.copper-Alloys')); ?>">copper</a>,
                                brass, <a href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel alloys</a>,
                                and <a href="<?php echo e(route('materials.titanium')); ?>">titanium</a>. Grades comply with ASTM,
                                ASME, DIN, EN, and JIS
                                standards.
                                </p>
                            </div>
        ...
        <div class="container">
            <div class="contact-cta-box">
                ...
                <p>
                    ...
                    <strong class="text-white"><a href="<?php echo e(route('index')); ?>">Moksh Tubes & Fittings LLP</a></strong>
                </p>
                <!-- Call button -->
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube-new\mokshtube\resources\views/frontend/products/bars-rods/flat-bars.blade.php ENDPATH**/ ?>