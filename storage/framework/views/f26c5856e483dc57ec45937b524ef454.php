<?php $__env->startSection('title', 'Custom Steel Furniture – Modern, Durable & Stylish'); ?> <!-- 52 characters -->
...
<?php $__env->startSection('meta_keywords', 'Custom Steel Furniture, Steel Furniture Manufacturers, Stainless Steel Furniture, Durable Steel Furniture, Modern Steel Furniture Designs, Industrial Steel Furniture, Custom Steel Tables, Chairs, Racks, Cabinets, Steel Furniture for Home & Office'); ?>
<?php $__env->startSection('og_image', asset('assets/images/product/steel-furniture/custom-steel-furniture.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/product/steel-furniture/custom-steel-furniture.webp')); ?>"
                ...
                <div class="col-md-6">
                    ...
                    <p class="fs-6 mb-3 text-justify">
                        ...
                        and stone allows for endless design possibilities. <strong class="text-black"><a
                                href="<?php echo e(route('index')); ?>">Moksh Tubes & Fittings LLP</a></strong> brings decades of
                    ...
                    <p class="fs-6 text-justify">
                        ...
                        shelving units, our steel furniture is crafted with precision <a
                            href="<?php echo e(route('materials.engineering-Steels')); ?>">engineering</a> and premium <a
                            href="<?php echo e(route('materials')); ?>">grade
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/products/special-fabricated/custom-steel-furniture.blade.php ENDPATH**/ ?>