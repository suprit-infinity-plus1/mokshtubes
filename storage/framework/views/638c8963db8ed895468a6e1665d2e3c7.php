<?php $__env->startSection('title', 'Super Duplex Stainless Steel S32760 | Moksh Tubes LLP'); ?>
            ...
            <div class="col-md-6">
                <div class="pe-md-3">
                    ...
                    <p class="fs-6 text-justify" style="text-align: justify;">
                        <a href="<?php echo e(route('index')); ?>">MOKSH TUBES & FITTINGS LLP</a> is a trusted supplier, exporter, importer, and stockist of Super Duplex S32760 products such as <a href="<?php echo e(route('products')); ?>">pipes, tubes, fittings, flanges, plates, and custom components</a>, designed for use in the most aggressive environments including seawater, chemical processing, and offshore oil & gas applications.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="mx-auto" style="width: 100%; max-width: 300px;">
                        <a href="<?php echo e(route($product['route'])); ?>" class="text-decoration-none">
                            <div class="product-card h-100">
                                <img src="<?php echo e(asset($product['image'])); ?>" alt="<?php echo e($product['name']); ?>" class="img-fluid  w-100">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/duplex-and-super-duplex/super-duplex-s32760.blade.php ENDPATH**/ ?>