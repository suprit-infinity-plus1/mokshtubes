<?php $__env->startSection('title', 'Round Bars – SS, MS, Alloy, Copper & Brass'); ?> <!-- 52 characters -->
<?php $__env->startSection('meta_description', 'Mokshtubes supplies high quality stainless steel, MS, alloy, copper, brass, nickel &
    aluminium round bars in various sizes, grades & weight chart.'); ?> <!-- 153 characters -->
<?php $__env->startSection('meta_keywords', 'Round Bars, Stainless Steel Round Bars, MS Round Bars, Alloy Round Bars, Copper Round Bars,
    Brass Round Bars, Nickel Round Bars, Aluminium Round Bars'); ?>
    <?php $__env->startSection('og_title', 'Round Bars – SS, MS, Alloy, Copper & Brass'); ?>
<?php $__env->startSection('og_image', asset('assets/images/product/Bars-&-Rods/round-bars.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/product/Bars-&-Rods/round-bars.webp')); ?>" alt="Round Bars"
                ...
                <div class="col-md-6">
                    <p class="fs-6 mb-3 text-justify">
                        ...
                        automotive, aerospace, marine, and engineering sectors. Available in different <a
                            href="<?php echo e(route('materials')); ?>">materials</a>, sizes, and
                        finishes, steel round bars are one of the most versatile raw <a
                            href="<?php echo e(route('materials')); ?>">materials</a> for machining, fabrication,
                        and structural applications.
                    </p>
                    <p class="fs-6 mb-3 text-justify">
                        <a href="<?php echo e(route('index')); ?>">Moksh Tubes & Fittings LLP</a>, we provide premium quality stainless
                        ...
                        <a href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel alloy</a> round bars, <a
                            href="<?php echo e(route('materials.titanium')); ?>">titanium</a> round bars, aluminium round bars, brass
                        round bars, and <a href="<?php echo e(route('materials.copper-Alloys')); ?>">copper</a>
                        round bars. All our plain round bars and bright steel round bars are manufactured as per ASTM, ASME,
                        DIN, <a href="<?php echo e(route('materials.engineering-Steels')); ?>">EN</a>, and JIS standards, ensuring
                        ...
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody>
                                <tr class="t-row">
                                    ...
                                    <td>
                                        <a
                                            href="<?php echo e(url('materials/austenitic-stainless-steel/austenitic-stainless-steel-304')); ?>">304
                                            stainless steel</a> round bar, <a
                                            href="<?php echo e(url('materials/austenitic-stainless-steel/austenitic-stainless-steel-310')); ?>">310
                                ...
                                <tr class="t-row">
                                    ...
                                    <td>
                                        ASTM A36, <a
                                            href="<?php echo e(url('materials/engineering-steels/engineering-steels-en8')); ?>">EN8</a>
                                        SS round bar, N8 SS round bar, <a
                                            href="<?php echo e(url('materials/engineering-steels/engineering-steels-en9')); ?>">EN9</a>,
                                        IS2062 <br>
                                        <small>(Widely used in structural, <a
                                                href="<?php echo e(route('materials.engineering-Steels')); ?>">engineering</a> &
                                ...
                                <tr class="t-row">
                                    ...
                                    <td>
                                        EN19, EN24, <a
                                            href="<?php echo e(url('materials/engineering-steels/engineering-steels-en31')); ?>">EN31</a>,
                                        4140, <a
                                            href="<?php echo e(url('materials/engineering-steels/engineering-steels-4130')); ?>">4130</a>
                                        <br>
                                        <small>(Ideal for heavy duty & <a
                                                href="<?php echo e(route('materials.high-strength-stainless-steel')); ?>">high
                                ...
                                <tr class="t-row">
                                    ...
                                    <td>
                                        ...
                                        bar, Monel 400 round bar, Waspaloy round bar, <a
                                            href="<?php echo e(url('materials/inconel/inconel-718')); ?>">718 Inconel</a> round bar
                                        suppliers <br>
                            ...
                            <div class="accord-content">
                                <p>
                                    Mokshtubes offers high precision, wide variety of <a
                                        href="<?php echo e(route('materials')); ?>">materials</a> and grades, multiple
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/products/bars-rods/round-bars.blade.php ENDPATH**/ ?>