<?php $__env->startSection('title', 'Hollow Bars – Stainless, Alloy & MS Mokshtubes'); ?> <!-- 53 characters -->
<?php $__env->startSection('meta_description', 'Mokshtubes supplies high-quality stainless steel, MS, alloy, aluminium & bronze hollow
    bars in custom sizes, grades & worldwide delivery.'); ?> <!-- 153 characters -->
<?php $__env->startSection('meta_keywords', 'Hollow Bars, Stainless Hollow Bars, Alloy Hollow Bars, MS Hollow Bars, Aluminium Hollow Bars,
    Bronze Hollow Bars'); ?>
    <?php $__env->startSection('og_image', asset('assets/images/product/Hollow-Bars.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/product/Hollow-Bars.webp')); ?>"
                ...
                <div class="col-md-6">
                    <p class="fs-6 mb-3 text-justify">
                        <strong class="text-black">Hollow Bars</strong> are tubular metal <a
                            href="<?php echo e(route('products.bars-rods')); ?>">bars</a> with a hollow center,
                        offering a <a href="<?php echo e(route('materials.high-strength-stainless-steel')); ?>">high strength</a> to
                    ...
                    <p class="fs-6 mb-3 text-justify">
                        ...
                        hollow bars, <a href="<?php echo e(route('materials.aluminium-Alloys')); ?>">aluminium</a> hollow <a
                            href="<?php echo e(url('products/bars-rods/square-bars')); ?>">square bars</a>, bronze hollow bars, and <a
                            href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel</a> hollow bars. We also offer
                        hollow square bars, extruded hollow bars, and oil filled hollow bars for specialized applications.
                        All <a href="<?php echo e(route('products')); ?>">products</a> conform to ASTM, ASME, DIN, EN, and JIS
                        standards.
                    </p>
                </div>
            </div>
                            ...
                            <tbody class="text-start">
                                ...
                                <tr class="t-row">
                                    ...
                                    <td>Seamless Hollow Bars, <a
                                            href="<?php echo e(route('products.pipes-tubes.welded-pipes')); ?>">Welded</a> Hollow Bars
                                    </td>
                                </tr>
                                <tr class="t-row">
                                    <td>Finishes</td>
                            ...
                            <tbody>
                                <tr class="t-row">
                                    ...
                                    <td><a
                                        ...
                                        304L, 316, 316L, <a
                                            href="<?php echo e(url('frontend/materials/austenitic-stainless-steel/austenitic-stainless-steel-310')); ?>">310</a>,
                                        321, <a
                                            href="<?php echo e(url('frontend/materials/austenitic-stainless-steel/austenitic-stainless-steel-347')); ?>">347</a>
                                        <br>
                                ...
                                <tr class="t-row">
                                    <td>Alloy Steel</td>
                                    <td><a
                                            href="<?php echo e(url('materials/engineering-steels/engineering-steels-4140')); ?>">4140</a>,
                                        4130, EN19, <a
                                            href="<?php echo e(url('materials/engineering-steels/engineering-steels-en24')); ?>">EN24</a>
                                        <br>
                                ...
                                <tr class="t-row">
                                    <td>Nickel Alloys</td>
                                    <td>Inconel, <a href="<?php echo e(route('materials.monel')); ?>">Monel</a>, Hastelloy <br>
                                        <small>(High temperature & corrosive environments)</small>
                                    </td>
                                </tr>
                                <tr class="t-row">
                                    <td>Titanium</td>
                                    <td>Grades 2, <a href="<?php echo e(url('materials/titanium/titanium-grade-5')); ?>">5</a> <br>
                                        <small>(Aerospace, desalination & chemical industries)</small>
                                    </td>
                                </tr>
                                <tr class="t-row">
                                    <td>Copper Alloys</td>
                                    <td><a href="<?php echo e(url('materials/copper-alloys/copper-alloys-cu-ni-70-30')); ?>">Cu-Ni
                            ...
                            <div class="accord-content">
                                <p>
                                    Stainless steel, MS, 4140, aluminium hollow <a
                                        href="<?php echo e(url('products/bars-rods/square-bars')); ?>">square bars</a>, bronze, and
                                    nickel hollow bars.
                                </p>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/products/bars-rods/hollow-bars.blade.php ENDPATH**/ ?>