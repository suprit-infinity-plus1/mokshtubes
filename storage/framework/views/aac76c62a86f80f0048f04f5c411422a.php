<?php $__env->startSection('title', 'Stainless Steel 431 | Mokshtubes Precision Alloy Supplier'); ?>
<?php $__env->startSection('meta_description', 'Stainless Steel 431 – high-quality, corrosion-resistant, hard, and tough for aerospace, tooling, and engineering applications.'); ?>
<?php $__env->startSection('meta_keywords', 'Stainless Steel 431, Alloy 431, UNS S43100, High-Strength Martensitic Stainless Steel, SS 431 Pipes, SS 431 Tubes, SS 431 Sheets, SS 431 Plates, SS 431 Coils, SS 431 Flanges, SS 431 Fasteners, SS 431 Bars, SS 431 Rods, SS 431 Components'); ?>
<?php $__env->startSection('og_image', asset('assets/images/high-strength-stainless-steel/Stainless-Steel-431.webp')); ?>
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 mb-4 mb-md-0">
                <img src="<?php echo e(asset('assets/images/high-strength-stainless-steel/Stainless-Steel-431.webp')); ?>" alt="Stainless Steel 431"
...
<section class="sec-padd-top sec-padd-bottom">
    <div class="container">
        <div class="section-title center">
            <h2>Stainless Steel 431 Chemical Composition</h2>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped align-middle">
                        ...
                        <tbody class="text-center">
                            <tr><td>Carbon (C)</td><td>0.20 max</td></tr>
                            <tr><td>Chromium (Cr)</td><td>15.0 – 17.0</td></tr>
                            <tr><td>Nickel (Ni)</td><td>1.25 – 2.50</td></tr>
                            <tr><td>Manganese (Mn)</td><td>1.00 max</td></tr>
                            <tr><td>Silicon (Si)</td><td>1.00 max</td></tr>
                            <tr><td>Phosphorus (P)</td><td>0.040 max</td></tr>
                            <tr><td>Sulfur (S)</td><td>0.030 max</td></tr>
                            <tr><td>Iron (Fe)</td><td>Balance</td></tr>
                        </tbody>
                    </table>
                    <p class="fs-6 text-center mt-3">
                        The combination of chromium and nickel provides exceptional corrosion resistance,
                        while controlled carbon content ensures good toughness and hardness after heat treatment.
                    </p>
                </div>
            </div>
        </div>
...
<section class="sec-padd-top sec-padd-bottom bg-light">
    <div class="container">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped align-middle">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr><td>Melting Point</td><td>1450°C</td></tr>
                            <tr><td>Modulus of Elasticity</td><td>200 GPa</td></tr>
                            <tr><td>Thermal Conductivity</td><td>25 W/m·K</td></tr>
                            <tr><td>Electrical Resistivity</td><td>0.60 μΩ·m</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <h4 class="text-center mb-3" style="color: #db7227;">Mechanical Properties of Stainless Steel 431</h4>
                <div class="table-responsive">
                    <table class="table table-bordered table-striped align-middle">
                        <thead class="table-dark text-center">
                        ...
                        <tbody class="text-center">
                            <tr><td>Tensile Strength</td><td>850 – 1000 MPa</td><td>123,000 – 145,000 psi</td></tr>
                            <tr><td>Yield Strength (0.2% Offset)</td><td>600 – 800 MPa</td><td>87,000 – 116,000 psi</td></tr>
                            <tr><td>Elongation at Break</td><td>18 – 22%</td><td>18 – 22%</td></tr>
                            <tr><td>Hardness (Brinell)</td><td>230 – 300 HB</td><td>230 – 300 HB</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="application-card">
                    ...
                    <p>Used in aircraft fittings, landing gear components, shafts, and fasteners requiring high tensile strength and toughness.</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="application-card">
                    ...
                    <p>Ideal for propeller shafts, pump shafts, and marine fasteners with resistance to seawater corrosion.</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="application-card">
                    ...
                    <p>Used for reactors, valves, pumps, and components exposed to mildly corrosive media and chemical solutions.</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="application-card">
                    ...
                    <p>Widely used in axles, drive shafts, and components exposed to vibration, stress, and moderate corrosion.</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="application-card">
                    ...
                    <p>Applications include valve parts, pump impellers, and structural elements exposed to drilling environments.</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="application-card">
                    ...
                    <p>Ideal for heavy-duty components and fasteners requiring superior strength under extreme stress conditions.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="accordion-box">
                    ...
                    <div class="accordion accordion-block">
                        <div class="accord-btn"><h4>1. What is Stainless Steel 431 used for?</h4></div>
                        <div class="accord-content">
                            <p>
                                Stainless Steel 431 is widely used in aerospace, marine, oil & gas, and automotive applications where strength, toughness, and corrosion resistance are required.
                            </p>
                        </div>
                    </div>
                    ...
                    <!-- Q2 -->
                    <div class="accordion accordion-block">
                        <div class="accord-btn"><h4>2. Is Stainless Steel 431 magnetic?</h4></div>
                        <div class="accord-content">
                            <p>
                                Yes. Being a martensitic stainless steel, it is magnetic both in annealed and hardened conditions.
                            </p>
                        </div>
                    </div>
                    ...
                    <!-- Q3 -->
                    <div class="accordion accordion-block">
                        <div class="accord-btn"><h4>3. Can Stainless Steel 431 be welded?</h4></div>
                        <div class="accord-content">
                            <p>
                                Welding is possible, but preheating and post-weld heat treatment are recommended to minimize cracking and maintain mechanical strength.
                            </p>
                        </div>
                    </div>
                    ...
                    <!-- Q4 -->
                    <div class="accordion accordion-block">
                        <div class="accord-btn"><h4>4. How does Stainless Steel 431 compare with 304 or 316?</h4></div>
                        <div class="accord-content">
                            <p>
                                Stainless Steel 431 has higher hardness and tensile strength than 304 or 316 but slightly lower corrosion resistance, making it suitable for mechanical and structural use.
                            </p>
                        </div>
                    </div>
                    ...
                    <!-- Q5 -->
                    <div class="accordion accordion-block">
                        <div class="accord-btn"><h4>5. What products are available in Stainless Steel 431 at MOKSH TUBES?</h4></div>
                        <div class="accord-content">
                            <p>
                                MOKSH TUBES & FITTINGS LLP supplies SS 431 in pipes, tubes, sheets, plates, coils, flanges, fittings, fasteners, bars, rods, and customized components engineered for precision projects.
                            </p>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/high-strength-stainless-steel/stainless-steel-431.blade.php ENDPATH**/ ?>