<?php $__env->startSection('title', 'Zirconium 705 | High-Performance Zirconium Alloy'); ?>
...
<?php $__env->startSection('meta_keywords',
    ...
    Zirconium'); ?>
<?php $__env->startSection('og_image', asset('assets/images/zirconium/zirconium-705.webp')); ?>
    ...
    <section class="sec-padd-top sec-padd-bottom bg-light">
        <div class="container">
            ...
            <h2 class="fw-semibold text-center mb-5" style="color: #db7227;">
                Introduction To Zirconium 705 / UNS R60705
            </h2>

            <div class="row align-items-center">
                <!-- Image Left -->
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/zirconium/zirconium-705.webp')); ?>" alt="Zirconium 705"
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            <strong class="text-black"> MOKSH TUBES & FITTINGS LLP</strong> we specialize in manufacturing,
                            supplying, exporting, importing, and stocking a wide range of<strong class="text-black">
                                Zirconium 705 (UNS R60705)
                                <a href="<?php echo e(route('products')); ?>">products</a></strong>. Our comprehensive lineup includes
                            Pipes & Tubes, Fittings, Flanges, Fasteners, Sheets,
                            Plates, Coils, Wires, Bars, Welding Rods, and custom-built components—made for performance in
                            demanding environments.
                        </p>

                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black"><a href="<?php echo e(route('materials.zirconium')); ?>">Zirconium
                                    705</a></strong> is a high-purity zirconium alloy noted for its remarkable resistance to
                            strong acids, alkalis, and hot water environments. It combines excellent ductility, weldability,
                            and mechanical strength, making it ideal for applications where corrosion resistance and
            ...
            <div class="row justify-content-center mb-3">
                <div class="col-lg-10">
                    <p class="fw-bold fs-5 text-center my-4" style="color: #174268;">
                        Zirconium 705 products are produced to the following global standards:
                    </p>
                </div>
            </div>
            ...
            <div class="row g-4 mt-4 justify-content-center">
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h5>Superior Corrosion Resistance – Stunning performance in acid and caustic environments</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h5>High Strength + Flexibility – Outstanding mechanical properties at room and moderate heat</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h5>Highly Fabricable – Easily welded, formed, and machined</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h5>Ultra‑Clean Purity – Ideal for pharmaceutical, semiconductor, and biotech systems</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h5>Non‑Magnetic & Biocompatible – Great for medical and cleanroom processes</h5>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        <div class="advantage-icon"><i class="bi bi-shield-check"></i></div>
                        <h5>Low Neutron Cross‑Section – Preferred in nuclear applications</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>Nuclear Energy</h5>
                        <p>Fuel cladding, control-rod sleeves, cooling channels, and structural reactor components.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>Marine & Desalination</h5>
                        <p>Seawater cooling lines, desalination plant hardware, and anti-corrosion marine structures.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>Medical & Healthcare</h5>
                        <p>Implants, surgical instruments, sterilization vessels—biocompatible and corrosion-proof.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>Semiconductor Manufacturing</h5>
                        <p>Ultra-pure wet-chemistry lines and chemical delivery systems.</p>
                    </div>
                </div>
            ...
            <div class="row g-4 mt-4">
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>Specialists in Pure Zirconium Alloys</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>Access to Prime-Quality Raw Materials</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>Precision Fabrication to ASTM/ASME Specs</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="why-banner-block">
                        ...
                        <h5>Custom Solutions to Match Project Needs</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="why-banner-block">
                        ...
                        <h5>Consistent Quality & Assured Traceability</h5>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/zirconium/zirconium-705.blade.php ENDPATH**/ ?>