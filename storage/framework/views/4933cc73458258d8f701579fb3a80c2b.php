<?php $__env->startSection('title', 'Austenitic Stainless Steel 321 | Heat Resistant Alloy'); ?>
<?php $__env->startSection('meta_description', 'Austenitic Stainless Steel 321 – stabilized alloy designed for high-temperature applications offering excellent oxidation resistance and durability.'); ?>
...
<?php $__env->startSection('og_image', asset('assets/images/austenitic-stainless-steel/austenitic-stainless-steel-321.webp')); ?>
<?php $__env->startSection('og_type', 'article'); ?>

<?php $__env->startSection('content'); ?>

    <!--Start breadcrumb area-->
    <section class="breadcrumb-area" style="background-image: url(/assets/images/austenitic-stainless-steel/austenitic-stainless-steel-321.webp);">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/austenitic-stainless-steel/austenitic-stainless-steel-321.webp')); ?>"alt="Austenitic Stainless Steel 321"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            of<strong class="text-black"> Stainless Steel 321 <a
                                    href="<?php echo e(route('products')); ?>">products</a></strong>, including pipes, tubes, sheets,
                            plates, bars, fittings, and
                            flanges.

                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black">Austenitic Stainless Steel 317</strong>, is a titanium-stabilized
                            <a href="<?php echo e(route('materials.austenitic-stainless-Steel')); ?>">austenitic stainless steel</a>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/austenitic-stainless-steel/austenitic-stainless-steel-321.blade.php ENDPATH**/ ?>