<?php $__env->startSection('title', 'Nimonic Alloys | High-Temp Strength & Durability'); ?>
<?php $__env->startSection('meta_description', 'Nimonic alloys – high-temperature, creep-resistant, and durable for aerospace, turbines,
    power generation, and extreme industrial environments.'); ?>
<?php $__env->startSection('meta_keywords', 'Nimonic alloy, high temperature alloy, creep resistant alloy, aerospace alloy, turbine alloy,
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/hard-to-find-and-special-alloys/hard-to-find-and-special-alloys-nimonic.webp')); ?>"
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        ...
                        <p> <strong class="text-black"><a
                                    href="<?php echo e(route('materials.hard-To-Find-Special-Alloys')); ?>">Nimonic
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/hard-to-find-special-alloys/hard-to-find-special-alloys-nimonic.blade.php ENDPATH**/ ?>