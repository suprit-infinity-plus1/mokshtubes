<?php $__env->startSection('title', 'Stainless Steel 440B | Precision Bars & Rods Supplier'); ?>
<?php $__env->startSection('meta_description', 'Premium 440B Stainless Steel bars & rods offering high strength, wear resistance & polish finish for industrial, tooling & engineering applications.'); ?>
<?php $__env->startSection('meta_keywords', '440B Stainless Steel, UNS S44004, AISI 440B, High Carbon Martensitic Stainless Steel, Corrosion Resistant Stainless Steel, High Strength Stainless Steel, Wear Resistant Alloy, Industrial Stainless Steel Supplier, Engineering Grade Stainless Steel, Tooling Stainless Steel'); ?>
<?php $__env->startSection('og_image', asset('assets/images/high-strength-stainless-steel/440B-Stainless-Steel.webp')); ?>
<?php $__env->startSection('og_type', 'article'); ?>
<?php $__env->startSection('content'); ?>

    <!--Start breadcrumb area-->
    <section class="breadcrumb-area" style="background-image: url(/assets/images/high-strength-stainless-steel/440B-Stainless-Steel.webp);">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/high-strength-stainless-steel/440B-Stainless-Steel.webp')); ?>" alt="Hastelloy C276"
                ...
                <p class="fs-6" style="text-align: justify;">
                    <a href="<?php echo e(route('index')); ?>"><strong class="text-black">MOKSH TUBES & FITTINGS LLP</strong></a> is a trusted supplier, exporter, importer, and stockist of stainless 440B <a href="<?php echo e(route('products')); ?>">products</a>, including pipes, tubes, fittings, flanges, fasteners, sheets, plates, coils, wires, bars, and custom machined parts, produced to international standards for performance and reliability.
                </p>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/high-strength-stainless-steel/440b-stainless-steel.blade.php ENDPATH**/ ?>