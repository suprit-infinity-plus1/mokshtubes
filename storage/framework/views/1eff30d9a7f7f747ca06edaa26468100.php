<?php $__env->startSection('title', 'Copper Alloy C46400 | High Strength & Durability'); ?>

<?php $__env->startSection('meta_description', 'Copper Alloy C46400 is a high-strength, durable copper alloy offering excellent corrosion
    resistance for aerospace, marine, and industrial uses.'); ?>

<?php $__env->startSection('meta_keywords', 'Copper Alloy C46400, high strength copper alloy, aerospace copper alloy, marine copper alloy,
    industrial copper alloy, durable copper alloy'); ?>
<?php $__env->startSection('og_image', asset('assets/images/copper-alloys/copper-alloys-c46400.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/copper-alloys/copper-alloys-c46400.webp')); ?>"alt="Copper Alloys C46400"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, and stockist of<strong class="tect-black"> C46400 Naval Brass
                                <a href="<?php echo e(route('products')); ?>"> products</a></strong>, including Pipes, Tubes, Rods,
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <form id="leadForm" method="POST" action="https://mokshtubes.com/datasheet-leads-capture" class="mb-3">
                ...
                <div class="row justify-content-center">
                    <input type="hidden" name="pdf" value="copper-alloy-C46400.pdf">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/copper-alloys/copper-alloys-c46400.blade.php ENDPATH**/ ?>