...
<?php $__env->startSection('meta_keywords',
    ...
    <?php $__env->startSection('og_image', asset('assets/images/product/Hexagon-Bars.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/product/Hexagon-Bars.webp')); ?>"
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <ul>
                            <li>Stainless & <a href="<?php echo e(route('materials.duplex-and-super-duplex')); ?>">duplex</a> hex bars
                                for corrosion resistance, <a href="<?php echo e(route('materials.copper-Alloys')); ?>">copper</a> <a
                                    href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel</a> for seawater</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <ul>
                            <li>Aluminium hex bar & <a href="<?php echo e(route('materials.titanium')); ?>">titanium</a> hex bars for
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h5>Stainless, <a href="<?php echo e(route('materials.duplex-and-super-duplex')); ?>">Duplex</a>, Nickel,
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-sm-12 col-lg-6">
                    <div class="why-banner-block">
                        ...
                        <h5><a href="<?php echo e(url('products/special-fabricated/custom-steel-furniture')); ?>">Custom</a> machining
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/products/bars-rods/hexagon-bars.blade.php ENDPATH**/ ?>