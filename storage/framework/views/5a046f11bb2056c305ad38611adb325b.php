<?php $__env->startSection('title', 'Titanium Grade 4 – High Strength Titanium Alloy'); ?> <!-- 52 chars -->
<?php $__env->startSection('meta_description', 'Titanium Grade 4 offers high strength and excellent corrosion resistance, ideal for aerospace, marine, and chemical industry applications.'); ?>
<?php $__env->startSection('meta_keywords', 'Titanium Grade 4, High Strength Titanium, Corrosion Resistant Titanium, Titanium Grade 4 Pipes, Titanium Grade 4 Tubes, Titanium Grade 4 Sheets, Aerospace Titanium Alloys, Marine Industry Titanium, Chemical Processing Titanium, Industrial Titanium Grades'); ?>
<?php $__env->startSection('og_image', asset('assets/images/material/titanium-grade4.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/material/titanium-grade4.webp')); ?>" alt="Titanium Grade 4"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, importer, and stockist of a wide range of<strong class="text-black">
                                Titanium Grade 4 <a href="<?php echo e(route('products')); ?>">products</a></strong>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/titanium/titanium-grade-4.blade.php ENDPATH**/ ?>