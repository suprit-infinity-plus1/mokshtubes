<?php $__env->startSection('title', '4140 Alloy Steel | High Strength Engineering Steel'); ?>
<?php $__env->startSection('meta_description', '4140 Alloy Steel offering excellent strength, hardness, and wear resistance for engineering and industrial applications.'); ?>
<?php $__env->startSection('meta_keywords', '4140 Alloy Steel, versatile alloy steel, high strength steel, wear resistant steel, hardenable steel, industrial alloy steel, engineering steel'); ?>

<?php $__env->startSection('og_image', asset('assets/images/engineering-steels/engineering-steels-4140.webp')); ?>
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, importer, and stockist of<strong class="text-black"> EN 4140 steel
                                products</strong> including<a href="<?php echo e(route('products.pipes-tubes')); ?>"> pipes</a>, tubes,
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            ...
                            <a href="<?php echo e(route('materials.engineering-Steels')); ?>"> EN 4140</a> can be heat-treated to
