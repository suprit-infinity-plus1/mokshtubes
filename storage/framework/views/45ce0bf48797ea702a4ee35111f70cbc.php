<?php $__env->startSection('title', 'Nickel Superalloys – Extreme Strength & Corrosion'); ?> <!-- 53 chars -->
<?php $__env->startSection('meta_description', 'Explore nickel-based superalloys from Moksh Tubes built for extreme temperatures and harsh conditions with superior corrosion resistance and strength.'); ?>
<?php $__env->startSection('meta_keywords', 'Nickel Superalloys, Nickel 200, Nickel 201, A286, High-Temperature Alloys, Corrosion Resistant Alloys, Nickel-Based Alloys, Extreme Temperature Alloys, High Strength Alloys, Industrial Superalloys'); ?>

<?php $__env->startSection('content'); ?>
    <!--Start breadcrumb area-->
    <section class="breadcrumb-area" style="background-image: url(/assets/images/nickel-based-superalloys/nickel-based-alloys-banner.webp);">
        <div class="container">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/nickel-based-superalloys/index.blade.php ENDPATH**/ ?>