<?php $__env->startSection('title', 'AL-6XN – Superior Corrosion Resistant Alloy'); ?> <!-- 52 chars -->
<?php $__env->startSection('meta_description', 'AL-6XN pipes, tubes, and fittings offer exceptional corrosion resistance in seawater, chemical, and food processing environments.'); ?>
<?php $__env->startSection('meta_keywords', 'AL-6XN, Corrosion Resistant Alloy, AL-6XN Pipes, AL-6XN Tubes, AL-6XN Fittings, Seawater Resistant Alloy, Chemical Processing Alloys, Food Processing Alloys, High Strength Stainless Steel, Industrial Corrosion Resistant Alloys'); ?>
<?php $__env->startSection('og_image', asset('assets/images/super-austenitic-stainless-steel/super-austenitic-stainless-steel-AL-6XN.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/super-austenitic-stainless-steel/super-austenitic-stainless-steel-AL-6XN.webp')); ?>"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, importer, and stockist of<strong class="text-black"> AL 6XN Alloy (UNS
                                N08367) <a href="<?php echo e(route('products')); ?>">products</a></strong> including
                            <a href="<?php echo e(route('products.pipes-tubes')); ?>">Pipes & Tubes</a>, Pipe Fittings, Flanges, Sheets
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            ...
                            (6.3%), and <a href="<?php echo e(route('materials.hard-To-Find-Special-Alloys')); ?>">nitrogen</a>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/super-austenitic-stainless-steel/super-austenitic-stainless-steel-al-6xn.blade.php ENDPATH**/ ?>