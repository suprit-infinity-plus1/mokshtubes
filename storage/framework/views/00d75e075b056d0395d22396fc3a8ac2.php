...
<?php $__env->startSection('meta_description', 'Premium industrial fasteners from Mokshtubes — bolts, nuts, screws & washers in stainless
    steel, alloy, titanium & nickel for marine & industrial use.'); ?> <!-- 153 characters -->
<?php $__env->startSection('meta_keywords', 'Industrial Fasteners, Bolts, Nuts, Screws, Washers, Studs, Anchors, Stainless Steel
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/peoduct/flangs/FASTENERS.jpeg')); ?>" alt="Custom-Fabricated-Fittings"
                ...
                <div class="col-md-6">
                    ...
                    <p class="fs-6 mb-3 text-justify">
                        ...
                        steel, carbon steel, alloy steel, titanium, nickel alloys, and copper alloys.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody>
                                ...
                                <tr class="t-row">
                                    <td>Nickel Alloys</td>
                                    <td>Inconel 600/625/718, Monel 400/K500, Hastelloy C22/C276 – for extreme heat and
                                        corrosive conditions.</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Titanium</td>
                                    <td>Grades 2, 5 (Ti-6Al-4V) – lightweight and strong for aerospace and medical use.</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Copper Alloys</td>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <ul>
                            <li>High-strength bolts for pipeline flanges, valves, and pressure vessels</li>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <ul>
                            ...
                            <li>Titanium and nickel fasteners for aircraft, satellites, and racing vehicles</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h4>Wide Range</h4>
                        <h5>Standard, metric, and custom fasteners available</h5>
                    </div>
                </div>
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>Material Expertise: Stainless, Duplex, Nickel Alloys, Titanium, Copper Alloys</h5>
                    </div>
                </div>
                    ...
                    <div class="accordion-box">
                        ...
                        <div class="accordion accordion-block">
                            <div class="accord-btn">
                                <h4>What types of fasteners are available from Moksh Tubes & Fittings LLP?</h4>
                            </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube-new\mokshtube\resources\views/frontend/products/pipe-fittings-flanges-fasteners/fasteners.blade.php ENDPATH**/ ?>