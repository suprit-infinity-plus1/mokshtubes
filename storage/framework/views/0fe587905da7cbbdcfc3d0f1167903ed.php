<?php $__env->startSection('title', 'Aluminium Alloys: 6082, 6061, 5083, HE30 | MokshTubes'); ?>
<?php $__env->startSection('meta_description', 'Lightweight, corrosion-resistant aluminium alloys at MokshTubes — 6082, 6061, 5083 & HE30, ideal for aerospace, marine, and structural uses'); ?>
<?php $__env->startSection('meta_keywords', 'Aluminium Alloys, 6082, 6061, 5083, HE30, 7075, Aluminium 6082-T6, Aluminium 6061-T6,
...
<?php $__env->startSection('og_image', asset('assets/images/aluminium-alloys/aluminium-banner.jpeg')); ?>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <a href="<?php echo e($href); ?>" class="text-decoration-none d-block h-100">
                    <div class="grade-card border rounded shadow-sm p-3 text-center h-100 transition" style="border-color: #db7227; transition: 0.3s;">
                        ...
                        <img src="<?php echo e(asset($grade['image'])); ?>" alt="<?php echo e($grade['name']); ?>" class="img-fluid rounded mb-3" style="border-radius: 8px;">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/aluminium-alloys/index.blade.php ENDPATH**/ ?>