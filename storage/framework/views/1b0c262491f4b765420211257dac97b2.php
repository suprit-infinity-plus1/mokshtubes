<?php $__env->startSection('title', 'Industrial Sheets & Plates – Premium Metal Solutions'); ?> <!-- 52 characters -->
<?php $__env->startSection('meta_description',
    'High-quality stainless, carbon, and alloy steel sheets & plates – durable, reliable, and
    ideal for manufacturing, construction, and industrial applications.'); ?> <!-- 153 characters -->
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/peoduct/Sheets, Plates and Coils/Sheets-and-Plates.jpg')); ?>"
                ...
                <div class="col-md-6">
                    <p class="fs-6 mb-3 text-justify">
                        ...
                        <a href="<?php echo e(route('materials.engineering-Steels')); ?>">engineering</a> industries. The main
                        ...
                        6 mm thick, while plates are 6 mm and above, designed for structural <a
                            href="<?php echo e(route('materials.high-strength-stainless-steel')); ?>">strength</a> and durability.
                    </p>

                    <p class="fs-6 mb-3 text-justify">
                        <a href="<?php echo e(route('index')); ?>">Moksh Tubes & Fittings LLP</a> supplies high quality metal sheets
                        & plates in a wide variety of
                        <a href="<?php echo e(route('materials')); ?>">materials</a>, finishes, and sizes, sourced and manufactured to
                        ASTM, ASME, EN, JIS, and DIN
                        standards. Our <a href="<?php echo e(route('products.sheets-plates-coils')); ?>">sheets</a> & plates are
                        ...
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody>
                                ...
                                <tr class="t-row">
                                    <td>Nickel Alloys</td>
                                    <td>
                                        Inconel, Monel, <a href="<?php echo e(route('materials.hastelloy')); ?>">Hastelloy</a> – for
                                ...
                                <tr class="t-row">
                                    <td>Aluminum</td>
                                    <td>
                                        <a href="<?php echo e(route('materials.aluminium-Alloys')); ?>">1100, 5052, 6061, 6082</a> –
                                ...
                                <tr class="t-row">
                                    <td>Titanium</td>
                                    <td>
                                        <a href="<?php echo e(route('materials.titanium')); ?>">Grades 1, 2, 5</a> – for aerospace,
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h4><a href="<?php echo e(url('products/sheets-plates-coils/chequered-sheets')); ?>">Chequered</a> Plates</h4>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h4>Provides structural strength in heavy <a
                                href="<?php echo e(route('materials.engineering-Steels')); ?>">engineering</a> projects</h4>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-lg-6">
                    <div class="advantage-card">
                        ...
                        <h4>Essential for pressure retaining equipment like <a
                                href="<?php echo e(url('products/pipes-tubes/boiler-heat-exchanger-tubes')); ?>">boilers</a> and tanks
                        </h4>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube-new\mokshtube\resources\views/frontend/products/sheets-plates-coils/sheets-and-plates.blade.php ENDPATH**/ ?>