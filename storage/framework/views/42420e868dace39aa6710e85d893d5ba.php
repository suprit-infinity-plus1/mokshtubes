<?php $__env->startSection('title', 'Hastelloy G30 | Superior Oxidation Resistance'); ?>
<?php $__env->startSection('meta_description', 'Hastelloy G30 pipes, tubes & fittings offer exceptional resistance to nitric, phosphoric, and sulfuric acids, ideal for harsh chemical processing.'); ?>
<?php $__env->startSection('meta_keywords', 'Hastelloy G30, Oxidation Resistant Alloy, Hastelloy G30 Pipes, Hastelloy G30 Tubes, Hastelloy
    G30 Fittings, Chemical Processing Alloys, Acid Resistant Alloy, Industrial Corrosion Resistant Alloys'); ?>
<?php $__env->startSection('og_image', asset('assets/images/hastelloy/Hastelloy-G30.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/hastelloy/Hastelloy-G30.webp')); ?>" alt="Hastelloy g30"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, importer, and stockist of ALLOY G-30 (UNS N06030) <a
                                href="<?php echo e(route('products')); ?>">products</a>, available in
                            various forms such as <a href="<?php echo e(route('products.pipes-tubes')); ?>">Pipes & Tubes</a>, Pipe
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            ...
                            exceptional resistance to mixed acid environments, <a
                                href="<?php echo e(route('materials.hastelloy')); ?>">HASTELLOY G30</a> also retains good fabricability
                            and is a
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/hastelloy/hastelloy-g30.blade.php ENDPATH**/ ?>