<?php $__env->startSection('title', 'EN24 Alloy Steel | High Strength & Fatigue Resistant'); ?>
<?php $__env->startSection('meta_description', 'EN24 Alloy Steel (817M40/AISI 4340) – chemical composition, mechanical properties, and applications. Buy EN24 round bars and custom products.'); ?>
<?php $__env->startSection('meta_keywords', 'EN24 Alloy Steel, high strength alloy steel, fatigue resistant steel, tough alloy steel,
    heavy-duty steel, industrial alloy steel'); ?>
<?php $__env->startSection('og_image', asset('assets/images/engineering-steels/engineering-steels-en24.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/engineering-steels/engineering-steels-en24.webp')); ?>" alt="EN24 Alloy Steel Round Bars and Forged Components – Moksh Tubes"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, and exporter of high quality<strong class="text-black"> EN24 steel <a
                                    href="<?php echo e(route('products')); ?>">products</a>,</strong>
                            including Round Bars, Forgings,
                            Bright Bars, Hex Bars, Flats, Shafts, <a href="<?php echo e(route('products.bars-rods.hollow-bars')); ?>">Hollow Bars</a>, and Custom Components. <a href="<?php echo e(url('materials/engineering-steels/engineering-steels-en36')); ?>">EN36</a>, also known as
                            817M40 or AISI 4340, is a high strength, alloy <a
                                href="<?php echo e(url('materials/engineering-steels/engineering-steels-en8')); ?>"> engineering steel 8</a> renowned for its
                            excellent
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/engineering-steels/engineering-steels-en24.blade.php ENDPATH**/ ?>