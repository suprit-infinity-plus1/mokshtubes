<?php $__env->startSection('title', 'Industrial Flanges & Pipe Fittings – Moksh Tubes'); ?> <!-- 52 characters -->
<?php $__env->startSection('meta_description',
    'Moksh Tubes provides premium flanges – stainless steel, weld neck, slip-on & blind with
    ASME B16.5 dimensions for industrial piping systems.'); ?> <!-- 153 characters -->
<?php $__env->startSection('meta_keywords',
    ...
    <?php $__env->startSection('og_image', asset('assets/images/product/flangs/Flanges-&-Pipe-Fittings.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/product/flangs/Flanges-&-Pipe-Fittings.webp')); ?>"
                ...
                <div class="col-md-6">
                    ...
                    <p class="fs-6 mb-3 text-justify">
                        <a href="<?php echo e(route('index')); ?>">Moksh Tubes & Fittings LLP</a>, we supply a complete range of
                        industrial flanges including stainless
                        steel flanges,carbon steel
                        flanges, alloy steel flanges, duplex & super duplex flanges, <a
                            href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel
                            ...
                            <tbody class="text-start">
                                <tr class="t-row">
                                    ...
                                    <td>Stainless Steel, Carbon Steel, Alloy Steel, <a
                                        ...
                                        <a href="<?php echo e(route('materials.titanium')); ?>">Titanium</a>, Copper Alloys
                                    </td>
                                </tr>
                                <tr class="t-row">
                                    <td>Grades</td>
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h5>Stainless, carbon, <a href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel</a>,
                            titanium, and <a href="<?php echo e(route('materials.copper-Alloys')); ?>">copper alloys</a> (stainless
                            flange, MS flange)</h5>
                    </div>
                </div>
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5><a href="<?php echo e(url('products/pipe-fittings-flanges-fasteners/custom-fabricated-fittings')); ?>">Custom
                                Flanges</a>: Long Weld Neck, Lap Joint, Orifice, Spectacle Blind</h5>
                    </div>
                </div>
                    ...
                    <div class="accordion-box">
                        ...
                        <div class="accordion accordion-block">
                            <div class="accord-btn">
                                <h4>What is a <a
                                        href="<?php echo e(url('products/pipe-fittings-flanges-fasteners/flanges-and-gaskets')); ?>">flange</a>?
                                </h4>
                            </div>
    ...
    <section class="sec-padd-top sec-padd-bottom bg-light">
        <div class="container">
            <div class="contact-cta-box">
                <h2>Contact Us</h2>
                <p>
                    Looking for high-quality stainless steel flanges, carbon steel flanges, or alloy flanges?<br>Contact
...
<?php $__env->startSection('jsscripts'); ?>
    <script type="application/ld+json">
            ...
            "mainEntity": [
                ...
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "A flange is a mechanical component used to connect pipes, valves, pumps, and other equipment in a piping system. It ensures a secure joint and allows for easy assembly, inspection, and maintenance of pipelines."
                }
                },
                {
                "@type": "Question",
                "name": "What is PCD in flange?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "PCD (Pitch Circle Diameter) in a flange is the diameter of the circle formed by the centers of the bolt holes. Correct PCD measurement is essential for proper alignment of flange joints."
                }
                },
                {
                "@type": "Question",
                "name": "How to measure flange size?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "To measure a flange size, note the Outer Diameter (OD), Bolt Circle Diameter (PCD), number of bolt holes, and flange thickness. Accurate measurement ensures the pipe flange fits perfectly in your system."
                }
                },
                {
                "@type": "Question",
                "name": "What is a flange coupling?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "A flange coupling is a type of mechanical connection used to join two shafts or pipes with flanges, bolts, and gaskets. It provides a robust, leak-proof connection in industrial and piping applications."
                }
                },
                {
                "@type": "Question",
                "name": "What materials are flanges made of?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Flanges are available in Stainless Steel (304, 316, 310), Carbon Steel (A105, A350 LF2), Alloy Steel (F11, F22), Duplex & Super Duplex, Nickel Alloys (Inconel, Monel), Titanium, and Copper Alloys (Cu-Ni, Brass, Bronze)."
                }
                }
            ]
            }
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/products/pipe-fittings-flanges-fasteners/fittings-and-flanges.blade.php ENDPATH**/ ?>