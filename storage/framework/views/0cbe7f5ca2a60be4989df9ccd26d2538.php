<?php $__env->startSection('title', 'EN31 Alloy Steel | High Wear Resistance Steel'); ?>
<?php $__env->startSection('meta_description', 'EN31 Alloy Steel offering superior wear resistance and hardness for demanding industrial tooling applications.'); ?>
<?php $__env->startSection('meta_keywords', 'EN31 Alloy Steel, high wear resistance steel, high hardness steel, industrial tooling steel, durable alloy steel, engineering steel'); ?>
<?php $__env->startSection('og_image', asset('assets/images/engineering-steels/engineering-steels-en31.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/engineering-steels/engineering-steels-en31.webp')); ?>" alt="EN31"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            exporter, importer, and stockist of a wide range of EN31 steel <a
                                href="<?php echo e(route('products')); ?>">products</a> including bars, rods,
                            sheets, plates, forgings, and custom-engineered components.
                        </p>

                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black"><a href="<?php echo e(route('materials.engineering-Steels')); ?>">EN
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/engineering-steels/engineering-steels-en31.blade.php ENDPATH**/ ?>