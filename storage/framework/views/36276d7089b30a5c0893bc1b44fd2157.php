<?php $__env->startSection('title', 'C26000 Cartridge Brass: Machinable & Corrosion-Resistant'); ?>

<?php $__env->startSection('meta_description', 'Cartridge Brass Alloy C26000 offers excellent machinability, durability, and corrosion resistance for engineering, marine, and industrial uses.'); ?>

<?php $__env->startSection('meta_keywords', 'Cartridge Brass C26000, C26000 brass alloy, machinable brass, corrosion resistant brass, durable brass alloy, general engineering brass, marine brass alloy, industrial brass grade'); ?>
<?php $__env->startSection('og_image', asset('assets/images/copper-alloys/copper-alloys-cartridge-brass.webp')); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/copper-alloys/copper-alloys-cartridge-brass.webp')); ?>"alt="Copper Alloys C26000 Cartridge Brass"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            exporter, importer, and stockist of<strong class="text-black"> Cartridge Brass (C26000) <a
                                    href="<?php echo e(route('products')); ?>">products</a></strong>, including Pipes, Tubes,
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            <h3 class="mb-3" style="color:#174268;">Download Cartridge Brass Datasheet</h3>
            <p class="mb-3">
                Get the complete Cartridge Brass datasheet with chemical composition,
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/copper-alloys/copper-alloys-cartridge-brass.blade.php ENDPATH**/ ?>