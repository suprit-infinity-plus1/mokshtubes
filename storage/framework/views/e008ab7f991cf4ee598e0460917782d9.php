<?php $__env->startSection('title', 'Haynes Superalloys 242 - Oxidation & Corrosion Resistant'); ?>
<?php $__env->startSection('meta_description', 'Haynes Alloy 242 offers excellent oxidation, thermal stability, and corrosion resistance for demanding industrial environments.'); ?>
<?php $__env->startSection('meta_keywords', 'Haynes Superalloys 242, Haynes Alloy 242, Oxidation Resistant Alloy, Corrosion Resistant Alloy, Thermal Stability Alloy, High Temperature Alloy, Industrial Haynes Alloys, Chemical Processing Haynes, Power Industry Haynes, Aerospace Haynes Alloys, Marine Industry Haynes'); ?>
<?php $__env->startSection('og_image', asset('assets/images/haynes/haynes-242.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/haynes/haynes-242.webp')); ?>" alt="Haynes-242"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            exporter, importer, and stockist of a wide range of<strong class="text-black"> Haynes 242 (UNS
                                N10242)<a href="<?php echo e(route('products')); ?>"> products</a></strong> including
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/haynes-superalloys/haynes-superalloys-242.blade.php ENDPATH**/ ?>