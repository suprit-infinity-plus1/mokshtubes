<?php $__env->startSection('title', 'Metal Coils – Premium Stainless, Carbon & Alloy Sheets'); ?> <!-- 52 characters -->
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/peoduct/Sheets, Plates and Coils/Metal-Coils.jpeg')); ?>"
                ...
                <div class="col-md-6">
                    <p class="fs-6 mb-3 text-justify">
                        ...
                        cold rolling <a href="<?php echo e(url('products/bars-rods/flat-bars')); ?>">flat</a> steel into continuous <a
                            href="<?php echo e(url('products/sheets-plates-coils/Strips')); ?>">strips</a> and winding them into coils,
                        they provide ease of
                        transport, storage, and processing.
                    </p>

                    <p class="fs-6 mb-3 text-justify">
                        Coils are available in various <a href="<?php echo e(route('materials')); ?>">materials</a> such as stainless
                        steel, carbon steel, mild steel,
                        <a href="<?php echo e(route('materials.aluminium-Alloys')); ?>">aluminum</a>, copper, and specialty alloys. Each
                        material offers unique advantages such as corrosion
                        resistance, durability, or lightweight properties.
                    </p>

                    <p class="fs-6 mb-3 text-justify">
                        <a href="<?php echo e(route('index')); ?>">Moksh Tubes & Fittings LLP</a> supplies high quality metal coils in a
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube-new\mokshtube\resources\views/frontend/products/sheets-plates-coils/coils.blade.php ENDPATH**/ ?>