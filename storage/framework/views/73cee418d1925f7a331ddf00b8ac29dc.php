<?php $__env->startSection('title', 'Square Bars – Stainless, MS, Aluminium & Brass'); ?> <!-- 52 characters -->
<?php $__env->startSection('meta_description',
    'Moksh Tubes supplies premium Square Bars in SS, MS, Aluminium & Brass with size charts,
    grades & custom cut-to-length options.'); ?> <!-- 152 characters -->
<?php $__env->startSection('meta_keywords',
    'Square Bars, Stainless Square Bars, MS Square Bars, Aluminium Square Bars, Brass Square Bars,
    Steel Square Rods, Square Bar Sizes, Square Bar Weight Chart'); ?>
    <?php $__env->startSection('og_title', 'Square Bars & Square Tubing | SS, MS, Aluminium & More'); ?>

<?php $__env->startSection('og_image', asset('assets/images/product/Bars-&-Rods/square-bars.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/product/Bars-&-Rods/square-bars.webp')); ?>" alt="Square Bars"
                ...
                <div class="col-md-6">
                    ...
                    <p class="fs-6 mb-3 text-justify">
                        ...
                        square bar, times square bars, carbon steel, alloy steel, duplex & super duplex, <a
                            href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel alloys</a>,
                        <a href="<?php echo e(route('materials.titanium')); ?>">titanium</a>, aluminium, brass square bar, and copper.
                        ...
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody class="text-start">
                                ...
                                <tr class="t-row">
                                    <td>Grades</td>
                                    <td>ASTM, ASME, DIN, EN,
                                        and JIS certified grades – available in all major alloys</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Size Range</td>
                        ...
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody>
                                <tr class="t-row">
                                    ...
                                    <td>304, 304L, 316, <a
                                            href="<?php echo e(url('materials/austenitic-stainless-steel/austenitic-stainless-steel-316ti')); ?>">316L</a>,
                                        310, <a
                                            href="<?php echo e(url('materials/austenitic-stainless-steel/austenitic-stainless-steel-321')); ?>">321</a>,
                                        347 <br>
                                ...
                                <tr class="t-row">
                                    ...
                                    <td><a
                                            href="<?php echo e(url('materials/duplex-and-super-duplex/super-duplex-2205')); ?>">2205</a>,
                                        S32750, <a
                                            href="<?php echo e(url('materials/duplex-and-super-duplex/super-duplex-s32760')); ?>">S32760</a>
                                        <br>
                                ...
                                <tr class="t-row">
                                    <td>Aluminum</td>
                                    <td><a
                                            href="<?php echo e(url('materials/aluminium-alloys/aluminium-alloys-6061-t6')); ?>">6061</a>,
                                        <a
                                            href="<?php echo e(url('materials/aluminium-alloys/aluminium-alloys-6082-t6')); ?>">6082</a>,
                                        <a href="<?php echo e(url('materials/aluminium-alloys/aluminium-alloys7075')); ?>">7075</a>
                                        <br>
                    ...
                    <div class="application-card">
                        ...
                        <ul>
                            <li><b>Alloy & titanium square bars</b> for chassis components, structural frames & tooling
                                parts.</li>
                            <li><b><a href="<?php echo e(route('materials.aluminium-Alloys')); ?>">Aluminium</a> square bar</b> for
                                light weight automotive and aerospace structures.</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="advantage-card">
                        ...
                        <h5>Easily converted into <b><a
                                    href="<?php echo e(url('products/pipe-fittings-flanges-fasteners/fittings-and-flanges')); ?>">fittings</a>,
                                tools, and machine components</b>.</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-lg-6">
                    <div class="advantage-card">
                        ...
                        <h5><b><a href="<?php echo e(route('materials.copper-Alloys')); ?>">Copper</a> & brass square bar</b> for
                            hardware and conductive applications.</h5>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        ...
                        <h5>Available in <b>Stainless, Duplex, <a
                                    href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">Nickel</a>, Titanium, Brass,
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5><b><a
                                ...
                                Design Solutions:</b> From concept to completion, we deliver furniture tailored to
                            your vision.</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5><b>Premium <a href="<?php echo e(route('materials')); ?>">Material</a> Selection:</b> Only certified steel
                            grades are used for superior quality.
                        </h5>
                    </div>
                </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>
                                    ...
                                    which is known for its <a
                                        href="<?php echo e(route('materials.high-strength-stainless-steel')); ?>">strength</a>,
                                    flexibility, and cost effectiveness. These bars are
                                    widely used in construction,
                                    fabrication, railings, industrial frameworks, and general <a
                                        href="<?php echo e(route('materials.engineering-Steels')); ?>">engineering</a> applications.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>
                                    ...
                                    uniform <strong>“edge to edge”</strong> square shape.
            ...
            <div class="contact-cta-box">
                ...
                <p>
                    Looking for Stainless Steel, MS, Aluminium, or Brass Square Bars? <br><a
                        href="<?php echo e(route('index')); ?>"><b>Moksh Tubes</b></a> delivers premium
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/products/bars-rods/square-bars.blade.php ENDPATH**/ ?>