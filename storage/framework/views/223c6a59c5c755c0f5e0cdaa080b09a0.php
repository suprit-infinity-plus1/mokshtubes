<?php $__env->startSection('title', 'Monel 400 Alloy – Superior Corrosion & Strength'); ?> <!-- 53 chars -->
...
<?php $__env->startSection('meta_keywords',
    ...
    Alloys'); ?>
<?php $__env->startSection('og_image', asset('assets/images/material/monel-400.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/material/monel-400.webp')); ?>" alt="Monel 400"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            exporter, importer and stockist of a variety of MONEL 400 (UNS N04400) <a
                                href="<?php echo e(route('products')); ?>">products</a> such as <a
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            ...
                            chemical environments. This <a href="<?php echo e(route('materials.hastelloy')); ?>">alloy</a> exhibits
                            ...
                            weldability, making it ideal for handling corrosive and high pressure conditions. <strong
                                class="text-black"> <a href="<?php echo e(route('materials.monel')); ?>">MONEL 400</a></strong>
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <form id="leadForm" method="POST" action="<?php echo e(route('lead.capture')); ?>" class="mb-3">
                <?php echo csrf_field(); ?>
                <div class="row justify-content-center">
                    <input type="hidden" name="pdf" value="Monel_400_data_sheet.pdf">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/monel/monel-400.blade.php ENDPATH**/ ?>