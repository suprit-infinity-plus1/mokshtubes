<?php $__env->startSection('title', 'Industrial Fasteners – High-Quality Bolts & Nuts'); ?> <!-- 52 characters -->
...
<?php $__env->startSection('meta_keywords',
    ...
    <?php $__env->startSection('og_image', asset('assets/images/product/flangs/FASTENERS.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/product/flangs/FASTENERS.webp')); ?>" alt="Custom-Fabricated-Fittings"
                ...
                <div class="col-md-6">
                    ...
                    <p class="fs-6 mb-3 text-justify">
                        ...
                        steel, carbon steel, alloy steel, <a href="<?php echo e(route('materials.titanium')); ?>">titanium</a>, nickel
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody>
                                ...
                                <tr class="t-row">
                                    <td>Nickel Alloys</td>
                                    <td><a href="<?php echo e(route('materials.inconel')); ?>">Inconel 600/625/718</a>, Monel 400/K500,
                                        <a href="<?php echo e(route('materials.hastelloy')); ?>">Hastelloy C22/C276</a> – for extreme
                                        heat and
                                        corrosive conditions.</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Titanium</td>
                                    <td><a href="<?php echo e(route('materials.titanium')); ?>">Grades 2, 5</a> (Ti-6Al-4V) –
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <ul>
                            <li><a href="<?php echo e(route('materials.high-strength-stainless-steel')); ?>">High strength</a> bolts
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo e(route('materials.titanium')); ?>">Titanium</a> and nickel fasteners for
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5><a href="<?php echo e(route('materials')); ?>">Material</a> Expertise: Stainless, Duplex, Nickel Alloys,
                    ...
                    <div class="accordion-box">
                        ...
                        <div class="accordion accordion-block">
                            <div class="accord-btn">
                                <h4>What types of fasteners are available from <a href="<?php echo e(route('index')); ?>">Moksh Tubes
                                        & Fittings LLP</a>?</h4>
                            </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/products/pipe-fittings-flanges-fasteners/fasteners.blade.php ENDPATH**/ ?>