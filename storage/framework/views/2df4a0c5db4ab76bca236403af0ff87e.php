<?php $__env->startSection('title', 'Hastelloy X | High-Temp Strength Alloy'); ?>
<?php $__env->startSection('meta_description', 'Hastelloy X pipes, tubes & fittings with high-temperature strength, oxidation resistance, and weldability for aerospace and turbine applications'); ?>
<?php $__env->startSection('meta_keywords', 'Hastelloy X, High Temperature Alloy, Hastelloy X Pipes, Hastelloy X Tubes, Hastelloy X
    Fittings, Oxidation Resistant Alloy, Aerospace Alloys, Turbine Alloys, High-Temp Strength Alloy'); ?>
<?php $__env->startSection('og_image', asset('assets/images/hastelloy/hastelloy-x.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/hastelloy/hastelloy-x.webp')); ?>" alt="Hastelloy X"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, importer, and stockist of Hastelloy X (UNS N06002) products, including <a
                                href="<?php echo e(route('products.pipes-tubes')); ?>">Pipes
                        ...
                        <p class="fs-6" style="text-align: justify;">
                            ...
                            <strong class="text-black"> <a href="<?php echo e(route('materials.hastelloy')); ?>">Hastelloy
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/hastelloy/hastelloy-x.blade.php ENDPATH**/ ?>