<?php $__env->startSection('title', 'Stainless Steel & Nickel Alloy Capillary Tubes – Moksh Tubes'); ?> <!-- 70 characters -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <p class="fs-6 mb-3 text-justify">
                        ...
                        <a href="<?php echo e(route('products')); ?>">products</a> with extremely small diameters designed for
                    ...
                    <p class="fs-6 mb-3 text-justify">
                        Made from high-quality <a href="<?php echo e(route('materials.super-Austenitic-Stainless-Steel')); ?>">stainless
                            steel</a>,<a href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>"> nickel alloys</a>, <a
                            href="<?php echo e(route('materials.titanium')); ?>">titanium</a>, and other specialty materials,
                            ...
                            <tbody class="text-start">
                                <tr class="t-row">
                                    ...
                                    <td>Stainless Steel, <a href="<?php echo e(route('materials.duplex-and-super-duplex')); ?>">Duplex &
                                            ...
                                            href="<?php echo e(route('materials.monel')); ?>">Monel</a>, Titanium,
                                        Copper Alloys</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Grades</td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody>
                                ...
                                <tr class="t-row">
                                    <td>Nickel Alloys</td>
                                    <td><a href="<?php echo e(route('materials.inconel')); ?>">Inconel 600, 625, 718</a> – for high
                                        temperature & corrosive environments.</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Monel Grades</td>
                                    <td><a href="<?php echo e(route('materials.monel')); ?>">Monel 400, K500</a> – for marine and chemical use.</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Titanium Grades</td>
                                    <td><a href="<?php echo e(route('materials.titanium')); ?>">Gr. 1, 2, 5</a> – for aerospace and medical devices.</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Duplex & Super Duplex</td>
                                    <td><a href="<?php echo e(route('materials.duplex-and-super-duplex')); ?>">2205, S32750</a> – for offshore and harsh industrial use.</td>
                                </tr>
                                <tr class="t-row">
                                    <td>Copper Alloys</td>
                                    <td><a href="<?php echo e(route('materials.copper-Alloys')); ?>">Cu-Ni 70/30, 90/10</a> – for refrigeration, marine, and heat exchanger systems.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="advantage-card">
                        <div class="advantage-icon"><i class="bi bi-droplet-half"></i></div>
                        <h4>Wide <a href="<?php echo e(route('materials')); ?>">Material</a> Selection </h4>
