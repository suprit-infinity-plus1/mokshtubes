<?php $__env->startSection('title', 'Zirconium 702 | High-Purity Corrosion Resistant'); ?>
<?php $__env->startSection('meta_description', 'Zirconium 702 alloy offers excellent corrosion resistance and high purity, ideal for chemical, nuclear, and industrial applications.'); ?>
<?php $__env->startSection('meta_keywords', 'Zirconium 702, High Purity Zirconium, Corrosion Resistant Zirconium, Zirconium 702 Pipes, Zirconium 702 Tubes, Zirconium 702 Sheets, Chemical Industry Zirconium, Nuclear Zirconium, Industrial Zirconium Alloys, High Performance Zirconium'); ?>
<?php $__env->startSection('og_image', asset('assets/images/zirconium/zirconium-702.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/zirconium/zirconium-702.webp')); ?>" alt="Zirconium 702"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            exports, imports, and stocks a wide range of<strong class="text-black"> Zirconium 702 (UNS
                                R60702) <a href="<?php echo e(route('products')); ?>">products</a></strong>. Our offerings
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/zirconium/zirconium-702.blade.php ENDPATH**/ ?>