<?php $__env->startSection('title', 'Inconel 617 – High-Temperature & Corrosion Alloy'); ?>
...
<?php $__env->startSection('og_image', asset('assets/images/inconel/Inconel-617.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/inconel/Inconel-617.webp')); ?>" alt="Inconel 617"
                ...
                <div class="col-md-6">
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            products including <a href="<?php echo e(route('products.pipes-tubes')); ?>">Pipes & Tubes</a>, Pipe
                            ...
                            <a href="<?php echo e(route('materials.hard-To-Find-Special-Alloys')); ?>">hard-to-find</a> Alloy 617
                            components.
                        </p>
    ...
    <section class="sec-padd-bottom bg-light">
        <div class="datasheet-download px-4 text-center">
            ...
            <form id="leadForm" method="POST" action="<?php echo e(route('lead.capture')); ?>" class="mb-3">
                <?php echo csrf_field(); ?>
                <div class="row justify-content-center">
                    <input type="hidden" name="pdf" value="Inconel_617_data_sheet.pdf">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/inconel/inconel-617.blade.php ENDPATH**/ ?>