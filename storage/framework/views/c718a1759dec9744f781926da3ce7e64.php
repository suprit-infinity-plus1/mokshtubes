<?php $__env->startSection('title', 'About Mokshtubes LLP | Expert in High-Performance Alloys'); ?>
<?php $__env->startSection('meta_description', 'Learn about Mokshtubes LLP, a trusted global supplier of stainless steel, nickel alloys, Hastelloy, Inconel and custom-engineered metal solutions for critical industries.'); ?>
                ...
                <div class="about-text">
                    ...
                    <div class="text">
                        ...
                        <p>
                            ...
                            stockists, and exporters of <strong class="text-black"><a href="<?php echo e(route('products.pipes-tubes')); ?>"> Pipes & Tubes</a>, Pipe Fittings,
                                Flanges,
                                Fasteners, Sheets
                            ...
                            diverse industrial sectors by offering a wide range of materials in <strong class="text-black">ferrous
                                ...
                                Nickel
                                Alloys such as <a href="<?php echo e(route('materials.hastelloy')); ?>"> Hastelloy</a>,<a href="<?php echo e(route('materials.inconel')); ?>"> Inconel</a>,<a href="<?php echo e(route('materials.monel')); ?>"> Monel</a>, Titanium Alloys, Copper & Bronze
                                Alloys,
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/about.blade.php ENDPATH**/ ?>