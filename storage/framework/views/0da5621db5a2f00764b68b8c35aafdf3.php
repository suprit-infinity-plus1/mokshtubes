...
<?php $__env->startSection('meta'); ?>
    ...
    <meta property="og:image" content="<?php echo e(asset('assets/images/about/about-materials_11zon.webp')); ?>" />
    ...
    <meta name="twitter:image" content="<?php echo e(asset('assets/images/about/about-materials_11zon.webp')); ?>">
                ...
                <div id="tabContents">
                    ...
                    <div id="tab1" class="tab-content-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets/images/calculator/steel-sheets-plates.png')); ?>" class="img-fluid rounded border w-100"
                    ...
                    <div id="tab2" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets/images/calculator/seamless_steel_circular.jpg')); ?>" class="img-fluid rounded border w-100"
                                    alt="Pipe Image">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab4" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets/images/calculator/Hollow_structural_sections-square.png')); ?>" class="img-fluid rounded border w-100"
                    ...
                    <div id="tab5" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets/images/calculator/hollow_sections_rectangular.png')); ?>" class="img-fluid rounded border w-100"
                    ...
                    <div id="tab6" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets/images/calculator/roundbar.jpg')); ?>" class="img-fluid rounded border w-100"
                    ...
                    <div id="tab7" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets\images\calculator\squaresteelbars.jpg')); ?>" class="img-fluid rounded border w-100"
                    ...
                    <div id="tab8" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets/images/calculator/Flatbars.jpg')); ?>" class="img-fluid rounded border w-100"
                    ...
                    <div id="tab9" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets\images\calculator\equal-angles.png')); ?>" class="img-fluid rounded border w-100 object-fit-cover"
                    ...
                    <div id="tab10" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets/images/calculator/unequal-angles.png')); ?>" class="img-fluid rounded border w-100"
                    ...
                    <div id="tab11" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets/images/calculator/Channels-GOST.jpg')); ?>" class="img-fluid rounded border w-100"
                    ...
                    <div id="tab12" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets/images/calculator/Channels-UPN.jpg')); ?>" class="img-fluid rounded border w-100"
                    ...
                    <div id="tab13" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets/images/calculator/Beams-IPN.png')); ?>" class="img-fluid rounded border w-100"
                    ...
                    <div id="tab14" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets/images/calculator/Beams-IPE.png')); ?>" class="img-fluid rounded border w-100"
                    ...
                    <div id="tab15" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            ...
                            <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets/images/calculator/Beams-HEA(IPBL) .jpg')); ?>" class="img-fluid rounded border w-100"
                    ...
                    <div id="tab16" class="tab-content-item d-none">
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-4 mb-lg-0">
                             ...
                             <!-- Right: Image -->
                            <div class="col-lg-6 d-flex align-items-center">
                                <img src="<?php echo e(asset('assets/images/calculator/Beams-HEB-(IPB).png')); ?>" class="img-fluid rounded border w-100"
                                    alt="HEA Beam Illustration" />
                            </div>
                        </div>
                    </div>
