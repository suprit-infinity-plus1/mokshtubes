<?php $__env->startSection('title', 'Titanium Grade 7 Nb – Niobium Stabilized Titanium Alloy'); ?> <!-- 52 chars -->
<?php $__env->startSection('meta_description', 'Titanium Grade 7 offers exceptional corrosion resistance for chemical, marine, and industrial applications in harsh environments.'); ?>
<?php $__env->startSection('meta_keywords', 'Titanium Grade 7 Nb, Niobium Stabilized Titanium, Corrosion Resistant Titanium, Titanium Grade 7 Nb Pipes, Titanium Grade 7 Nb Tubes, Titanium Grade 7 Nb Sheets, Reducing Environment Resistant Titanium, Chemical Processing Titanium, Industrial Titanium Alloys, High Performance Titanium'); ?>
<?php $__env->startSection('og_image', asset('assets/images/titanium/titanium-7nb.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/titanium/titanium-7nb.webp')); ?>" alt="Titanium Grade 7 NB"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            Forgings, Custom Components, and other hard-to-find titanium alloy <a
                                href="<?php echo e(route('products')); ?>">products</a> tailored to your
                            exact requirements.
                        </p>

                        <p class="fs-6" style="text-align: justify;">
                            <strong class="text-black">Titanium Grade 7 NB (UNS R52400), </strong>also known as Ti-0.2Pd, is
                            a corrosion-resistant, alpha-phase <a href="<?php echo e(route('materials.titanium')); ?>">titanium
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Used in piping, tanks, valves, and heat exchangers handling aggressive chemicals and acids.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <h5>Desalination & Marine Systems</h5>
                        <p>Ideal for brine handling systems, marine heat exchangers, and seawater filtration units.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Used in bleach tanks, digesters, and process piping exposed to chlorine compounds.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Employed in condenser tubes and feedwater systems of nuclear and thermal power plants.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Safe for contact with consumables and resistant to cleaning chemicals and sanitizers.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="application-card">
                        ...
                        <p>Suitable for scrubbers, stack gas systems, and reactors in flue-gas desulfurization.</p>
                    </div>
                </div>
            ...
            <div class="row g-4 mt-4">
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>Decades of experience in titanium and specialty alloy manufacturing</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>Global sourcing network ensuring consistent quality</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="why-banner-block">
                        ...
                        <h5>Custom-fabricated components tailored to client needs</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="why-banner-block">
                        ...
                        <h5>Strict quality control and testing processes</h5>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="why-banner-block">
                        ...
                        <h5>Customer-first approach with timely delivery and support</h5>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/titanium/titanium-grade-7-nb.blade.php ENDPATH**/ ?>