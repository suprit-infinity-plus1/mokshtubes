<?php $__env->startSection('title', 'Fabricated Stainless Steel Grills – Stylish & Durable'); ?> <!-- 52 characters -->
...
<?php $__env->startSection('og_image', asset('assets/images/product/SS-grill.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/product/SS-grill.webp')); ?>"
                ...
                <div class="col-md-6">
                    ...
                    <p class="fs-6 mb-3 text-justify">
                        <strong><a href="<?php echo e(route('index')); ?>">Moksh Tubes & Fittings LLP</a></strong>, we manufacture
                        ...
                        requirements. Each grill is crafted with precision engineering and high grade <a
                            href="<?php echo e(route('materials.austenitic-stainless-Steel')); ?>">stainless steel</a> to
                        ...
                        grills for upscale residences to heavy duty industrial safety grills, our <a
                            href="<?php echo e(route('products')); ?>">products</a> are tailored for
                        purpose and built to last.
                    </p>
                    <p class="fs-6 text-justify">
                        With modern fabrication techniques like laser cutting, CNC bending, and TIG <a
                            href="<?php echo e(route('products.pipes-tubes.welded-pipes')); ?>">welding</a>, we produce
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="accordion-box">
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>
                                    Yes. At <a href="<?php echo e(route('index')); ?>">Moksh Tubes & Fittings LLP</a>, we offer fully
                        ...
                        <div class="accordion accordion-block">
                            ...
                            <div class="accord-content">
                                <p>
                                    Simply contact <b><a href="<?php echo e(route('index')); ?>">Moksh Tubes & Fittings LLP</a></b> at
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/products/special-fabricated/fabricated-ss-grills.blade.php ENDPATH**/ ?>