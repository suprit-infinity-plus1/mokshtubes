<?php $__env->startSection('title', 'Aluminium Alloy 2014 T6 | High Strength Aerospace Alloy'); ?>
...
<?php $__env->startSection('og_image', asset('assets/images/aluminium-alloys/aluminium-alloys-2014-t6.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/aluminium-alloys/aluminium-alloys-2014-t6.webp')); ?>"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, importer, and stockist of<strong class="text-black"> Aluminium Alloy 2014-T6
                                <a href="<?php echo e(route('products')); ?>">products</a></strong> such as sheets,
                            ...
                            <div class="accord-content">
                                <p>
                                    Aluminium Alloy 2014-T6 is a high strength, <a
                                        href="<?php echo e(route('materials.copper-Alloys')); ?>">copper alloyed</a> aluminum grade
                                    widely used in
                                    aerospace, automotive, and structural <a
                                        href="<?php echo e(route('materials.engineering-Steels')); ?>">engineering</a>. The T6 temper
                                    means it has been
                            ...
                            <div class="accord-content">
                                <p>
                                    ...
                                    corrosion resistant as commercially pure aluminum grades like <a
                                        href="<?php echo e(url('materials/aluminium-alloys/aluminium-alloys-1100')); ?>">1100</a> or
                                    <a href="<?php echo e(url('materials/aluminium-alloys/aluminium-alloys-1200')); ?>">1200</a>. In
                                    most
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/aluminium-alloys/aluminium-alloys-2014-t6.blade.php ENDPATH**/ ?>