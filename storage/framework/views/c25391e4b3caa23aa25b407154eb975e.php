<?php $__env->startSection('title', 'SMO 254 – High Strength Chloride Resistant Alloy | Moksh'); ?> <!-- 52 chars -->
<?php $__env->startSection('meta_description', 'Moksh Tubes supplies SMO 254 pipes, tubes & fittings offering high chloride corrosion resistance for marine, offshore & chemical environments.'); ?>
<?php $__env->startSection('meta_keywords', 'SMO 254, Super Austenitic Stainless Steel, Chloride Resistant Alloy, Corrosion Resistant Alloy, SMO 254 Pipes, SMO 254 Tubes, SMO 254 Fittings, Marine Industry Alloys, Offshore Industry Alloys, Chemical Processing Alloys, Industrial Corrosion Resistant Alloys'); ?>
<?php $__env->startSection('og_image', asset('assets/images/super-austenitic-stainless-steel/super-austenitic-stainless-steel-SMO-254.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('assets/images/super-austenitic-stainless-steel/super-austenitic-stainless-steel-SMO-254.webp')); ?>"
                    ...
                    <div class="pe-md-3">
                        <p class="fs-6 mb-4 text-justify" style="text-align: justify;">
                            ...
                            supplier, exporter, and stockist of high-performance<strong class="text-black"> SMO 254 (UNS
                                S31254) <a href="<?php echo e(route('products')); ?>">products</a>,</strong> including
                        ...
                        <p> <strong class="text-black">SMO 254</strong> is a <a
                                href="<?php echo e(route('materials.super-Austenitic-Stainless-Steel')); ?>">super austenitic stainless
                                steel alloy</a>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/materials/super-austenitic-stainless-steel/super-austenitic-stainless-steel-smo-254.blade.php ENDPATH**/ ?>