<?php $__env->startSection('title', 'Boiler & Heat Exchanger Tubes: ASTM A179/A213 | Seamless, U‑Bent | Moksh Tubes'); ?>
<!-- 52 characters -->
<?php $__env->startSection('meta_description',
    ...
    <?php $__env->startSection('og_image', asset('assets/images/product/boiler-and-heat.webp')); ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?php echo e(asset('/assets/images/product/boiler-and-heat.webp')); ?>"
                ...
                <div class="col-md-6">
                    ...
                    <p class="fs-6 mb-3 text-justify">
                        Made from high grade<a href="<?php echo e(route('materials.austenitic-stainless-Steel')); ?>"> stainless
                    ...
                    <p class="fs-6 text-justify">
                        ...
                        exchanger tubes using advanced cold drawing, seamless forming, and <a
                            href="<?php echo e(route('products.pipes-tubes.welded-pipes')); ?>">welding</a> technologies to deliver
                            ...
                            <tbody class="text-start">
                                <tr class="t-row">
                                    ...
                                    <td>Stainless Steel, <a href="<?php echo e(route('materials.duplex-and-super-duplex')); ?>">Duplex &
                                            ...
                                            href="<?php echo e(route('materials.inconel')); ?>">Inconel</a>, Monel,
                                ...
                                <tr class="t-row">
                                    <td>Type</td>
                                    <td><a href="<?php echo e(url('products/pipes-tubes/seamless-pipes')); ?>">Seamless</a>, Welded
                                        (ERW, EFW), <a href="<?php echo e(url('products/pipes-tubes/u-bent-tubes')); ?>">U-Bent
                                            Tubes</a></td>
                                </tr>
                                <tr class="t-row">
                                    <td>Standards</td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped align-middle">
                            ...
                            <tbody>
                                ...
                                <tr class="t-row">
                                    <td>Titanium</td>
                                    <td><a href="<?php echo e(route('materials.titanium')); ?>">Grades 1, 2</a> for desalination plants
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-md-6 center">
                    <div class="application-card">
                        ...
                        <a class="" href="<?php echo e(route('products.pipes-tubes.boiler-heat-exchanger-tubes')); ?>">
                            <img class="w-100" src="<?php echo e(asset('/assets/images/product/basic-tube-layout.webp')); ?>"
                ...
                <div class="col-md-6 center">
                    <div class="application-card">
                        ...
                        <a class="" href="<?php echo e(route('products.pipes-tubes.u-bent-tubes')); ?>">
                            <img class="w-100"
                                src="<?php echo e(asset('/assets/images/product/u-bent-tube-heat-exchange-layout.webp')); ?>"
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="advantage-card">
                        ...
                        <h5>Stainless, alloy, carbon, copper <a
                                href="<?php echo e(route('materials.nickel-Based-Superalloys')); ?>">nickel</a> & titanium options.
                        </h5>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mokshtube\resources\views/frontend/products/pipes-tubes/boiler-heat-exchanger-tubes.blade.php ENDPATH**/ ?>